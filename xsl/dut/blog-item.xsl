...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
                ...
                <iaixsl:if test="page/navigation/bydates/item">
                    <div id="menu_blog_bydates" class="menu_blog_box">
                        <a class="menu_categories_label" href="/blog-list.php">
                            <iaixsl:attribute name="title">Archief</iaixsl:attribute>Archief</a>
                        <ul>
                                                    ...
                                                    <a>
                                                        ...
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="@value='01'">
                                                                <iaixsl:attribute name="title">Januari<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Styczeń
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='02'">
                                                                <iaixsl:attribute name="title">Februari<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Luty
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='03'">
                                                                <iaixsl:attribute name="title">Maart<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Marzec
                                                            </iaixsl:when>
                                                            ...
                                                            <iaixsl:when test="@value='05'">
                                                                <iaixsl:attribute name="title">Mei<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Maj
                                                            </iaixsl:when>
                                                            ...
                                                            <iaixsl:when test="@value='08'">
                                                                <iaixsl:attribute name="title">Augustus<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Sierpień
                                                            </iaixsl:when>
                ...
                <iaixsl:if test="action/blog_rss"> 
                    <div id="menu_blog_rss">
                        <a>
                            ...
                            <iaixsl:attribute name="title">RSS feed<i class="icon-rss"></i></iaixsl:attribute>RSS feed<i class="icon-rss"></i>
                        </a>
                    </div>
                </iaixsl:if> 
        ...
        <!--Blog - Content (blog_item_content, 116098.1)-->
            <iaixsl:if test="/shop/page/blogitem/long_description">
                <div id="blog-item">
                    ...
                    <iaixsl:if test="/shop/page/blogitem/categories/category">
                        <div class="d-flex d-md-none article__category_wrapper">
                            <iaixsl:for-each select="/shop/page/blogitem/categories/category">
                                <div class="article__category_name">
                                    <iaixsl:value-of select="@name"/>
                                </div>
                            </iaixsl:for-each>
                        </div>
                ...
                <iaixsl:if test="/shop/page/navigation/bycategories/item/@current='active' or /shop/page/navigation/bydates/item/item/@current='active'">
                    <div class="blog_viewalso">Toon meer inzendingen van<iaixsl:choose>
                            ...
                            <iaixsl:when test="not(/shop/page/navigation/bycategories/item/@current='active') and /shop/page/navigation/bydates/item/item/@current='active'">
                                <iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">Andere inzendingen van deze maand</iaixsl:attribute>
                                        <iaixsl:choose>
                            ...
                            <iaixsl:otherwise>Categorie <a>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@link"/></iaixsl:attribute>
                                    <iaixsl:attribute name="title"><iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/></iaixsl:attribute>
                                    <iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/>
                                </a>of<iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">Andere inzendingen van deze maand</iaixsl:attribute>
                                        <iaixsl:choose>
                                ...
                                <a class="headline">
                                    ...
                                    <span class="headline__name">
                                        <iaixsl:choose>
                                            ...
                                            <iaixsl:otherwise>Aanbevolen</iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </span>
        ...
        <!--Blog - Facebook comments (blog_item_facebook_comments, 107733.1)-->
            <iaixsl:if test="page/facebook_comments">
                <div class="cms_fb_comments">
                    <div class="big_label cms_fb_comments_label">Deel uw opmerkingen met anderen</div>
                    <div id="fb-root"/>
                    <script>
            ...
            <iaixsl:if test="not(action/set_render/item) or (action/set_render/item/@name = 'footer')">
                <footer>
                    ...
                    <!--Newsletter (menu_newsletter, 115949.1)-->

        <iaixsl:variable name="hideLabel"/>
        <iaixsl:variable name="hideFirstname">true</iaixsl:variable>

        <div id="menu_newsletter" class="container mb-5">
            <form action="/settings.php" method="post" class="d-flex">
                <iaixsl:if test="/shop/action/settings/@url">
                    <iaixsl:attribute name="action"><iaixsl:value-of select="/shop/action/settings/@url"/></iaixsl:attribute>
                </iaixsl:if>
                <div class="label_container">
                    <label><iaixsl:choose>
                            <iaixsl:when test="/shop/page[@type = 'blog-list'] or /shop/page[@type = 'blog-item']"><span>Wil je op de hoogte blijven?</span><b>Abonneer u op onze nieuwsbrief</b></iaixsl:when>
                            <iaixsl:otherwise><b>Abonneer u op onze nieuwsbrief</b><span>Wil je op de hoogte blijven en speciale acties ontvangen?</span></iaixsl:otherwise>
                    </iaixsl:choose></label>
                </div>
                    ...
                    <div class="nl_form_wrapper">
                        <input class="form-control validate" name="mailing_email" type="text" required="required" data-validate="email">                            
                            <iaixsl:choose>
                                    ...
                                    <iaixsl:otherwise>
                                        <iaixsl:attribute name="placeholder">Voer uw e-mailadres in</iaixsl:attribute>
                                    </iaixsl:otherwise>       
                            </iaixsl:choose> 
                        </input>
                        <button name="mailing_action" value="add" type="submit" class="btn --solid --medium add_newsletter">
                            <iaixsl:attribute name="title">Aanmelden</iaixsl:attribute>Aanmelden</button>
                        <button name="mailing_action" value="Wypisz się" type="submit" class="remove_newsletter">
                            <iaixsl:attribute name="title"/>Afmelden</button>
                    </div>
                    <div class="checkbox_container">
                        <input type="checkbox" name="agreement" id="newsletter_agreement" required="required"/>
                        <label for="newsletter_agreement">Ik accepteer<a href="/Polityka-prywatnosci-cterms-pol-66.html">voorwaarden van de nieuwsbrief</a></label>
                    </div>
                </div>
            </form>
        </div>
        ...
        <iaixsl:if test="/shop/@menu_newsletter"/>
        <iaixsl:if test="/shop/@menu_newsletter_remove"/>
