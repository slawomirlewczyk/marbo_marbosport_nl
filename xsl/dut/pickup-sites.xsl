...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/pickup_sites_list.js.gzip?r=1685223127</iaixsl:attribute></script></head>
        ...
        <!--Punkty odbioru - CMS (pickup_sites_cms, 107703.1)-->
            <iaixsl:if test="page/text/body">
                <div class="pickup_cms_label big_label">
                    <span class="pickup_cms_label">Aanvullende informatie</span>
                </div>
            ...
            <div id="pickup_site">
                    ...
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/pickups/deliveryaddress and /shop/page/pickups/google_api_key/@value and /shop/page/pickups/google_api_key/@value != ''">
                            <div class="locationField_sub">
                                <p class="pickup_list_desc">Voer uw adres in en zoek de dichtstbijzijnde persoonlijke ophaalpunten. Klik naast de kaart op een van de punten om uw bestelling daar af te halen.</p>
                       ...
                       <div class="locationField_sub">
                                <p class="pickup_list_desc"/>
                                <div id="locationField">
                                    <input id="autocomplete_location" class="autocomplete_nomap" type="text" value=""><iaixsl:attribute name="placeholder">Voer het adres in</iaixsl:attribute></input>
                                    <a class="btn --solid --medium">
                                        <span class="d-none d-sm-inline">Punten zoeken</span>
                                        <span class="d-sm-none"><i class="icon-search"></i></span>
                                    </a>
                    ...
                    <form id="pickup_list_form" method="post">
                                        ...
                                        <iaixsl:if test="/shop/page/pickups/deliveryaddress">
                                            <div class="map_button_search">
                                                <a href="#search_here" class="btn --solid --medium pickup_search_here">
                                                    <iaixsl:attribute name="title">Klik om punten in het gebied te zoeken</iaixsl:attribute>Doorzoek het gebied</a>
                                            </div>
                                        </iaixsl:if>
                                            ...
                                            <div>
                                                ...
                                                <iaixsl:if test="requires_client_number/text() = 'true'">
                                                    <input type="text" name="client_courier_number" disabled="true" required="required">
                                                        <iaixsl:attribute name="placeholder">Klantnummer in het koerierssysteem:</iaixsl:attribute>
                                                    </input>
                                                </iaixsl:if>
                                                <iaixsl:if test="info">
                                                    ...
                                                    <iaixsl:if test="time">
                                                        <div class="timeText">
                                                            <iaixsl:choose>
                                                                ...
                                                                <iaixsl:when test="delivery_time">De voorbereiding voor het persoonlijk ophalen zal<iaixsl:if test="delivery_time/@days  &gt; 0">
                                                                ...
                                                                <iaixsl:when test="delivery_time/@days = '0'">
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:otherwise>De voorbereiding voor het persoonlijk ophalen zal<iaixsl:value-of select="delivery_time/@hour"/>
                                                                            <iaixsl:choose>
                                                                                ...
                                                                                <iaixsl:otherwise>uren</iaixsl:otherwise>
                                                                            </iaixsl:choose>
                                                                        </iaixsl:otherwise>
                                                                    </iaixsl:choose>
                                                                </iaixsl:when>
                                                                <iaixsl:otherwise>De voorbereiding voor het persoonlijk ophalen zal<iaixsl:value-of select="delivery_time/@days"/>
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="delivery_time/@days = '1'">
                                                                             dzień
                                                                        </iaixsl:when>
                                        ...
                                        <a class="btn --solid --icon-left icon-globe map_dir" target="_blank">
                                            <iaixsl:attribute name="href">
                                                ...
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:otherwise>https://maps.google.com?saddr=Current+Location&amp;daddr=<iaixsl:value-of select="address"/>+<iaixsl:value-of select="zipcode"/>+<iaixsl:value-of select="city"/>
                                                    </iaixsl:otherwise>
                                                </iaixsl:choose>

                                            </iaixsl:attribute>De route bepalen</a>
                        ...
                        <iaixsl:if test="page/order_calendar/@type = 't'">
                            <div class="pickupl_hour_wrapper">
                                <span>U kunt ook uw voorkeursperiode aangeven</span>
                        ...
                        <div class="pickupl_submit">
                            <button class="btn --solid --large --icon-right icon-angle-right" type="submit">
                                ...
                                </iaixsl:if>Ga verder.</button>
                            <p class="pickupl_back">Indien u de leveringsvorm wenst te wijzigen, stuur dan terug naar<a id="pickup_site_back"><iaixsl:attribute name="href"><iaixsl:value-of select="page/pickups/@back"/></iaixsl:attribute><iaixsl:attribute name="title">Klik om terug te keren naar uw keuze van levering en betaling</iaixsl:attribute>keuze van levering en betaling</a>.</p>
                        </div>
                    </form>
                </div>
                ...
                <div id="pickup_copy" style="display:none;">
                    ...
                    <label class="pickup_point" required="required" data-id="" data-requires_client_number="" data-longitude="" data-latitude="" for="">
                        ...
                        <a class="btn --solid --icon-left icon-globe map_dir" target="_blank">De route bepalen</a>
                    </label>
                </div>
