...
<iaixsl:variable name="next_page_bottom">Volgende pagina</iaixsl:variable>
    ...
    <div class="products_bought row" id="products-bought">
        <div class="col-12">
            <h1 class="big_label">Lista zakupionych produktów</h1>
        </div>
        <form id="paging_setting_top" class="pb_search_setting pb_top col-12" action="/settings.php">
            <iaixsl:if test="not(/shop/page/navigation/@disable_sort_change = 'y')">
                <div class="s_paging__item --sort">
                    ...
                    <select class="pb_paging__select --order --small-md" id="select_top_sort" name="sort_order">
                        <option value="name-a" class="option_name-a"><iaixsl:if test="page/navigation/@sort = 'name' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op naam in oplopende volgorde</option>
                        <option value="name-d" class="option_name-d"><iaixsl:if test="page/navigation/@sort = 'name' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op naam in aflopende volgorde</option>
                        <option value="price-a" class="option_price-a"><iaixsl:if test="page/navigation/@sort = 'price' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteer op prijs in oplopende volgorde</option>
                        <option value="price-d" class="option_price-d"><iaixsl:if test="page/navigation/@sort = 'price' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op prijs in aflopende volgorde</option>
                        <option value="date-a" class="option_date-a"><iaixsl:if test="page/navigation/@sort = 'date' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op datum in oplopende volgorde</option>
                        <option value="date-d" class="option_date-d"><iaixsl:if test="page/navigation/@sort = 'date' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op datum in aflopende volgorde</option>
                    </select>
                </div>
            </iaixsl:if>
            ...
            <iaixsl:if test="count(page/navigation/item) &gt; 1">
                <div id="s_paging_top" class="pb_paging_top d-none d-md-block">
                    <ul class="pagination">
        ...
        <div class="col-12">
            <div id="products-bought__list" class="products-bought__list">
                <div class="pb_list_header row d-none d-md-flex">
                    ...
                    <div class="pb_header_date col-2">Datum van laatste aankoop</div>
                                ...
                                <div class="row align-items-center products-bought__product-inner">
                                    ...
                                    <div class="col-md-1 col-12 mb-3 mb-md-0">
                                        <div class="products-bought__product-icon">
                                            <a>
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                                <img class="basket_prod rwd-src" alt="Szczegoly" src="/gfx/pol/loader.gif?r=1612518076">
                                    ...
                                    <div class="col-md-2 col-12 mb-3 mb-md-0">
                                        <div class="products-bought__product-date">
                                            <span class="d-block d-md-none">Datum van laatste aankoop</span>
                                        ...
                                        <div class="products-bought__product-button">
                                            <iaixsl:choose>
                                                <iaixsl:when test="sizes/size[@buy_date]/@amount = 0">
                                                    <span class="products-bought__product-unavailable">Product niet beschikbaar</span>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --solid --medium">
                                                        <iaixsl:attribute name="href"><iaixsl:value-of select="add_to_basket"/></iaixsl:attribute>
                                                        <iaixsl:attribute name="title">Voeg toe aan winkelkar</iaixsl:attribute>Voeg toe aan winkelkar</a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </div>
                                    </div>
        ...
        <form id="paging_setting_bottom" class="pb_search_setting pb_down col-12" action="/settings.php">
            <iaixsl:if test="not(/shop/page/navigation/@disable_sort_change = 'y')">
                <div class="s_paging__item --sort d-none d-md-block">
            ...
            <iaixsl:if test="count(page/navigation/item) &gt; 1">
                <div id="s_paging_bottom" class="pb_paging_bottom">
                    <ul class="pagination">
