...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/contact_address.js.gzip?r=1612518076</iaixsl:attribute></script></head>
    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
        ...
        <!--Dane kontaktowe na stronie Kontakt (contact_contact, 115022.1)-->
        ...
        <div class="row" id="contact_page__top_info">
        <div id="contact_contact" class="col-md-6 col-12">
            <h2>
                <iaixsl:attribute name="class">big_label</iaixsl:attribute>Heb je vragen?</h2>            
            <div class="contact_contact_sub"> 
                <div class="contact_contact_faq">
					<a>
						<iaixsl:attribute name="href">/FAQ-chelp-pol-251.html</iaixsl:attribute>Kijk maar.<b>FAQ</b>(Veelgestelde vragen)</a>
                </div>
                <div class="contact_contact_phone">

                    <iaixsl:if test="/shop/page/contact/contact_nodes/node[@type = 'phone']">
                        <p>
                            <iaixsl:attribute name="class">icon_contact_phone</iaixsl:attribute>

                            <iaixsl:for-each select="/shop/page/contact/contact_nodes/node[@type = 'phone']">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="/shop/page/contact/contact_nodes/node[@type = 'mail']">
                        <p>
                            <iaixsl:attribute name="class">icon_contact_email</iaixsl:attribute>

                            <iaixsl:for-each select="/shop/page/contact/contact_nodes/node[@type = 'mail']">
                                <iaixsl:choose>
                                    <iaixsl:when test="@link">
                                        <a>
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                    ...
                    <iaixsl:if test="/shop/page/contact/contact_nodes/node[@type = 'fax']">
                        <p>
                            <iaixsl:attribute name="class">icon_contact_fax</iaixsl:attribute>

                            <iaixsl:for-each select="/shop/page/contact/contact_nodes/node[@type = 'fax']">
                                <iaixsl:choose>
                                    <iaixsl:when test="@link">
                                        <a>
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
         ...
         <div id="contact_address" class="col-md-6 col-12">
            <h2><iaixsl:attribute name="class">big_label</iaixsl:attribute>Winkelier</h2>
            <div class="contact_address_sub">
                <div class="contact_address_sub_sub_1">
                        ...
                        <div class="contact_data_address"> 
                            <div class="contact_data_address_sub">
                                ...
                                <iaixsl:if test="/shop/page/contact/owner_data/@zipcode or /shop/page/contact/owner_data/@city">
                                    <p id="contact_address_city"><iaixsl:value-of select="/shop/page/contact/owner_data/@zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="/shop/page/contact/owner_data/@city"/></p>
                                </iaixsl:if>
                ...
                <div class="contact_address_sub_sub_2">
                    <iaixsl:if test="/shop/page/contact/contact_nodes/node[@type != 'phone' and @type != 'mail' and @type != 'fax']">
                            <iaixsl:for-each select="/shop/page/contact/contact_nodes/node[@type != 'phone' and @type != 'mail' and @type != 'fax']">
                    <p><strong><iaixsl:value-of select="@title"/>:</strong><span><iaixsl:value-of select="@value"/></span></p>
                    </iaixsl:for-each>
                    </iaixsl:if>
                </div>
            </div>
        ...
        <!--Dane adresowe na stronie Kontakt (contact_address, 112677.1)-->
                        ...
                        <div class="loadingMap">
                            <div class="loadingContent">
                                <div class="loadingBox">
                                    ...
                                    <span class="loadingAdres">Adres zoeken</span>
                                    <img class="loadingMapImg" src="/gfx/pol/mapLoader.gif?r=1612518076" alt=""/>
                                </div>
                            </div>
                        </div>
                        <img class="marker_face" src="/gfx/pol/marker_face.png?r=1612518076" alt=""/>
            ...
            <div id="stocks_contact4" class="row">
                <div class="col-12">
                    <h2><iaixsl:attribute name="class">big_label</iaixsl:attribute>Bezoek een van onze winkels</h2>
                    <p>Wilt u uw bestelling zelf afhalen of ons assortiment bekijken, dan kan dat in een van onze vele winkels. Controleer de adressen en levertijden om de winkel te kiezen die het beste bij uw behoeften past.</p>
                    <a href="/stock.php" class="btn --solid --medium">Bekijk onze winkels</a>
                </div>
            </div>
        <!--CMS na stronie Kontaktu (contact_cms, 116888.1)-->
