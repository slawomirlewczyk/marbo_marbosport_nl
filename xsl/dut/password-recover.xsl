        ...
        <!--Formularz przypomnienia hasła (password-recover, 108083.1)-->
            ...
            <div id="signin_password_recovery">
                ...
                <div class="row flex-column align-items-center ">
                    <p class="reminder_desc col-12 col-sm-6 mb-3">Er wordt een e-mail naar uw adres gestuurd waarmee u automatisch kunt inloggen. U kunt uw wachtwoord wijzigen nadat u bent ingelogd op de pagina Uw gegevens bewerken.</p>
                    <form class="password-recover col-12 col-sm-6 mb-3" action="/password-recover.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-desc">Voer het e-mailadres in dat u bij de registratie hebt opgegeven of het nummer van uw klantenkaart:</div>
                        </div>
                        <button class="signin_password-recover btn --solid --medium" type="submit">Stuur e-mail</button>
                    </form>

                    <div class="password_recovery_phone col-12 col-sm-6">Als u uw gebruikersnaam niet meer weet of als u, om welke reden dan ook, het e-mailadres dat u bij de registratie hebt opgegeven niet kunt ontvangen, bel ons dan op<b><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/login/response/@tel"/></b><iaixsl:text> </iaixsl:text>of door een e-mail te sturen naar het volgende adres<iaixsl:text> </iaixsl:text><a class="mail_54144"><iaixsl:attribute name="href">mailto:<iaixsl:value-of select="page/login/response/@email"/></iaixsl:attribute><iaixsl:value-of select="page/login/response/@email"/></a>.
                    </div>
                </div>
            </div>
