...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/basketedit_rebates.js.gzip?r=1685223127</iaixsl:attribute></script><script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/basketedit_productslist.js.gzip?r=1685223127</iaixsl:attribute></script>
            <script>
                app_shop.runApp();
            </script>
