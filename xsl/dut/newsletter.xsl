                    ...
                    <div class="newsletter_message_wrapper">
                        <div class="newsletter_message n54531_outline">
                            ...
                            <div class="n54531_outline_sub">
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_addsuccess'">Bedankt voor uw inschrijving op onze nieuwsbrief. De volgende nieuwsbrieven komen rechtstreeks in uw inbox. Om er zeker van te zijn dat u ze allemaal krijgt, raden wij u aan de e-mail van onze winkel toe te voegen aan uw adresboek.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_maileregerror'">Het opgegeven e-mailadres is onjuist.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_removesuccess'">Uw e-mail is uitgeschreven uit de nieuwsbrief database.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_nosuchemail'">Het door u ingevoerde e-mailadres is niet gevonden in de nieuwsbriefdatabase.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_sendingconfirm'">Er werd een e-mail gestuurd naar het opgegeven adres met een link om het abonnement op de nieuwsbrief te bevestigen.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_emailexist'">Het opgegeven e-mailadres zit al in onze database.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_sendingconfirm_remove'">Naar het opgegeven adres is een e-mail gestuurd met een link om de afmelding voor de nieuwsbrief te bevestigen.</iaixsl:when>
                                </iaixsl:choose>
                            </div>
                        </div>
                    </div>
                    ...
                    <iaixsl:when test="not(/shop/page/communicates_newsletter/message) or (/shop/page/communicates_newsletter/message/@type = 'mailing_maileregerror') or (/shop/page/communicates_newsletter/message/@type = 'mailing_emailexist') or (/shop/page/communicates_newsletter/message/@type = 'mailing_nosuchemail')">
                        <iaixsl:choose>
                                        ...
                                        <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="$account_email_info">
                                                    <p class="col-md-6 col-12">U bent al geabonneerd op onze nieuwsbrief. Het e-mailadres dat aan uw account is toegewezen is<b><iaixsl:value-of select="/shop/page/client/@email"/></b>.<br/>U kunt zich te allen tijde uitschrijven door op onderstaande knop te klikken.</p>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <p class="col-md-6 col-12">U bent al geabonneerd op onze nieuwsbrief. U kunt zich te allen tijde uitschrijven door op onderstaande knop te klikken.</p>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                            ...
                                            <div class="newsletter_button_wrapper col-md-6 col-12">
                                                <button id="newsletter_button_remove" type="submit" class="btn --solid --secondary">
                                                    <iaixsl:attribute name="value">Afmelden</iaixsl:attribute>Afmelden</button>
                                            </div>
                                        </form>
                                    </iaixsl:when>
                                        ...
                                        <iaixsl:choose>
                                            ...
                                            <iaixsl:when test="/shop/page/client/@email != ''">
                                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                                    ...
                                                    <p id="newsletter_longdesc" class="col-md-6 col-12">U bent niet ingeschreven voor onze nieuwsbrief. Wilt u op de hoogte blijven van nieuws en acties in de winkel, klik dan op onderstaande knop. De nieuwsbrief wordt verstuurd naar<strong><iaixsl:value-of select="page/client/@email"/></strong>die u als contactadres heeft opgegeven. Als u het e-mailadres waarnaar de nieuwsbrief wordt gestuurd wilt wijzigen, ga dan naar<a href="/loginedit.php?operation=edit">bewerken van contactgegevens</a></p>
                                                    <input name="mailing_email" type="hidden">
                                                        <iaixsl:attribute name="value"><iaixsl:value-of select="page/client/@email"/></iaixsl:attribute>
                                                    </input>
                                                    ...
                                                    <div id="newsletter_privacy_consent" class="form-group col-md-6 col-12">
                                                        <div class="has-feedback">
                                                            <label class="control-label d-flex align-items-center">
                                                                ...
                                                                <div class="text_to_left">Ik wil graag de e-mail nieuwsbrief ontvangen. Ik geef toestemming voor de verwerking van mijn persoonsgegevens voor marketingdoeleinden in overeenstemming met<a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/private_policy/@url"/></iaixsl:attribute>privacybeleid</a>
                                                                </div>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="newsletter_button_wrapper col-md-6 col-12">
                                                        <button id="newsletter_button_add" type="submit" class="btn --solid">
                                                            <iaixsl:attribute name="value">Aanmelden</iaixsl:attribute>Aanmelden</button>
                                                    </div>
                                                </form>
                                            </iaixsl:when>
                                            ...
                                            <iaixsl:otherwise>
                                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                                    <input id="mailing_action_contact" name="mailing_action" value="add" type="hidden"/>
                                                    <p id="newsletter_longdesc" class="col-md-6 col-12">U bent niet ingeschreven voor onze nieuwsbrief. Wilt u op de hoogte blijven van nieuws en acties in de winkel, vul dan het e-mailadres in waarop u de nieuwsbrief wilt ontvangen en klik op onderstaande knop. Het e-mailadres dat u invoert wordt toegewezen aan de contactgegevens in uw profiel. U kunt dit te allen tijde wijzigen met behulp van de<a href="/loginedit.php?operation=edit">bewerken van contactgegevens</a></p>

                                                    <div class="form-group col-md-6 col-12">
                                                        <div class="has-feedback">
                                                            <input class="newsletter_form_field form-control validate" name="mailing_email" id="mailing_email" type="text" data-validate="email"/>
                                                            <label for="mailing_email" class="control-label">Voer uw e-mail in</label>
                                                    ...
                                                    <div class="form-group col-md-6 col-12">
                                                        <div class="has-feedback">
                                                            ...
                                                            <label for="mailing_name" class="control-label">Vermeld uw naam</label>
                                                            <span class="form-control-feedback"/>
                                                        </div>
                                                    </div>
                            ...
                            <iaixsl:otherwise>
                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                    <input id="mailing_action_contact" name="mailing_action" value="add" type="hidden"/>
                                    <p class="col-md-6 col-12">Voer uw e-mailadres in en klik op de juiste knop om u aan of af te melden voor onze nieuwsbrief.</p>
                        ...
                        <div class="newsletter_button_wrapper">
                            <a class="btn --solid" href="/">
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:otherwise>
                                        <iaixsl:attribute name="title">Homepage</iaixsl:attribute>Homepage</iaixsl:otherwise>
                                </iaixsl:choose>
                            </a>
                        </div>
                    </iaixsl:otherwise>
