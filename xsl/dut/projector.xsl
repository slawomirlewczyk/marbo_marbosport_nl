        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <iaixsl:if test="/shop/page/@type = 'main' or /shop/page/@type = 'search' or /shop/page/@type = 'place-order' or /shop/page/@type = 'noproduct' or ($projector_script_bottom and /shop/page/@type = 'projector')">
                <iaixsl:choose>
                    ...
                    <iaixsl:otherwise>
                        <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/shop.js.gzip?r=1612518058</iaixsl:attribute></script>
                    </iaixsl:otherwise>
                </iaixsl:choose>
            </iaixsl:if>
            <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/menu_alert.js.gzip?r=1612518058</iaixsl:attribute></script>
            <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/projector_photos.js.gzip?r=1612518058</iaixsl:attribute></script><script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/projector_details.js.gzip?r=1612518058</iaixsl:attribute></script><script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/projector_bundle_zone.js.gzip?r=1612518058</iaixsl:attribute></script><script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/projector_components_hiding.js.gzip?r=1612518058</iaixsl:attribute></script><script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/projector_projector_opinons_form.js.gzip?r=1612518058</iaixsl:attribute></script>
            <script>
                app_shop.runApp();
            </script>
