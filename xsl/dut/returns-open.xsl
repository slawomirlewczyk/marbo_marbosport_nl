        ...
        <!--Returns Open Form (returns_open_form, 112619.1)-->
			<section class="returns_open mb-4">
				...
				<h1 class="returns_open__label headline">
					<span class="returns_open__label_txt headline__name">Selecteer de bestelling waaruit u het product wilt terugsturen</span>
				</h1>

				
				<div class="returns_open__description menu_messages_message mb-4">
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/returns-open/@returns_exist_link and not(/shop/page/returns-open/@returns_exist_link = '')">Er is al een retour gegenereerd voor deze bestelling. Controleer de status van uw huidige aanvragen of voeg een nieuwe toe via het retourpaneel.</iaixsl:when>
                        <iaixsl:when test="/shop/page/returns-open/@client = 'false' or /shop/page/returns-open/@client_orders = 'true'">Om een product te retourneren, geeft u het bestelnummer op waarin het is verzonden (u vindt dit in de e-mail die u na het plaatsen van uw bestelling hebt ontvangen) en uw telefoonnummer of e-mailadres.</iaixsl:when>
                        <iaixsl:otherwise>Er is geen bestelling geplaatst op deze rekening. Daarom kunt u de klachtenprocedure niet starten. Als u een klacht wilt indienen over een bestelling die vanaf een andere rekening of zonder registratie is uitgevoerd, vul dan onderstaand formulier in.</iaixsl:otherwise>
                    </iaixsl:choose>
				</div>
                    ...
                    <iaixsl:when test="/shop/page/returns-open/@returns_exist_link and not(/shop/page/returns-open/@returns_exist_link = '')">
                        <div class="returns_open__exists d-flex align-items-center flex-column">
                            <a class="returns_open__exist btn --solid --medium mb-3">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/returns-open/@returns_exist_link"/></iaixsl:attribute>Ga naar de terugkeer</a>
                            <a class="returns_open__new btn --solid --medium mb-3">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/returns-open/@returns_new_link"/></iaixsl:attribute>Een nieuwe aangifte indienen</a>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
						<form action="/returns-open.php" method="post" class="returns_open__form row flex-column align-items-center mb-4" novalidate="novalidate">
							<div class="returns_open__inputs col-12 col-sm-7">
								...
								<div class="f-group returns_open__number">
									<div class="f-feedback returns_open__feedback --number">
										...
										<label for="returns_open__number_input" class="f-label">Bestelnummer:</label>
								...
								<div class="f-group returns_open__email">
									<div class="f-feedback returns_open__feedback --email">
										...
										<label for="returns_open__email_input" class="f-label">Uw telefoon of e-mail:</label>
										<span class="f-control-feedback"/>
									</div>
								</div>
							</div>
							...
							<div class="returns_open__submit col-12 col-sm-7 d-flex flex-column align-items-center">
								<button class="btn --solid --medium px-5 returns_open__button">Een bestelling vinden</button>
						...
						<div class="returns_open__signin d-flex justify-content-center">
							<a class="returns_open__signin_link">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/></iaixsl:attribute>Ik heb een geregistreerde account en wil toegang tot mijn bestellijst</a>
						</div>
					</iaixsl:otherwise>
				</iaixsl:choose>
			</section>
