		...
		<iaixsl:choose>
			...
			<iaixsl:when test="/shop/page/newslist">
				<section id="news_list" class="article mb-4">
					<h1 class="headline">
						<span class="headline__name">Nieuws</span>
					</h1>
					...
					<iaixsl:choose>
						...
						<iaixsl:when test="not(/shop/page/newslist/mainpage1)">
							<div class="menu_messages_message" id="menu_messages_warning">
								<div class="menu_messages_warning_sub">
									<p>Er zijn geen updates op dit moment.</p>
								</div>
							</div>
						</iaixsl:when>
						<iaixsl:otherwise>
        ...
        <!--Facebook comments News (news_facebook_comments, 107868.1)-->
            <iaixsl:if test="page/facebook_comments">
                <div class="news_fb_comments">
                    <div class="big_label news_fb_comments_label">Deel uw opmerkingen met anderen</div>
                    <div id="fb-root"/>
                    <script>
