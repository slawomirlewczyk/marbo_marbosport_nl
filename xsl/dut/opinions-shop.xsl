        ...
        <!--opinie o sklepie (opinions_shop_display, 114534.1)-->
			<iaixsl:if test="/shop/page/opinions-shop/comments/@all &gt; '0'">
				<section id="opinions_shop" class="opinions_shop">
					...
					<h2 class="headline">
						<span class="headline__name">Klantbeoordelingen van onze winkel</span>
					</h2>
					...
					<div class="opinions_shop__container row">
						...
						<div class="opinions_shop__block --average col-12 d-sm-flex flex-sm-wrap align-self-md-start col-md-4 col-lg-3">
							...
							<div class="opinions_shop__average mb-5 px-0 col-sm-6 pr-sm-3 col-md-12 pr-md-0">
								...
								<div class="opinions_shop__total_reviews">Het aantal beoordelingen van onze klanten:<iaixsl:value-of select="/shop/page/opinions-shop/comments/@all"/></div>
							</div>
							...
							<div class="opinions_shop__sorts_wrapper mb-5 px-0 col-sm-6 pl-sm-3 col-md-12 pl-md-0 mb-md-0">
								...
								<div class="opinions_shop__sorts">
									<a class="opinions_shop__sort d-flex align-items-center mb-2" href="#5" data-rate="5">
										...
										<span class="opinions_shop__sort_star"><i class="icon-star"></i></span>
								...
								<div class="opinions_shop__guide">Klik op een beoordeling om meningen te filteren</div>
							</div>
						</div>
						...
						<div class="opinions_shop__block --opinions col-12 col-md-8 ml-lg-auto">
									...
									<div class="opinions_shop__opinion pb-5 mb-5">
										...
										<div class="opinions_shop__opinion_bottom d-flex justify-content-between align-items-center flex-wrap">
											...
											<div class="opinions_shop__rate d-flex align-items-center ml-auto mb-2">
												<span class="opinions_shop__rate_text">Was het advies nuttig?</span>
												...
												<a href="#thumbs_down" class="opinions_shop__thumbs --down ml-3"><i class="icon-thumbs-down"></i>Niet<span class="opinions_shop__rate_count"><iaixsl:value-of select="@rate_no"/></span></a>
											</div>
										</div>
										
										<iaixsl:if test="response and response != ''">
											<div class="opinions_shop__response mt-4 p-3">
												<div class="opinions_shop__response_top"><strong>Winkel reactie</strong><span class="opinions_shop__response_date"><iaixsl:value-of select="response/@date"/></span></div>
							...
							<iaixsl:if test="/shop/page/opinions-shop/comments/@limited = 'true'">
								<div class="opinions_shop__more_wrapper d-flex justify-content-center">
									<a class="opinions_shop__more btn --medium --solid" id="more_opinion" href="#more">
										...
										<iaixsl:attribute name="data-all"><iaixsl:value-of select="$all"/></iaixsl:attribute>Meer tonen<span>
											<iaixsl:choose>
							...
							<div class="menu_messages_message" id="no_opinions_of_type">Geen recensies met dit aantal sterren.</div>
						</div>
					</div>
				</section>
				...
				<div class="opinions_shop__opinion --skeleton pb-5 mb-5">
					...
					<div class="opinions_shop__opinion_bottom d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="opinions_shop__rate d-flex align-items-center ml-auto mb-2">
							...
							<a href="#thumbs_down" class="opinions_shop__thumbs --down ml-3"><i class="icon-thumbs-down"></i>Niet<span class="opinions_shop__rate_count"/></a>
						</div>
					</div>
					
					<div class="opinions_shop__response mt-4 p-3">
						<div class="opinions_shop__response_top"><strong>Winkel reactie</strong><span class="opinions_shop__response_date"/></div>
				...
				<div class="opinions_shop__more_wrapper --skeleton d-flex justify-content-center">
					<a class="opinions_shop__more btn --medium --solid" id="more_opinion" href="#more">
						...
						<iaixsl:attribute name="data-all"/>Meer tonen<span/>
					</a>
				</div>
			</iaixsl:if>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/opinions_shop_display.js.gzip?r=1685223127</iaixsl:attribute></script>
            <script>
                app_shop.runApp();
            </script>
