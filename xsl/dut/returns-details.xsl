...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
    ...
    <!--Zwroty szczegóły (returns_details_form, 107773.1)-->
        ...
        <iaixsl:if test="page/@display = 'details'">
            ...
            <iaixsl:variable name="n5_4atxt">Nadaj paczkę <small>U betaalt niets extra's voor het verzenden van</small></iaixsl:variable>
            ...
            <div class="step7">
                ...
                <div id="orderdetails_info">
                    ...
                    <h2 class="big_label">
                        <span>Details retourneren</span>
                        <span class="order-date">datum van opstelling van de aangifte:<iaixsl:value-of select="page/details/@datetime"/>
                        </span>
                    </h2>
                    <div id="orderdetails_info_status">
                        ...
                        <div class="prepaid-status">
                            ...
                            <small>Retour nr:<iaixsl:value-of select="page/details/@id"/></small>
                        </div>

                        <div class="prepaid-buttons">
                            <iaixsl:if test="/shop/page/editlink/@url">
                                <a class="btn-icon prepaid-edit">
                                    <iaixsl:attribute name="title">Klik om de terugkeer te bewerken.</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute><small><i class="icon-pencil"></i></small><span>Verander de zin</span></a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/page/cancellink/@url">
                                <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                    ...
                                    <iaixsl:attribute name="title">Annuleer terugkeer</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cancellink/@url"/></iaixsl:attribute>
                                    <small><i class="icon-remove"></i></small><span>Annuleer terugkeer</span>
                                </a>
                            </iaixsl:if>
                        </div>
                    </div>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="/shop/page/return_method/@id='2' and $n5_4atxt">
                        <div class="return_image_i">
                            <div class="text-1a">Afdrukken van aangifte en etiketten voor retourzendingen</div>
                            <div class="text-2a">Het pakket voorbereiden<small>Voeg het retourformulier en het aankoopbewijs bij</small></div>
                            <div class="text-3a">Pakket verzenden<small>U betaalt niets extra's voor het verzenden van</small></div>
                            <img src="/gfx/dut/instukcja_zwrot2.png?r=1612518076" alt=""/>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <div class="return_image_i">
                            <div class="text-1">Druk het retourformulier en het etiket af</div>
                            <div class="text-2">Het pakket voorbereiden<small>Voeg het retourformulier en het aankoopbewijs bij</small></div>
                            <div class="text-3">Plak het etiket op de verpakking</div>
                            <div class="text-4">Pakket verzenden</div>
                            <img src="/gfx/dut/instukcja_zwrot.png?r=1612518076" alt=""/>
                        </div>
                    </iaixsl:otherwise>
                </iaixsl:choose>
                ...
                <iaixsl:if test="/shop/page/documentlink/@url">
                    <div class="return_wrapper2">
                        <a class="btn --solid --large" target="blank">
                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/documentlink/@url"/></iaixsl:attribute>De aangifte van terugkeer afdrukken</a>
                ...
                <iaixsl:if test="page/returnproducts/products/product">
                    ...
                    <div id="prepaid_order_products">
                        <h2 class="big_label">Teruggestuurd product</h2>
                                        ...
                                        <td class="ordered-name">
                                            ...
                                            <iaixsl:if test="order_files/file">
                                                <div class="ordered-files">
                                                    <label>Bijgevoegde bestanden:</label>
                                                    <ul>
                                            ...
                                            <iaixsl:if test="@product_type = 'product_virtual'">
                                                <div class="ordered-info">Downloadbare bestanden verschijnen in de<a>
                                                        <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/client_files/@link_to_download"/></iaixsl:attribute>"Moje pliki"</a>in het klantenpaneel nadat de hele bestelling is betaald.</div>
                                            </iaixsl:if>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5" class="rma-remarks">
                                                ...
                                                <div class="rma-remarks">
                                                    <b class="rma-remarks">Beschrijving:</b>
                ...
                <iaixsl:if test="/shop/page/repayment_method or /shop/page/return_method">
                    <div class="returns_details_wrapper">
                        <table class="returns_details_table">
                            <tbody>
                                <tr>
                                    <th class="returns_details_name">Wijze en vorm van terugzending van het product</th>
...
<iaixsl:when test="/shop/page/return_method/@description">
                                                    <span class="product_name">Wijze van retourneren van producten:<iaixsl:value-of select="/shop/page/return_method/@name"/>
                                                    </span>
                                                ...
                                                <iaixsl:when test="/shop/page/return_method/@id = 1">
                                                    <span class="product_name">Sposób zwrotu produktów:
                                                        Dostarczę osobiście do jednego z punktów obsługi zwrotów</span>
                                                    <div class="return_description">Ik verbind mij ertoe het pakket persoonlijk af te leveren bij het gekozen retourservicepunt.</div>
                                                </iaixsl:when>
                                                <iaixsl:when test="/shop/page/return_method/@id = 2">
                                                    <span class="product_name">Sposób zwrotu produktów:
                                                        Skorzystam z przesyłek sklepu</span>
                                                    <div class="return_description">De vergoeding zal worden afgetrokken van de waarde van de geretourneerde producten.</div>
                                                </iaixsl:when>
                                                <iaixsl:when test="/shop/page/return_method/@id = 3">
                                                    <span class="product_name">Sposób zwrotu produktów:
                                                        Wyślę samodzielnie i samodzielnie opłacę przesyłkę</span>
                                                    <div class="return_description">Ik verbind mij ertoe het pakket zelf te verzenden en alle kosten voor het terugbrengen naar de winkel te dragen.</div>
                                                </iaixsl:when>
                                        ...
                                        <td class="returns_details_name float_icon">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 't'">
                                                    <span class="product_name">Vorm van vergoeding: Saldo klant</span>

                                                    <div class="return_description">Ik kies ervoor om het bedrag terug te storten in het saldo van de klant, te gebruiken bij verdere aankopen in de winkel.</div>

                                                </iaixsl:when>
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
                                                    <span class="product_name">Vorm van vergoeding: Transfer</span>
                                                    <div class="return_description">De tegenwaarde van uw aankopen wordt via een bankoverschrijving op uw rekening teruggestort.</div>
                                                </iaixsl:when>
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
                                                    <span class="product_name">Vorm van terugbetaling: Handelskrediet herstellen</span>
                                                    <div class="return_description">De tegenwaarde van uw aankopen wordt toegevoegd aan uw saldo in de vorm van een handelskrediet.</div>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                ...
                <iaixsl:if test="/shop/page/remarks">
                    <div class="returns_details_wrapper">
                        <h2 class="big_label">Opmerkingen over de terugkeer</h2>
                ...
                <iaixsl:if test="/shop/page/pickup/name">
                    <div class="returns_details_wrapper">
                        <h2 class="big_label">Retouradres</h2>
                        <div class="returns_details_w_sub">
                                ...
                                <div class="pickupl_return_one_sub">
                                    <div class="pickupl_return_one_link">
                                        <a target="_blank" class="btn --solid">
                                            <iaixsl:attribute name="title">Zie details</iaixsl:attribute>
                                            <iaixsl:attribute name="href">
                                                <iaixsl:value-of select="/shop/page/pickup/link"/>
                                            </iaixsl:attribute>Zie details</a>
                                    </div>
                    ...
                    <div class="basketedit_summary_right">
                        <div class="basketedit_calculations">
                            <iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Waarde van geretourneerde producten:</label>
                            ...
                            <iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Terugbetaling van de leveringskosten aan de klant:</label>
                            ...
                            <iaixsl:if test="/shop/page/costs/cost[@type='shop_shipping']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Retour verzendkosten:</label>
                        ...
                        <iaixsl:if test="/shop/page/costs/@value_formatted">
                            <div class="basketedit_total_summary">
                                <label>Wordt teruggebracht:</label>
            ...
            <div class="prepaid_summary_buttons">
                <iaixsl:if test="page/backlink/@url">
                    <a class="btn --solid --medium">
                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/backlink/@url"/></iaixsl:attribute>Een ander product terugsturen</a>
                </iaixsl:if>
                <iaixsl:if test="page/backlink_other/@url">
                    <a class="btn --solid --medium">
                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/backlink_other/@url"/></iaixsl:attribute>Een ander product terugsturen</a>
                </iaixsl:if>
            </div>
        </iaixsl:if>

        <div id="menu_notice" style="display: none;">
            <h2>Annulering van retourzending</h2>
            <strong>Het annuleren van een aangifte is een onomkeerbare actie. Om verder te gaan, drukt u op de annuleer terug knop.</strong>
            <div class="menu_notice_button">
                <button onclick="$('#dialog_close').click();" class="prepaid_cancel btn --solid">Venster sluiten</button>
                <button class="prepaid_confirm btn --solid">Annuleer terugkeer</button>
            </div>
            <div class="clearboth"/>
        </div>
