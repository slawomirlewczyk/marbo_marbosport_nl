                ...
                <iaixsl:choose>
                    <iaixsl:when test="page/client_files/@mode = 'to_download'">
                        <div class="n68137_downloadable">
                            <div class="big_label n68137_label">
                                <span class="n68137_label">Informatie over het downloaden van gekochte bestanden</span>
                            </div>
                                ...
                                <iaixsl:for-each select="/shop/page/client_files/product_data">
                                    <div class="n68137_file">
                                        ...
                                        <div class="n68137_files_description">
                                            ...
                                            <div class="n68137_files_description_order"><span class="n68137_desc_label">Bestelnummer:</span><span class="n68137_desc_value"><a class="n68137_desc_value"><iaixsl:attribute name="href"><iaixsl:value-of select="@order_link"/></iaixsl:attribute><iaixsl:value-of select="@order_sn"/></a></span></div>
                                            <div class="n68137_files_description_availability">
                                                <span class="n68137_desc_label">Beschikbaarheid:</span>
                                                <span class="n68137_desc_value">
                                                    <iaixsl:choose>
                                                        <iaixsl:when test="@available = 'y'">
                                                            plik jest dostępny do pobrania
                                                        </iaixsl:when>
                                                        <iaixsl:otherwise>het bestand kan niet worden gedownload omdat de bestelling niet is betaald</iaixsl:otherwise>
                                                    </iaixsl:choose>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="@available = 'y'">
                                                <button class="btn --solid n68137_files_download">Bestanden downloaden</button>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                <a class="btn --solid n68137_files_pay">
                                                    <iaixsl:attribute name="href"><iaixsl:value-of select="@order_link"/></iaixsl:attribute>Betaal uw bestelling</a>
                                            </iaixsl:otherwise>
                                        </iaixsl:choose>
                                        ...
                                        <div class="n68137_popup">
                                            ...
                                            <div class="big_label n68137_label_popup">Informatie over het downloaden van bestanden</div>
                                            <div class="n68137_description_popup">Selecteer het gewenste bestandsformaat en klik op downloaden - het downloaden van het bestand begint automatisch.<br/><br/>
                                            ...
                                            <div class="n68137_files_description_popup">
                                                <div class="n68137_desc_popup">
                                                    ...
                                                    <div class="n68137_desc_availability_popup">beschikbaar om te downloaden<iaixsl:choose>
                                                            ...
                                                            <iaixsl:otherwise>
                                                                ...
                                                                <iaixsl:choose>
                                                                    ...
                                                                    <iaixsl:otherwise>keer</iaixsl:otherwise>
                                                                </iaixsl:choose>
                                                ...
                                                <a class="btn --solid n68137_files_download_popup">
                                                    ...
                                                    <span class="n68137_button_label_popup">Downloaden in formaat<span class="n68137_button_value_popup"><iaixsl:value-of select="@file_extension"/></span>
                                                    </span>
                                                </a>
                                                <div class="clearDiv"/>
                                            </div>
                    ...
                    <iaixsl:when test="page/client_files/@mode = 'not_available'">
                        <div class="n68137_notdownloadable">
                            <div class="big_label n68137_label">
                                <span class="n68137_label">Informatie over bestanden die niet meer kunnen worden gedownload</span>
                            </div>
                            ...
                            <div class="n68137_files">
                                <iaixsl:for-each select="/shop/page/client_files/product_data">
                                    <div class="n68137_file">
                                        ...
                                        <div class="n68137_files_description">
                                            <a class="n68137_desc_name"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
                                            <div class="n68137_files_description_order"><span class="n68137_desc_label">Bestelnummer:</span><a class="n68137_desc_value"><iaixsl:attribute name="href"><iaixsl:value-of select="@order_link"/></iaixsl:attribute><iaixsl:value-of select="@order_sn"/></a></div>
                                            <div class="n68137_files_description_availability">
                                                <span class="n68137_desc_label">Beschikbaarheid:</span>
                                                <span class="n68137_desc_value">
                                                    <iaixsl:choose>
                                                        ...
                                                        <iaixsl:otherwise>bestand niet beschikbaar</iaixsl:otherwise>
                                                    </iaixsl:choose>
                                                </span>
                                            </div>
                                        </div>
                                        <iaixsl:if test="@available='y'">
                                            <a class="btn --solid n68137_files_buy">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>Voeg toe aan winkelkar</a>
                                        </iaixsl:if>
                                        <div class="clearDiv"/>
                                    </div>
                                </iaixsl:for-each>
