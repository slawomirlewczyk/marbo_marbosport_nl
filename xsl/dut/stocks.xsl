    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
        ...
        <!--CMS - Informacja o magazynach (stocks_cms, 107926.1)-->
            <iaixsl:if test="page/text/body">
                <div class="stocks_cms_label  big_label">Aanvullende informatie</div>
        ...
        <iaixsl:if test="count(page/stocks/stock) &gt; 0">
            ...
            <div class="stocks_list_outline">
                <div class="stocks_list_label">
                    ...
                    <span class="stocks_list_label">Lijst van inzamelpunten</span>
                </div>
                        ...
                        <div class="loadingMap">
                            <div class="loadingContent">
                                <div class="loadingBox">
                                    ...
                                    <span class="loadingMarkers">Laadplaatsen<span class="loadingMarkersComplete"/>
                                         z 
                            ...
                            <p class="stocks_list_stock">
                                ...
                                <iaixsl:if test="@link != ''">
                                    <a class="stocks_list_more">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>meer informatie</a>
                                </iaixsl:if>
                                <iaixsl:if test="/shop/page/stocks/google_api_key/@value">
                                    <a class="btn --solid show_stock_on_map" onclick="stocks_sites.markerOnClick(this);">Toon op kaart</a>   </iaixsl:if>
                            </p>
                        </div>
                    </iaixsl:for-each>
                </div>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/stocks_list.js.gzip?r=1612518076</iaixsl:attribute></script>
            <script>
                app_shop.runApp();
            </script>
