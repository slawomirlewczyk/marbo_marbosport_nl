			...
			<iaixsl:choose>
				<iaixsl:when test="/shop/page/cards/item">
					<div id="client_cards">
						...
						<h2>
							<iaixsl:attribute name="class">big_label</iaixsl:attribute>Loyaliteitskaarten uitgereikt:</h2>
						<table>
							<tr>
								<th>vervaldatum van de kaart</th>
								<th>naam van de kaart</th>
								<th>kaartnummer</th>
								<th>kaartstatus</th>
							</tr>
							...
							<tr>
								...
								<td class="client_cards_active">
									<iaixsl:choose>
										...
										<iaixsl:otherwise>b/d</iaixsl:otherwise>
									</iaixsl:choose>
								</td>
							</tr>
							</iaixsl:for-each>
						</table>
						<p>Om te zien welke kortingen wij u hebben gegeven, kijk onder<a href="client-rebate.php">De kortingspagina van uw klantenpaneel.</a>
						</p>
					
					</div>
				</iaixsl:when>
				<iaixsl:otherwise>
					<div class="menu_messages_message">U heeft geen klantenkaart</div>
				</iaixsl:otherwise>
			</iaixsl:choose>
