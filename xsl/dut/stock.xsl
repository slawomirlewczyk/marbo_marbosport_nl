...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/stock_info.js.gzip?r=1685223127</iaixsl:attribute></script></head>
...
<iaixsl:attribute name="class">stock_cms_label  big_label</iaixsl:attribute>
            <span class="stock_cms_label">Aanvullende informatie</span>
        </div>
        <div class="stock_cms">
    ...
    <!--Informacja o magazynie (stock_info, 107884.1)-->
        ...
        <div class="stock_info_outline" id="stock_info_58110">
            <div class="big_label stock_label">
                <span class="stock_label">Informatie over verzamelpunten</span>
            </div>
            <div class="stock_info_sub">
                <div class="stock_info_details">
                    <iaixsl:if test="page/stock/@name and (page/stock/@name != '')">
                        <div class="stock_info_section" id="stock_info_details_name">
                            <span class="stock_info_title">Naam</span>
                    ...
                    <iaixsl:if test="page/stock/@street and (page/stock/@street != '')">
                        <div class="stock_info_section" id="stock_info_details_street">
                            <span class="stock_info_title">Straat</span>
                    ...
                    <iaixsl:if test="page/stock/@zipcode and (page/stock/@zipcode != '')">
                        <div class="stock_info_section" id="stock_info_details_zipcode">
                            <span class="stock_info_title">Postcode</span>
                    ...
                    <iaixsl:if test="page/stock/@city and (page/stock/@city != '')">
                        <div class="stock_info_section" id="stock_info_details_city">
                            <span class="stock_info_title">Stad</span>
                    ...
                    <iaixsl:if test="page/stock/@phone and (page/stock/@phone != '')">
                        <div class="stock_info_section" id="stock_info_details_phone">
                            <span class="stock_info_title">Telefoon</span>
                    ...
                    <iaixsl:if test="page/stock/@street and (page/stock/@street != '') or page/stock/@zipcode or (page/stock/@zipcode != '') or page/stock/@city and (page/stock/@city != '')">
                        <iaixsl:if test="($mapHide != '') and page/stock/google_api_key/@value">
                            ...
                            <a class="btn --solid show_on_map">
                                ...
                                <i class="icon-globe"></i> <span class="d-none d-sm-inline">Toon op kaart</span><span class="d-sm-none">Kaart</span>
                            </a>
                        </iaixsl:if>
                    </iaixsl:if>
                </div>
                ...
                <div class="stock_info_hours">
                    <span class="stock_info_hours_label">Openingstijden</span>
                    <iaixsl:if test="page/stock_time/monday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Maandag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:otherwise>Gesloten</iaixsl:otherwise>
                                </iaixsl:choose>
                            </span>
                        </div>
                    </iaixsl:if>
                    <iaixsl:if test="page/stock_time/tuesday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Dinsdag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/wednesday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Woensdag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/thursday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Donderdag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/friday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Vrijdag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/saturday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Zaterdag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/sunday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Zondag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <div class="loadingMap">
                        <div class="loadingContent">
                            <div class="loadingBox">
                                ...
                                <span class="loadingAddress">Adres zoeken</span>
            ...
            <iaixsl:if test="page/stock/text()">
                <div class="big_label stock_label">
                    <span class="stock_label">Gedetailleerde informatie</span>
                </div>
