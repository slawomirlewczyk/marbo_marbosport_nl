                    ...
                    <iaixsl:if test="count(login_options/service)&gt;1 and not(/shop/page/client-data/@registerByExternalService='true')">
                        <div id="client_new_social">
                            ...
                            <iaixsl:if test="/shop/page/client-data/@edit='true'">
                                <h2>
                                    <iaixsl:attribute name="class">big_label</iaixsl:attribute>Uw account koppelen aan een andere dienst</h2>
                            </iaixsl:if>
                            ...
                            <div class="client_new_social_sub">
                                ...
                                <iaixsl:if test="page/client-data/@allow_register = 'false'">
                                    <div class="client_new_form_info" id="client_new_form_info">Log in op een van de volgende aanmeldingsformulieren om uw registratie te voltooien.</div>
                                </iaixsl:if>
                ...
                <iaixsl:when test="/shop/page/communicates/message/@type='login_connect'">
                    <div style="display:none;">
                        <div id="client_new_social_info">
                            <h2>Uw account koppelen aan de dienst<iaixsl:value-of select="/shop/page/communicates/message/@value"/></h2>
                            <strong>We hebben met succes uw accountgegevens gedownload van de dienst<iaixsl:value-of select="/shop/page/communicates/message/@value"/>. <br/><br/>Vul de ontbrekende verzendgegevens in en voltooi de accountregistratie.</strong>
                            <button class="btn --solid --medium go_to_register_form" onclick="$('#dialog_close').click();">Ga naar het registratieformulier</button>
                        </div>
                    </div>
                </iaixsl:when>
                ...
                <iaixsl:when test="/shop/page/communicates/message/@type='login_connected'">
                    <div style="display:none;">
                        <div id="client_new_social_info">
                            ...
                            <strong>Uw shop account is succesvol gekoppeld aan uw service account<iaixsl:value-of select="/shop/page/communicates/message/@value"/>. <br/><br/>Ga naar het registratieformulier en controleer of uw gegevens up-to-date zijn.</strong>
                            <button class="btn --solid --medium go_to_register_form2" onclick="$('#dialog_close').click();">Ga naar het registratieformulier</button>
                        </div>
                    </div>
                </iaixsl:when>
            </iaixsl:choose>
        </iaixsl:if>
        <!--Formularz dodawania nowego klienta (client_new_form, 112107.1)-->
        ...
        <form method="post" class="form-horizontal" id="client_new_form" enctype="multipart/form-data">
            ...
            <iaixsl:if test="(page/client-data/@operation = 'register-wholesale-add') or (page/client-data/@operation = 'edit-wholesale-add') or (page/client-data/@operation = 'edit-wholesale-edit')">
                <div class="row clearfix wholesale_box">
                    <div class="col-12">
                        <h2 class="big_label" id="wholesale_header">Registratie groothandelaar</h2>
                    </div>
                    <div class="col-12">
                        <div class="wholesale_box cn_wrapper">
                            ...
                            <div class="form-group">
                                <label class="control-label">
                                    <iaixsl:choose>
                                        ...
                                        <iaixsl:otherwise>Facturen:</iaixsl:otherwise>
                                    </iaixsl:choose>
                                </label>
                            ...
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="client_description" class="control-label">Bedrijfsomschrijving:</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="wholesale_box cn_wrapper">
                            <div class="form-group">
                                <label for="client_attachment1" class="control-label">Bijlage 1<small>(max 10MB)</small>:
                                </label>
                                <div class="form-control-static">
                                    ...
                                    <iaixsl:if test="/shop/page/client-data/wholesale_data/@file1_link">
                                        <p class="help-block">
                                            [
                                            <a>
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/client-data/wholesale_data/@file1_link"/></iaixsl:attribute>zie</a>
                                            ]
                                        </p>
                                    </iaixsl:if>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="client_attachment2" class="control-label">Bijlage 2<small>(max 10MB)</small>:
                                </label>
                                <div class="form-control-static">
                                    ...
                                    <iaixsl:if test="/shop/page/client-data/wholesale_data/@file2_link">
                                        <p class="help-block">
                                            [
                                            <a>
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/client-data/wholesale_data/@file2_link"/></iaixsl:attribute>zie</a>
                                            ]
                                        </p>
                                    </iaixsl:if>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="client_attachment3" class="control-label">Bijlage 3<small>(max 10MB)</small>:
                                </label>
                                <div class="form-control-static">
                                    ...
                                    <iaixsl:if test="/shop/page/client-data/wholesale_data/@file3_link">
                                        <p class="help-block">
                                            [
                                            <a>
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/client-data/wholesale_data/@file3_link"/></iaixsl:attribute>zie</a>
                                            ]
                                        </p>
                                    </iaixsl:if>
                                </div>
            ...
            <div class="row clearfix">
                <div class="col-12" id="client_new_client">
                    ...
                    <h2 class="big_label" id="client_header">Uw gegevens</h2>
                    ...
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/client-data/@operation = 'register' and /shop/action/registration_options/wholesale">
                            <div class="cn_wrapper choose_other_form">
                                <i class="icon-wholesaler-register"></i>Bent u een groothandelaar? Profiteer van<a>
                                    ...
                                    <iaixsl:attribute name="title">Klik om naar het registratieformulier voor groothandelaren te gaan</iaixsl:attribute>inschrijvingsformulier voor groothandelaars</a>
                            </div>
                        </iaixsl:when>
                        <iaixsl:when test="/shop/page/client-data/@operation = 'register-wholesale-add' and /shop/action/registration_options/retail">
                            <div class="cn_wrapper choose_other_form">
                                <i class="icon-register-card"></i>Bent u een retail klant? Profiteer van<a>
                                    ...
                                    <iaixsl:attribute name="title">Klik om naar het registratieformulier voor winkeliers te gaan</iaixsl:attribute>een vereenvoudigd registratieformulier.</a>
                            </div>
                        </iaixsl:when>
                    </iaixsl:choose>
                    ...
                    <div class="client_box cn_wrapper">
                        <iaixsl:if test="not((page/client-data/@operation = 'register-wholesale-add') or (page/client-data/@operation = 'edit-wholesale-add') or  (page/client-data/@operation = 'edit-wholesale-edit')) or (page/client-data/@disallow_change_company_data = 'false')">
                            <div class="form-group firm_switcher">
                                <label class="control-label">Je bestelt als:</label>
                                <div class="form-control-static">
                                    <label class="radio-inline">
                            ...
                            <div class="form-group firm-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="has-feedback has-required col-sm-6 col-12">
                                        ...
                                        <label for="client_firm" class="control-label">Naam van het bedrijf</label>
                                    ...
                                    <iaixsl:if test="/shop/page/client-data/nip/@active != 'hide'">
                                        <div>
                                            ...
                                            <label for="client_nip" class="control-label">NIP</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                    </iaixsl:if>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="has-feedback has-required col-sm-6 col-12">
                                    ...
                                    <label for="client_firstname" class="control-label">Naam</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                ...
                                <div class="has-feedback has-required col-sm-6 col-12">
                                    ...
                                    <label for="client_lastname" class="control-label">Naam</label>
                                    <span class="form-control-feedback"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="has-feedback has-required col-12">
                                ...
                                <label for="client_street" class="control-label">Straat en nummer</label>
                                <span class="form-control-feedback"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div id="zipcode_wrapper" class="has-feedback has-required col-sm-6 col-12">
                                    ...
                                    <label for="client_zipcode" class="control-label">Postcode</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                ...
                                <div id="city_wrapper" class="has-feedback has-required col-sm-6 col-12">
                                    ...
                                    <label for="client_city" class="control-label">Stad</label>
                                    <span class="form-control-feedback"/>
                                </div>
                            </div>
                            ...
                            <iaixsl:otherwise>
                                <div class="form-group row country">
                                    <div class="has-feedback col-12">
                                        ...
                                        <label for="client_region" class="control-label">Land:</label>
                                    </div>
                                </div>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                                    ...
                                    <div class="has-feedback col-12">
                                        <select class="form-control" name="client_province">
                                            ...
                                            <iaixsl:if test="not(provinces/province/@id = /shop/page/client-data/invoice_data/@province or provinces/province/@selected)">
                                                <option disabled="disabled" selected="selected" value="no_province">Selecteer<iaixsl:choose>
                                                        <iaixsl:when test="province_types/type/text() = 'state'"> stan</iaixsl:when>
                                                        <iaixsl:when test="province_types/type/text() = 'province'">provincie van</iaixsl:when>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="has-feedback has-required col-sm-6 col-12">
                                    ...
                                    <label for="client_phone" class="control-label">Telefoon</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                ...
                                <div class="has-feedback has-required col-sm-6 col-12">
                                    ...
                                    <label for="client_email" class="control-label">E-mailadres</label>
                                    <span class="form-control-feedback"/>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12" id="delivery_box_switcher">
                    ...
                    <div class="cn_wrapper">
                        <div class="form-group row">
                            ...
                            <label for="deliver_to_billingaddr" class="control-label">Verzending naar een ander adres:</label>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="additional_box cn_wrapper">
                                    ...
                                    <div class="form-group addresses_list_wrapper">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="dropdown cn_dropdown">
                                                <button class="btn --solid --icon-right icon-reorder dropdown-toggle" type="button" id="dropdownAdressMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Kies uit de lijst met adressen</button>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="has-feedback has-required col-sm-6 col-12">
                                            ...
                                            <label for="additional_firstname" class="control-label">Naam</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                        ...
                                        <div class="has-feedback has-required col-sm-6 col-12">
                                            ...
                                            <label for="additional_lastname" class="control-label">Naam</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="has-feedback col-12">
                                        ...
                                        <label for="additional_additional" class="control-label">Naam van het bedrijf</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="has-feedback has-required col-12">
                                        ...
                                        <label for="additional_street" class="control-label">Straat en nummer</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div id="delivery_zipcode_wrapper" class="has-feedback has-required col-sm-6 col-12">
                                            ...
                                            <label for="additional_zipcode" class="control-label">Postcode</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                        <div id="delivery_city_wrapper" class="has-feedback has-required col-sm-6 col-12">
                                            ...
                                            <label for="additional_city" class="control-label">Stad</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <iaixsl:otherwise>
                                        <div class="form-group row country">
                                            <div class="has-feedback col-12">
                                                ...
                                                <label for="additional_region" class="control-label">Land</label>
                                            </div>
                                        </div>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                                ...
                                <div class="form-group row">
                                    <div class="has-feedback has-required col-12">
                                        ...
                                        <label for="additional_phone" class="control-label">Telefoon</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group button-form">
                                    <div class="col-12 px-0">
                                        <button id="delete_delivery_address" class="btn --solid delete_address">
                                            <iaixsl:if test="not(@removable = 'yes')"><iaixsl:attribute name="style">display: none;</iaixsl:attribute></iaixsl:if>Adres wissen</button>
                                        <button id="new_delivery_address" class="btn --solid new_address">Nieuw adres toevoegen</button>
                                        <button id="save_delivery_address" type="submit" class="btn --solid save_address" style="display:none;">Adres opslaan</button>
                                    </div>
                                </div>
                            </div>
                        </iaixsl:for-each>
                            ...
                            <iaixsl:for-each select="/shop/page/client-data/delivery_data">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="has-feedback has-required col-sm-6 col-12">
                                            ...
                                            <label for="delivery_firstname" class="control-label">Naam</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                        ...
                                        <div class="has-feedback has-required col-sm-6 col-12">
                                            ...
                                            <label for="delivery_lastname" class="control-label">Naam</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="has-feedback col-12">
                                        ...
                                        <label for="delivery_additional" class="control-label">Naam van het bedrijf</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="has-feedback has-required col-12">
                                        ...
                                        <label for="delivery_street" class="control-label">Straat en nummer</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div id="new_delivery_zipcode_wrapper" class="has-feedback has-required col-sm-6 col-12">
                                            ...
                                            <label for="delivery_zipcode" class="control-label">Postcode</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                        <div id="new_delivery_city_wrapper" class="has-feedback has-required col-sm-6 col-12">
                                            ...
                                            <label for="delivery_city" class="control-label">Stad</label>
                                            <span class="form-control-feedback"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <iaixsl:otherwise>
                                        <div class="form-group row country">
                                            <div class="has-feedback col-12">
                                                ...
                                                <label for="delivery_region" class="control-label">Land</label>
                                            </div>
                                        </div>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                                ...
                                <div class="form-group row">
                                    <div class="has-feedback has-required col-12">
                                        ...
                                        <label for="delivery_phone" class="control-label">Telefoon</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                            </iaixsl:for-each>
                    ...
                    <div class="col-12" id="invoice_box_switcher">
                        <div class="cn_wrapper">
                            <div class="form-group row">
                                ...
                                <label for="invoice_to_billingaddr" class="control-label">Factuur voor andere gegevens:</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="additional_box cn_wrapper">
                            ...
                            <div class="form-group row">
                                <div class="has-feedback has-required col-12">
                                    ...
                                    <label for="invoice_firm" class="control-label">Naam van het bedrijf</label>
                                    <span class="form-control-feedback"/>
                                </div>
                            </div>
                            ...
                            <iaixsl:if test="/shop/page/client-data/nip/@active != 'hide'">
                                <div class="form-group row">
                                    <div>
                                        ...
                                        <label for="invoice_nip" class="control-label">NIP</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                            </iaixsl:if>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="has-feedback has-required col-sm-6 col-12">
                                        ...
                                        <label for="invoice_firstname" class="control-label">Naam</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                    ...
                                    <div class="has-feedback has-required col-sm-6 col-12">
                                        ...
                                        <label for="invoice_lastname" class="control-label">Naam</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="has-feedback has-required col-12">
                                    ...
                                    <label for="invoice_street" class="control-label">Straat en nummer</label>
                                    <span class="form-control-feedback"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div id="invoice_zipcode_wrapper" class="has-feedback has-required col-sm-6 col-12">
                                        ...
                                        <label for="invoice_zipcode" class="control-label">Postcode</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                    <div id="invoice_city_wrapper" class="has-feedback has-required col-sm-6 col-12">
                                        ...
                                        <label for="invoice_city" class="control-label">Stad</label>
                                        <span class="form-control-feedback"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <iaixsl:otherwise>
                                    <div class="form-group row country">
                                        <div class="has-feedback col-12">
                                            ...
                                            <label for="invoice_region" class="control-label">Land:</label>
                                        </div>
                                    </div>
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                                    ...
                                    <div class="form-group row client_provinces" style="display: none;">
                                        ...
                                        <div>
                                            ...
                                            <select class="form-control" name="invoice_province">
                                                ...
                                                <iaixsl:if test="not(provinces/province/@id = /shop/page/client-data/invoice_data-list/address[@default = 'yes']/@province)">
                                                    <option disabled="disabled" selected="selected" value="no_province">Selecteer<iaixsl:choose>
                                                            <iaixsl:when test="province_types/type/text() = 'state'"> stan</iaixsl:when>
                                                            <iaixsl:when test="province_types/type/text() = 'province'">provincie van</iaixsl:when>
                                                            <iaixsl:when test="province_types/type/text() = 'territory'"> terytorium</iaixsl:when>
                ...
                <iaixsl:if test="$client_new_mode != 'onceorder'">
                    <div class="col-12" id="client_new_login">
                        <h2 class="big_label">Uw rekening</h2>
                        ...
                        <div class="login_box cn_wrapper">
                            ...
                            <div class="form-group row">
                                <div>
                                    ...
                                    <label for="client_login" class="control-label">Login</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                <div class="form-desc col-12">De login moet minimaal 3 en maximaal 40 tekens bevatten (alleen letters of cijfers).</div>
                            </div>
                            ...
                            <div class="form-group row password-group">
                                ...
                                <div>
                                    ...
                                    <label for="client_password" class="control-label">Wachtwoord</label>
                                    <span class="form-control-feedback"/>
                                ...
                                <iaixsl:if test="/shop/page/client-data/profile_data/@max_password_length and /shop/page/client-data/profile_data/@max_password_length &gt; 0">
                                    <div class="form-desc col-12">Het wachtwoord moet minimaal 6 tekens bevatten</div>
                                </iaixsl:if>
                                <iaixsl:if test="/shop/page/client-data/@register='true' and /shop/page/client-data/profile_data/@mandatory_password!='true'">
                            ...
                            <iaixsl:if test="page/client-data/@action = 'password_token' and $client_new_mode = 'edit'">
                                <p class="no_password_social_text">
                                    <iaixsl:attribute name="style">display:none;</iaixsl:attribute>
                                    <b>U hoeft uw wachtwoord niet te onthouden.</b>Koppel uw winkelaccount aan uw account op een van de onderstaande diensten en log daarmee in voor volgende aankopen.</p>
                            </iaixsl:if>
                ...
                <div class="col-6">
                    ...
                    <div class="clientnew_regulations">
                        ...
                        <iaixsl:if test="($client_new_mode = 'edit') and login_options/service[@connected='true']">
                            <div class="form-group">
                                <div class="col-12">
                                    <label>Uw account is gekoppeld aan uw service account<iaixsl:value-of select="login_options/service[@connected='true']/@name"/></label>
                                    <a class="btn-connected btn --solid">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="login_options/service[@connected='true']/@disconnect_url"/></iaixsl:attribute>Account verbreken</a>
                                </div>
                            </div>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                            <div class="checkbox">
                                <label>
                                    ...
                                    </input>Ik ben een EU-btw-plichtige. Ik bestel zonder BTW en verbind me ertoe het in mijn land te regelen.</label>
                            </div>
                        </iaixsl:if>
                        <iaixsl:choose>
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    ...
                                    </input>Ik wil de e-mailnieuwsbrief ontvangen (mogelijkheid om later uit te schrijven)</label>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        ...
                                        </input>Ik wil graag de SMS Nieuwsbrief ontvangen (later uitschrijven)<input type="hidden" name="client_send_sms_exists" value="1"/>
                                    </label>
                                </div>
                            </div>
                        </iaixsl:if>
                    ...
                    <div class="clientnew_buttons">
                        <div class="button_legend">Velden met een sterretje zijn verplicht</div>
                        <button id="submit_clientnew_form" type="submit" class="btn --solid --large">
                            <iaixsl:choose>
                                <iaixsl:when test="$client_new_mode = 'edit'">Wijzigingen opslaan</iaixsl:when>
                                <iaixsl:when test="$client_new_mode = 'register'">Een account registreren</iaixsl:when>
                                <iaixsl:when test="$client_new_mode = 'onceorder'">Ga verder.</iaixsl:when>
                            </iaixsl:choose>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6 col-12">
                        <iaixsl:choose>
                            ...
                            <iaixsl:when test="/shop/page/client-data/@active_card and not(/shop/page/client-data/@active_card='')">
                                <div class="form-group">
                                    <span class="rebate_card_header">Uw kortingskaart is actief!</span>
                                    <div class="has-feedback d-flex align-items-center">
                                        ...
                                        <div class="rebate_card_input">
                                            ...
                                            <label for="card_discount_code" class="control-label">Kortingskaartnummer</label>
                                        </div>
                                    </div>
                                </div>
                                <p class="rebate_card_desc">U kunt uw actieve kortingskaart wijzigen door hierboven het nieuwe nummer in te voeren. Ga voor de details van de toegekende kortingen naar<a href="/client-rebate.php" title="Twoje rabaty">Uw kortingen</a>.
                                </p>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <div class="form-group">
                                ...
                                <p class="rebate_card_desc">Als u onze plastic kortingskaart hebt, voer dan het nummer ervan in. Zo krijgt u kortingen zoals in onze traditionele winkels.</p>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                </div>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/client_new_form.js.gzip?r=1612518076</iaixsl:attribute></script>
            <script>
                app_shop.runApp();
            </script>
