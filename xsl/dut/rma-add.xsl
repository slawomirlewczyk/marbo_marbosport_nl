...
<iaixsl:attribute name="class">rma_add_cms_label  big_label</iaixsl:attribute>
            <span class="rma_add_cms_label">Aanvullende informatie</span>
        </div>
        ...
        <div class="rma_add_form_outline">
            <form id="rma_add_form" method="post" action="/rma-add.php">
                ...
                <div class="rma_add_form_label">
                    <span class="rma_add_form_label">Schadeafdeling (RMA)</span>
                </div>
                <div class="rma_add_form_addbutton">
                    <a href="rma-list.php" class="btn --solid --medium --icon-left icon-file-alt rma_add_form_listbutton">
                        <iaixsl:attribute name="title">Klik om toegang te krijgen tot de lijst van ingediende klachten</iaixsl:attribute>
                        <span class="img_rma_add"/>Uw klachten</a>
                </div>
                ...
                <div class="rma_add_form_section" id="rma_add_form_section1">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Uw gegevens</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Hieronder staan uw gegevens, ingevoerd tijdens de registratie. Als u vindt dat ze verouderd zijn, zorg er dan voor dat u</span>
                            <a class="rma_add_form_clientedit">
                                ...
                                <iaixsl:attribute name="title">Ga naar uw gegevens bewerken</iaixsl:attribute>uw gegevens corrigeren</a>
                        </div>
                    </iaixsl:if>
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection1">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box1">
                            <span class="rma_add_form_adr1">Factuurgegevens:</span>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box2">
                            <span class="rma_add_form_adr2">Leveringsadres:</span>
                            <div class="rma_add_form_boxsub3">
                                <iaixsl:choose>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box2b">
                            <span class="rma_add_form_adr1">Contactgegevens:</span>
                ...
                <div class="rma_add_form_section" id="rma_add_form_section2">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Informatie over het geadverteerde product</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">De volgende informatie is nodig om uw klacht te behandelen. Geef de naam van het product en de maat.</span>
                        </div>
                    </iaixsl:if>
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection2">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box3">
                            <div class="rma_add_form_boxsub">
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <span class="rma_add_form_infotitle">Naam van het product:</span>
                                    ...
                                    <iaixsl:otherwise>
                                        <div class="form-group clearfix">
                                            <div class=" ">
                                                <label for="rma_add_form_product" class="control-label">Naam van het product:</label>
                                            </div>
                            ...
                            <iaixsl:if test="not(page/rma/inputs/@serial_number_active = '0')">
                                <div class="rma_add_form_boxsub">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rma/@action = 'view'">
                                            <span class="rma_add_form_infotitle">Serienummer van het product:</span>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class=" ">
                                                <label for="rma_add_form_begin_ymd" class="control-label">Serienummer van het product:</label>
                                            </div>
                                            <div class=" ">
                            ...
                            <div class="rma_add_form_boxsub">
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <span class="rma_add_form_infotitle">Aankoopdatum:</span>
                                    ...
                                    <div class="form-group clearfix">
                                            <div class=" ">
                                                <label for="rma_add_form_begin_ymd" class="control-label">Aankoopdatum:</label>
                                            </div>
                                            <div class="has-feedback has-required ">
                            ...
                            <div class="rma_add_form_boxsub">
                                <span class="rma_add_form_infotitle">Plaats van aankoop:</span>
                                    ...
                                    <div class="rma_add_form_boxsub_hidden">
                                        ...
                                        <iaixsl:choose>
                                            ...
                                            <iaixsl:when test="@name = 'other'">
                                                ...
                                                <div class="form-group clearfix">
                                                    <div class=" ">
                                                        <label for="buy_place_desc" class="control-label">Korte beschrijving van de plaats van aankoop:</label>
                                                    </div>
                                                    <div class="has-feedback has-required ">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box4">
                            ...
                            <div class="rma_add_form_descval">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <span class="rma_add_form_desc">Fout beschrijving:</span>
                                    ...
                                    <iaixsl:otherwise>
                                        <div class="form-group clearfix">
                                            <div class=" ">
                                                <label for="rma_add_form_desc" class="control-label">Fout beschrijving:</label>
                                            </div>
                                            <div class="has-feedback has-required ">
                ...
                <iaixsl:if test="not(page/rma/payments/@active = '0')">
                    <div class="rma_add_form_section" id="rma_add_form_section3">
                        <div class="rma_add_form_sectionheader">
                            <span class="rma_add_form_sectionheader">Terugbetaling</span>
                        </div>
                        <iaixsl:if test="not(page/rma/@action = 'view')">
                            <div class="rma_add_form_sectiondesc">
                                <span class="rma_add_form_sectiondesc">Om een terugbetaling te bespoedigen in het geval dat uw klacht succesvol is, verzoeken wij u hieronder aan te geven hoe u de terugbetaling verwacht. Het louter verstrekken van deze informatie betekent niet dat de klacht tot terugbetaling zal leiden.</span>
                            </div>
                        </iaixsl:if>
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="rma_add_form_box" id="rma_add_form_box5">
                                <div class="rma_add_form_boxsub2">
                                    <span class="rma_add_form_infotitle2">Vorm van terugbetaling:</span>
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'b'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Bankrekening</span>
                                            ...
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'p'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Door overschrijving naar</span>
                                                    <span class="rma_add_form_infovalue2"><iaixsl:value-of disable-output-escaping="no" select="page/rma/payments_text"/></span>
                                                </div>
                                            </iaixsl:when>
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">Adres:<iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/pol/need.gif?r=1685223127"><iaixsl:attribute name="alt">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
                                                                <img src="/gfx/pol/correct.png?r=1685223127" class="rma_correct_img" id="rma_add_przekaz_on" style="display:none;"/>
                                                                <img src="/gfx/pol/incorrect.png?r=1685223127" class="rma_correct_img" id="rma_add_przekaz_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'b'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">Rekeningnummer:<iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/pol/need.gif?r=1685223127"><iaixsl:attribute name="alt">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
                                                                <img src="/gfx/pol/correct.png?r=1685223127" class="rma_correct_img" id="rma_add_bankaccount_on" style="display:none;"/>
                                                                <img src="/gfx/pol/incorrect.png?r=1685223127" class="rma_correct_img" id="rma_add_bankaccount_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'c'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">Details voor de cheque:<iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/pol/need.gif?r=1685223127"><iaixsl:attribute name="alt">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
                                                                <img src="/gfx/pol/correct.png?r=1685223127" class="rma_correct_img" id="rma_add_czek_on" style="display:none;"/>
                                                                <img src="/gfx/pol/incorrect.png?r=1685223127" class="rma_correct_img" id="rma_add_czek_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                    ...
                    <div class="rma_add_form_sectionheader">
                        <iaixsl:choose>
                            <iaixsl:when test="page/rma/@action = 'view' or count(page/rma/stocks/stock) = 1">
                                <span class="rma_add_form_sectionheader">Plaats van de klacht</span>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <span class="rma_add_form_sectionheader">Waar wilt u uw klacht naartoe sturen?</span>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view') and count(/shop/page/rma/stocks/stock) &gt; 1">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Kies het contactpunt waar u uw klacht naartoe stuurt en met wie u contact zult opnemen over uw klacht.</span>
                        </div>
                    </iaixsl:if>
                        ...
                        <iaixsl:for-each select="page/rma/stocks/stock">
                            <div class="rma_add_form_stock">
                                ...
                                <iaixsl:if test="not(/shop/page/rma/@action = 'view') and count(/shop/page/rma/stocks/stock) &gt; 1">
                                    <iaixsl:attribute name="title">Klik om nu een klacht te selecteren</iaixsl:attribute>
                        ...
                        <a id="rma_add_form_submit" onmouseover="rma_add.checkInps();" class="btn --solid --medium rma_add_form_button_add">
                            ...
                            <iaixsl:choose>
                                <iaixsl:when test="page/rma/@id">
                                    ...
                                    <iaixsl:attribute name="title">Klik om de wijzigingen in uw klacht op te slaan</iaixsl:attribute>
                                    Zapisz zmiany
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    <iaixsl:attribute name="title">Klik om een klacht in te dienen</iaixsl:attribute>Dien een klacht in</iaixsl:otherwise>
                            </iaixsl:choose>
