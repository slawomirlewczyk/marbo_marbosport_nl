                    ...
                    <iaixsl:when test="page/orders/@mode = 'closed'">
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            ...
                            <a href="client-orders.php?display=opened" class="btn --solid --medium mt-2">
                                <iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=opened</iaixsl:attribute></iaixsl:if>Lijst van lopende orders</a>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            ...
                            <a href="client-orders.php?display=closed" class="btn --solid --medium mt-2">
                                <iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=closed</iaixsl:attribute></iaixsl:if>Lijst van afgeronde bestellingen</a>
                        </div>
                    </iaixsl:otherwise>
                </iaixsl:choose>
                <iaixsl:choose>
                    <iaixsl:when test="/shop/page/orders/item">
                        ...
                        <iaixsl:if test="page/orders/@mode = 'closed'">
                            <div class="client_order_summary">
                                <table class="orders" cellspacing="0" cellpadding="0" id="rebates">
                                    <tr>
                                        <td colspan="3" class="headerek" id="rabat_header">Totale waarde van voltooide orders</td>
                                    </tr>
                                    <tr>
                                        <td class="ord3" id="reb_head_left">in het laatste kwartaal</td>
                                        <td class="ord3" id="reb_head_center">in het afgelopen jaar</td>
                                        <td class="ord3" id="reb_head_right">alle</td>
                                    </tr>
                                    <tr>
                        ...
                        <table class="orders" cellspacing="0" cellpadding="0">
                            ...
                            <thead>
                                <tr>
                                    <th id="orders_th1">Bestel ID</th>
                                    <th id="orders_th2">Besteldatum</th>
                                    <iaixsl:if test="not(page/orders/@mode = 'returns') and not(page/orders/@mode = 'rma')">
                                        <th id="orders_th3">Te betalen</th>
                                        <th id="orders_th4">Betaling</th>
                                    </iaixsl:if>
                                    <th id="orders_th5">status</th>
                                    <th id="orders_th6">Actie</th>
                                </tr>
                            </thead>
                            <tbody>
                                                                    ...
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:when test="@prepaidstatus ='n'">
                                                                            <iaixsl:choose>
                                                                                ...
                                                                                <iaixsl:otherwise>in afwachting van plaatsing</iaixsl:otherwise>
                                                                            </iaixsl:choose>
                                                                        </iaixsl:when>
                                                                    ...
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:when test="@prepaidstatus ='y'">
                                                                            <iaixsl:choose>
                                                                                ...
                                                                                <iaixsl:otherwise>betaald</iaixsl:otherwise>
                                                                            </iaixsl:choose>
                                                                        </iaixsl:when>
                                            ...
                                            <div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="$status_order = 't'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small><iaixsl:choose><iaixsl:when test="@personal_collection = 'yes'">ontvangen</iaixsl:when><iaixsl:otherwise>verzonden</iaixsl:otherwise></iaixsl:choose></small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'n'">
                                                        <span><i class="icon-clock"></i></span>
                                                        <small>aangenomen</small>
                                                    </iaixsl:when>
                                                    ...
                                                    <iaixsl:when test="$status_order = 'p'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small>klaar om te verzenden / ontvangen</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'i'">
                                                        <span><i class="icon-remove"></i></span>
                                                        <small>Afgewezen</small>
                                                    </iaixsl:when>
                                                    ...
                                                    <iaixsl:when test="$status_order = 'h'">
                                                        ...
                                                        <small>ingehouden</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'w'">
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="number(@paid) = number(@cost)">
                                                                <span><i class="icon-clock"></i></span>
                                                                <small>in afwachting van verdere uitvoering</small>
                                                            </iaixsl:when>
                                                            <iaixsl:when test="number(@paid) &gt; 0">
                                                                <span><i class="icon-money"></i></span>
                                                                <small>in afwachting van betaling</small>
                                                            </iaixsl:when>
                                                            <iaixsl:otherwise>
                                                                <span><i class="icon-pause"></i></span>
                                                                <small>in afwachting van betaling</small>
                                                    ...
                                                    <iaixsl:when test="$status_order = 'd'">
                                                        <span><i class="icon-pause"></i></span>
                                                        <small>in afwachting van levering</small>
                                                    </iaixsl:when>
                                        ...
                                        <td>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@returns_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class="icon-plus"></i></span><small>Selecteer</small></a>
                                                </iaixsl:when>
                                                <iaixsl:when test="@rma_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class="icon-plus"></i></span><small>Selecteer</small></a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class="icon-plus"></i></span><small>Zie</small></a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </td>
                                    </tr>
                    ...
                    <iaixsl:otherwise>
                        <div class="client_orders_null">
                            <iaixsl:choose>
                                ...
                                <iaixsl:otherwise>Je hebt momenteel geen bestellingen in behandeling.</iaixsl:otherwise>
                            </iaixsl:choose>
                        </div>
                        <div class="n54744_goback">
                            <a class="btn --solid n54744" href="/main.php">
                                ...
                                <iaixsl:attribute name="id">retbut_strona_glowna</iaixsl:attribute>Homepage</a>
                        </div>
                    </iaixsl:otherwise>
                </iaixsl:choose>
                <table>
