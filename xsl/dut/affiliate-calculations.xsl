...
<iaixsl:if test="page/calculations">
    <div class="affiliate_calculations_label big_label">
        <span class="affiliate_calculations_label">Schikkingen</span>
    </div>
    <iaixsl:choose>
        <iaixsl:when test="count(page/calculations/payment)">
            
                <div class="affiliate_calculations_desc">De onderstaande tabel toont de bedragen die wij u verschuldigd zijn voor bestellingen die u via uw deelname aan het affiliate-programma hebt verkregen. Dit zijn de stromen in uw affiliate account:<ol>
                        <li>totaal rekeningsaldo:<strong class="resources_total"><iaixsl:value-of select="page/payments/@total_formatted"/></strong>
                        </li>
                        <li>het totale bedrag aan verminderde commissies als gevolg van teruggezonden producten:<strong class="resources_returned"><iaixsl:value-of select="page/payments/@returns_formatted"/></strong>           
                        </li>
                    </ol>
                    
                    <iaixsl:if test="page/client/@loyalty_points = 'true'">Commissie op bestellingen van verworven klanten wordt betaald in de vorm van punten aan uw<a href="/affiliate-main.php">saldo in het loyaliteitsprogramma</a>
                    </iaixsl:if>
                </div>
            <div class="affiliate_calculations">    
                <div class="affiliate_calculations_sub">
                    <table class="affiliate_calculations">
                        ...
                        <thead>
                            <tr>
                                <th id="affiliate_calculations_th0">datum van toekenning van de opdracht</th>
                                <th id="affiliate_calculations_th1">geldig vanaf</th>
                                <th id="affiliate_calculations_th4">geldig tot</th>
                                <th id="affiliate_calculations_th2">uw vergoeding</th>
                                <th id="affiliate_calculations_th3">beschrijving</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="affiliate_calculations_third">
                                       <iaixsl:choose>
                                        ...
                                        <span>Directe beloning voor de opdracht<iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rd'">
                                        <span class="r">De directe vergoeding voor de opdracht werd geannuleerd<iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gi'">
                                        <span>Indirecte beloning voor de opdracht<iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'ri'">
                                        <span class="r">De indirecte vergoeding voor het contract werd geannuleerd<iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gv'">
                                        <span>Er werd een bon gegenereerd met het nummer<iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rv'">
                                        <span class="r">Geblokkeerd bonnummer<iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gc'">
                                        <span>Uitbetaald geld</span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rc'">
                                        <span class="r">Geldopname geweigerd</span>
                                        </iaixsl:when>

                                        <iaixsl:when test="@type = 'rr'">
                                        <span>Product retour</span>
                                        </iaixsl:when>
                                        </iaixsl:choose>
                                    </td>
                                </tr>
        ...
        <iaixsl:otherwise>
            <div class="affiliate_calculations_null">Geen regeling</div>
        </iaixsl:otherwise>
    </iaixsl:choose>
</iaixsl:if>
