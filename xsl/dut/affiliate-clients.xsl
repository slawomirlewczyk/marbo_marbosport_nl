...
<iaixsl:attribute name="class">big_label affiliate_clients_label</iaixsl:attribute>
        ...
        <span class="affiliate_clients_label">Lijst van uw klanten</span>
    </div>
    <iaixsl:choose>
    <iaixsl:when test="count(page/clients_list/login)">
        <div class="affiliate_clients_desc">
            <p class="affiliate_clients_desc">Hieronder vindt u een lijst van alle klanten die een account hebben aangemaakt na binnenkomst van uw verwijzing.</p>
        </div>
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_clients</iaixsl:attribute>
                    ...
                    <thead>
                        <tr>
                            <th id="affiliate_clients_th1">klant id</th>
                            <th id="affiliate_clients_th3">datum waarop de rekening is aangemaakt</th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <iaixsl:otherwise>
        <div class="affiliate_clients_desc_null">U heeft momenteel geen klanten die op uw aanbeveling een rekening hebben geopend.</div>
    </iaixsl:otherwise>
    </iaixsl:choose>
</iaixsl:if>
