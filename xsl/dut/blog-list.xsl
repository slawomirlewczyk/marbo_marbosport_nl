...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
            ...
            <div class="blog_categoriesdescription mb-4">
                <h1 class="big_label">
                    <iaixsl:choose>
                        ...
                        <iaixsl:otherwise>Gidsen en artikelen</iaixsl:otherwise>
                    </iaixsl:choose>
                </h1>
        ...
        <!--Blog - List (blog_list_display, 115906.1)-->
		...
		<iaixsl:if test="count(page/blogitems/blogitem) &gt; 0">
			<section id="blog_list" class="article mb-5">

				<div class="article__block row">
					<iaixsl:for-each select="page/blogitems/blogitem">
						<article class="article__item col-12 col-sm-6">

							<div class="article__item__sub">
                                ...
                                <iaixsl:if test="image/@src and image/@src!=''">
                                    ...
                                    <img src="/gfx/dut/loader.gif?r=1612518076" class="article__image b-lazy">
                                ...
                                <iaixsl:if test="categories/category/@name">
                                    <div class="article__category_name"><iaixsl:value-of select="categories/category/@name"/></div>
                                </iaixsl:if>
                            </div>
