...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/partners_list.js.gzip?r=1612518076</iaixsl:attribute></script></head>
...
<iaixsl:attribute name="class">big_label partners_list_header</iaixsl:attribute>
      <div class="partners_list_header_sub">
        <span class="partners_list_label">Onze partners</span>
      </div>
    </div>    
    ...
    <div class="partners_text_info">
      <p>Bekijk onze lijst van zakenpartners. Om bedrijven in uw omgeving te vinden, klikt u op de knop Selecteer stad.</p>
    </div>

    <iaixsl:if test="/shop/page/partners/google_api_key/@value">
      <div class="partners_show_city_button">
      <div class="button_image"/>
      <a class="partners_show_city_button" onclick="partners_map.showCityList();">
  <iaixsl:attribute name="class">btn-large partners_show_city_button</iaixsl:attribute>
        <iaixsl:attribute name="title">Klik om een stad te selecteren</iaixsl:attribute>Selecteer een stad</a>
      </div>
    ...
    <iaixsl:if test="count(page/partners/city) = 1">
      <div class="partners_text_info_oneCity">
        <p>Bekijk de lijst van onze zakenpartners:</p>
      </div>  
      <script>
      ...
      <div class="loadingMap">
        <div class="loadingContent">
          <div class="loadingBox">
            ...
            <span class="loadingMarkers">Locaties van laadpartners<span class="loadingMarkersComplete"/>
               z 
...
<iaixsl:attribute name="class">big_label partners_list_under_sub</iaixsl:attribute>
              <span class="partners_list_under_label">Lijst van adressen -<iaixsl:value-of select="@name"/>
              </span>
            </div>    
              ...
              <div class="partners_list_under_wrapper">
                ...
                <div class="partners_list_under_wrapper_sub">
                  ...
                  <iaixsl:if test="not(@phone1 = '')">
                    <span class="city_tel1">Telefoon:<iaixsl:value-of select="@phone1"/>         
                    </span> 
                  </iaixsl:if>  
                  <iaixsl:if test="not(@phone2 = '')">
                    <span class="city_tel2">Telefoon:<iaixsl:value-of select="@phone2"/>         
                    </span> 
                  </iaixsl:if>  
...
<iaixsl:attribute name="class">btn-small city_showDesc</iaixsl:attribute>Beschrijving tonen<div class="city_desc">
...
<iaixsl:attribute name="class">btn-small show_on_map</iaixsl:attribute>
                      <iaixsl:if test="not(card/desc)"><iaixsl:attribute name="class">show_on_map btn-small noDesc</iaixsl:attribute></iaixsl:if>Toon kaart</a>
      ...
      <iaixsl:if test="not(count(page/partners/city/partner) &gt; $partnersLimit)">
        ...
        <div class="partners_list_under_sub">
<iaixsl:attribute name="class">big_label partners_list_under_sub</iaixsl:attribute>
          <span class="partners_list_under_label">Lijst van adressen</span>
        </div>        
        <iaixsl:for-each select="page/partners/city"> 
            ...
            <iaixsl:for-each select="partner">
              <div class="partners_list_under_wrapper under_limit">
                ...
                <div class="partners_list_under_wrapper_sub">
                  ...
                  <iaixsl:if test="card/desc">
                    <a class="city_showDesc" onclick="partners_map.showDesc(this);">Beschrijving tonen<div class="city_desc">
                        <div class="city_desc_wrapper">
                          <iaixsl:value-of disable-output-escaping="yes" select="card/desc"/>
                        </div>
                      </div>
                    ...
                    <a class="show_on_map" onclick="partners_map.markerOnClick(this);">
                      <iaixsl:if test="not(card/desc)"><iaixsl:attribute name="class">show_on_map noDesc</iaixsl:attribute></iaixsl:if>Toon kaart</a>
                  <iaixsl:if test="card/@icon">
                    <img class="city_img"><iaixsl:attribute name="src"><iaixsl:value-of select="card/@icon"/></iaixsl:attribute>  </img>
                  </iaixsl:if>                
                </div>
    ...
    <div id="partners_list_none">
      ...
      <div id="partners_list_city_pop">
        <h2 class="partner_list_city_label">Selecteer een stad</h2>
        <div class="partners_list_city_search_wrapper">
          <input class="partners_list_city_search" id="city_search" type="text" name="text" onkeyup="partners_map.citySearch(this);" onfocus="partners_map.clearInput(this)" onblur="partners_map.clearInput(this)">
            <iaixsl:attribute name="value">zoek stad...</iaixsl:attribute>
          </input>
        </div>
        
        <div class="partners_list_city_list_wrapper">
          <span class="partners_list_noResult">geen stad gevonden</span>
          <iaixsl:for-each select="page/partners/city">
            <div class="city_list_element">
              ...
              <span class="city_list_info">(partners:<iaixsl:value-of select="count(partner)"/> 
                )
              </span>
            </div>
          </iaixsl:for-each>
        ...
        <div id="menu_notice" class="partners_list_buttons">
          <button class="btn-small" onclick="$('#dialog_close').click();">venster sluiten</button>
        </div>
      </div>
    </div>
  </iaixsl:if>
