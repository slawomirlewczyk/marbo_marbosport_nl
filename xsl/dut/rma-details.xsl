    ...
    <!--Rma szczegóły (rma_details_form, 107800.1)-->
        ...
        <iaixsl:if test="page/@display = 'details'">
            <div class="step_confirmation">
                ...
                <iaixsl:if test="/shop/page/details/@status=1">
                    <div class="progress_bar_wrapper pb_step confirmation rma_progress_bar">
                        ...
                        <div class="_step _step3">
                            ...
                            <p>
                                <i/>
                                <b>Kies uw methode</b>levering</p>
                        </div>
                ...
                <div id="orderdetails_info" class="rma_orderdetails_info">
                    ...
                    <h2 class="big_label">
                        <span>Klachtgegevens</span>
                        <span class="order-date">Datum waarop de claim is ontstaan:<iaixsl:value-of select="page/details/@datetime"/>
                        </span>
                    </h2>
                    <div id="orderdetails_info_status">
                        ...
                        <div class="prepaid-status">
                            ...
                            <small>Klacht nr:<iaixsl:value-of select="page/details/@id"/></small>
                        </div>

                        <div class="prepaid-buttons">
                            <iaixsl:if test="/shop/page/editlink/@url">
                                <a class="btn-icon prepaid-edit">
                                    <iaixsl:attribute name="title">Klik om de klacht te bewerken.</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute><i class="icon-pencil"></i><span>Wijzig uw klacht</span></a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/page/cancellink/@url">
                                <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                    ...
                                    <iaixsl:attribute name="title">Annuleer uw claim</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cancellink/@url"/></iaixsl:attribute>
                                    <i class="icon-remove"></i><span>Annuleer uw claim</span>
                                </a>
                            </iaixsl:if>
                        </div>
                    </div>
                ...
                <iaixsl:if test="/shop/page/documentlink/@url">
                    <div class="orderdetails_documentlink">
                        <h2 class="big_label">
                            <span>Afdruk van de uitnodiging tot betaling</span>
                        </h2>
                        <div class="documentlink_image row">
                            <div class="document_img_1 col-12 col-sm-4">
                                <img src="/gfx/pol/documentlink_1.png?r=1612518076" alt=""/>
                                <span>Claim en etiketten afdrukken</span>
                            </div>
                            <div class="document_img_2 col-12 col-sm-4">
                                <img src="/gfx/pol/documentlink_2.png?r=1612518076" alt=""/>
                                <span>Maak de verpakking klaar. Voeg een schadeformulier bij.</span>
                            </div>
                            <div class="document_img_3 col-12 col-sm-4">
                                <img src="/gfx/pol/documentlink_3.png?r=1612518076" alt=""/>
                                <span>Stuur een pakje. U betaalt niets extra's voor het verzenden.</span>
                            </div>
                        </div>
                        <iaixsl:if test="/shop/page/documentlink/@url">
                            <div class="return_wrapper2">
                                <a class="btn --solid --large" target="blank">
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/documentlink/@url"/></iaixsl:attribute>Een klachtenrapport afdrukken</a>
                            </div>
                        </iaixsl:if>
                    </div>
                </iaixsl:if>
                ...
                <iaixsl:if test="/shop/page/rma_questions">
                    <div class="rma_questions">
                        <h2 class="big_label">
                            <span>Correspondentie betreffende klachten</span>
                        </h2>
                        ...
                        <form class="rma_added_files" method="post" enctype="multipart/form-data">
                            ...
                            <div class="rma_af_input">
                                ...
                                <div class="form-group clearfix row">
                                    <label for="comment" class="control-label">
                                        ...
                                        <div class="rma_af_info">
                                            <strong>Bericht toevoegen</strong>
                                            <span>Het winkelpersoneel zal zo snel mogelijk reageren.</span>
                                        </div>
                                    </label>
                                    <div>
                                            ...
                                            <iaixsl:for-each select="/shop/page/rma_questions/rma_files/file">
                                                <li>
                                                    ...
                                                    <a class="deleteFile">
                                                        ...
                                                        <iaixsl:attribute name="title">Bestand verwijderen</iaixsl:attribute>Bestand verwijderen</a>
                                                </li>
                                            </iaixsl:for-each>
                                        </ol>
                                    </iaixsl:if>
                                ...
                                <div class="rma_af_buttons">
                                    <a class="btn --solid --large --secondary --icon-left icon-paperclip rma_attach_file">Foto bijvoegen</a>

                                    <button class="btn --solid --large mb-1" type="submit">Stuur</button>
        ...
        <iaixsl:if test="page/returnproducts/products/product">
            ...
            <div id="prepaid_order_products">
                <h2 class="big_label">Product geclaimd</h2>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" class="rma-remarks">
                                        ...
                                        <div class="rma-remarks">
                                            <b class="rma-remarks">Fout beschrijving:</b>
        ...
        <div class="step7">
            ...
            <iaixsl:if test="/shop/page/pickup/name">
                <div class="returns_details_wrapper">
                    <h2 class="big_label">Adres van de plaats van de klacht</h2>
                            ...
                            <div class="pickupl_return_one_sub">
                                <div class="pickupl_return_one_link">
                                    <a target="_blank" class="btn --solid">
                                        <iaixsl:attribute name="title">meer informatie</iaixsl:attribute>
                                        <iaixsl:attribute name="href">
                                            <iaixsl:value-of select="/shop/page/pickup/link"/>
                                        </iaixsl:attribute>meer informatie</a>
                                </div>
                        ...
                        <div class="basketedit_calculations">
                            <iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>De waarde van het geadverteerde product:</label>
            ...
            <div class="prepaid_summary_buttons">
                <iaixsl:if test="page/backlink/@url">
                    <a class="btn --solid --medium">
                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/backlink/@url"/></iaixsl:attribute>Maak reclame voor een ander product</a>
                </iaixsl:if>
                <iaixsl:if test="page/backlink_other/@url">
                    <a class="btn --solid --medium">
                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/backlink_other/@url"/></iaixsl:attribute>Claim een ander product van deze bestelling</a>
                </iaixsl:if>
            </div>
        </iaixsl:if>
        ...
        <div id="menu_notice" style="display: none;">
            ...
            <h2>Annulering van klachten</h2>
            <strong>Het annuleren van een klacht is een onomkeerbare actie. Om verder te gaan drukt u op de knop claim annuleren.</strong>
            <div class="menu_notice_button">
                <button onclick="$('#dialog_close').click();" class="prepaid_cancel btn --solid">Venster sluiten</button>
                <button class="prepaid_confirm btn --solid">Annuleer uw claim</button>
            </div>
            <div class="clearboth"/>
        </div>
