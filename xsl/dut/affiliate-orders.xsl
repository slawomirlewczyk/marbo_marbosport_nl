...
<div class="affiliate_orders_label">
   <iaixsl:attribute name="class">big_label affiliate_orders_label</iaixsl:attribute>
    ...
    <span class="affiliate_orders_label">De bestellingen van uw klanten</span>
</div>
<iaixsl:choose>
    <iaixsl:when test="count(page/orders/client)">
        <div class="affiliate_orders_desc">
            <p class="affiliate_orders_desc">De onderstaande tabel toont degenen die op uw aanbeveling een aankoop hebben gedaan of een account bij ons hebben aangemaakt. De vermelde bedragen zijn voor bestellingen met uw partnerschap. Om de details van een persoon te bekijken, klik op zijn ID.</p>
        </div>
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_orders</iaixsl:attribute>
                    ...
                    <thead>
                        <tr>
                            <th id="affiliate_orders_th1">klant id</th>
                            <th id="affiliate_orders_th3">datum waarop de rekening is aangemaakt</th>
                            <th id="affiliate_orders_th4">aantal geplaatste bestellingen</th>
                            <th id="affiliate_orders_th5">de waarde van de bestelde producten<span><br/><small>(zonder verzendkosten)</small></span></th>
                            <th id="affiliate_orders_th6">aantal afgeronde bestellingen</th>
                            <th id="affiliate_orders_th7">aantal uitgevoerde orders<span><br/><small>(zonder verzendkosten)</small></span></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <iaixsl:if test="page/orders/client_sum">
                            <tr data-mobile-class="hide" class="table-stroke-row-sum">
                                <td class="affiliate_orders_sum"><span>Totaal</span></td>
    ...
    <iaixsl:otherwise>
        <div class="affiliate_orders_null">Geen bestellingen van uw klanten.</div>
    </iaixsl:otherwise>
</iaixsl:choose>
</iaixsl:if>
