        ...
        <!--RMA - open (rma_open_form, 112617.1)-->
			<section class="rma_open mb-4">
				...
				<h1 class="rma_open__label headline">
					<span class="rma_open__label_txt headline__name">Selecteer de bestelling waarvan u het product wilt claimen</span>
				</h1>

				
				<div class="rma_open__description menu_messages_message mb-4">
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/rma-open/@rma_exist_link and not(/shop/page/rma-open/@rma_exist_link = '')">Voor deze bestelling is al een klacht ingediend. Controleer de status van uw huidige claims of voeg een nieuwe toe via het Claims-paneel.</iaixsl:when>
                        <iaixsl:when test="/shop/page/rma-open/@client = 'false' or /shop/page/rma-open/@client_orders = 'true'">Als u een klacht over een product wilt indienen, geef dan het bestelnummer op waarin het product is verzonden (u vindt dit in de e-mail die u na het plaatsen van uw bestelling hebt ontvangen) en uw telefoonnummer of e-mailadres.</iaixsl:when>
                    ...
                    <iaixsl:when test="/shop/page/rma-open/@rma_exist_link and not(/shop/page/rma-open/@rma_exist_link = '')">
                        <div class="rma_open__exists d-flex align-items-center flex-column">
                            <a class="rma_open__exist btn --solid --medium mb-3">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/rma-open/@rma_exist_link"/></iaixsl:attribute>Ga naar klachten</a>
                            <a class="rma_open__new btn --solid --medium mb-3">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/rma-open/@rma_new_link"/></iaixsl:attribute>Een nieuwe klacht indienen</a>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
						<form action="/rma-open.php" method="post" class="rma_open__form row flex-column align-items-center mb-4" novalidate="novalidate">
							<div class="rma_open__inputs col-12 col-sm-7">
								...
								<div class="f-group rma_open__number">
									<div class="f-feedback rma_open__feedback --number">
										...
										<label for="rma_open__number_input" class="f-label">Bestelnummer:</label>
								...
								<div class="f-group rma_open__email">
									<div class="f-feedback rma_open__feedback --email">
										...
										<label for="rma_open__email_input" class="f-label">Uw telefoon of e-mail:</label>
										<span class="f-control-feedback"/>
									</div>
								</div>
							</div>
							...
							<div class="rma_open__submit col-12 col-sm-7 d-flex flex-column align-items-center">
								<button class="btn --solid --medium px-5 rma_open__button">Een bestelling vinden</button>
