...
<div class="payment_card">
    <div class="payment_card_sub">
        <div class="payment_card_info">Kaartgegevens worden niet opgeslagen in ons systeem. Ze worden onmiddellijk na het afsluiten van de transactie gewist.</div>
        ...
        <form class="payment_card">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="@name = 'creditCard[system]'">
                        <div class="payment_card_formel cc_wrapper">
                            <label for="credit_card_system" class="payment_card_formel">Type kaart:</label>
                            ...
                            <span class="payment_card_need">
                                <img src="/gfx/pol/need.gif?r=1685223127" class="payment_card_nedd_img"><iaixsl:attribute name="alt">To pole jest wymagane do dokonania płatności</iaixsl:attribute><iaixsl:attribute name="title">Dit veld is verplicht om een bestelling te plaatsen</iaixsl:attribute></img>
                                <img src="/gfx/pol/correct.png?r=1685223127" class="payment_card_correct_img" style="display:none;"/><img src="/gfx/pol/incorrect.png?r=1685223127" class="payment_card_wrong_img" style="display:none;"/>
                                <span class="payment_card_help"><span class="payment_card_help2">Selecteer een creditcardregeling</span></span>
                            </span>
                    ...
                    <iaixsl:when test="@name = 'creditCard[number]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_number" class="payment_card_formel">Kaartnummer:</label>
                    ...
                    <iaixsl:when test="@name = 'creditCard[endDateMonth]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_month" class="payment_card_formel">Vervaldatum:</label>
                        ...
                        <div class="payment_card_datedesc">De vervaldatum moet worden ingevoerd als een getal van twee cijfers, bv. 04/12</div>
                    </iaixsl:when>
                    <iaixsl:when test="@name = 'creditCard[securityCode]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_code" class="payment_card_formel">Veiligheidscode (CVV):</label>
                    ...
                    <iaixsl:when test="@name = 'creditCard[name]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_name" class="payment_card_formel">Naam:</label>
            ...
            <div class="credit_card_submit">
                <button class="btn --solid --large credit_card_submit disabled" type="submit">
                    <iaixsl:attribute name="title">Doe een betaling</iaixsl:attribute>Doe een betaling</button>
