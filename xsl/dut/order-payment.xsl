                    ...
                    <iaixsl:when test="@name = 'creditCard[system]'">
                        <div class="payment_card_formel cc_wrapper">
                            ...
                            <span class="payment_card_need">
                                <img src="/gfx/pol/need.gif?r=1612518076" class="payment_card_nedd_img"><iaixsl:attribute name="alt">To pole jest wymagane do dokonania płatności</iaixsl:attribute><iaixsl:attribute name="title">Dit veld is verplicht om een bestelling te plaatsen</iaixsl:attribute></img>
                                <img src="/gfx/pol/correct.png?r=1612518076" class="payment_card_correct_img" style="display:none;"/><img src="/gfx/pol/incorrect.png?r=1612518076" class="payment_card_wrong_img" style="display:none;"/>
