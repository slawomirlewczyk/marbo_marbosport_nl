            ...
            <div id="signin-form_box_left" class="signin-form_box col-md-8 col-sm-7 col-12">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="not(/shop/client_data/@signin = 'cookie') and /shop/client_data/@iai_accounts = 'consent' and (not(/shop/client_data/@last_login_option = 'shop'))">
                        ...
                        <div id="cookie_login_social" class="iai_accounts">
                            <span id="cookie_login_social_desc" class="iai_accounts">Log in met<strong>IAI Accounts</strong>via<iaixsl:value-of select="$social_media_name"/>en uw verzendgegevens worden automatisch ingevuld op basis van uw vorige bestellingen.</span>
                                ...
                                <iaixsl:for-each select="login_options/service[not(@name='shop_register') and not(@login_url)]">
                                    <form action="login.php" method="post" style="display:none;">
                                        ...
                                        <button type="submit" class="signin_button btn --solid">
                                            <iaixsl:attribute name="data-signin_button"><iaixsl:value-of select="@name"/></iaixsl:attribute>Inloggen</button>
                                    </form>
                                </iaixsl:for-each>
                            </div>
                        </iaixsl:if>
                            ...
                            <span id="cookie_login_social_desc">
                                <iaixsl:choose>
                                    <iaixsl:when test="not(/shop/client_data/@iai_accounts = 'consent')">
                                        <strong>U bent al onze klant.</strong>
                                        Zaloguj się ponownie przez 
                                        <iaixsl:value-of select="$social_media_name"/>
                                        , abyśmy mieli pewność że to Ty. 
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <iaixsl:attribute name="class">iai_accounts</iaixsl:attribute>Log in met<strong>IAI Accounts</strong>via<iaixsl:value-of select="$social_media_name"/>en uw verzendgegevens worden automatisch ingevuld op basis van uw vorige bestellingen.</iaixsl:otherwise>
                                </iaixsl:choose>
                            </span>
                            <div id="cookie_login_social_item">
                                <div id="client_new_social">
                                ...
                                <div id="client_new_social">
                                    ...
                                    <div class="client_new_social_sub">
                                        ...
                                        <iaixsl:if test="not(page/client-data/@allow_register = 'false')">
                                            <p>Als u een account heeft bij een van de volgende diensten, kunt u deze gebruiken om een account aan te maken en later in te loggen.<br/><br/> <b>Als u al een eerdere account heeft</b>kunt u ze voor uw eigen gemak koppelen aan een login van uw favoriete dienst. Om dit te doen, logt u eerst in en gaat u vervolgens naar het bewerken van uw gegevens, waar u de juiste tool vindt om uw account te koppelen.</p>
                                        </iaixsl:if>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_1">
                    <div class="signin-form_select">
                        <h3>Log me in via</h3>
                        <input id="signin-form_radio1" type="radio" value="signin-form_box_sub_1" checked="checked" name="login_form1" data-target="login_form2"/><label for="signin-form_radio1">login en wachtwoord</label>
                        <input id="signin-form_radio2" type="radio" value="signin-form_box_sub_2" name="email_form1" data-target="email_form2"/><label for="signin-form_radio2">wachtwoord herinneren</label>
                    </div>
                        ...
                        <div class="signin_inputs col-md-10 col-12">
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="user_login" class="control-label">Login / Klantenkaartnummer / E-mail</label>
                            ...
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="user_pass" class="control-label">Wachtwoord / Getrouwheidskaart pin</label>
                                    <span class="form-control-feedback"/>
                                </div>
                            </div>
                        </div>
                        <div class="signin_buttons col-md-10 col-12">
                            <button class="btn --solid --medium signin_button" type="submit">Inloggen</button>
                            ...
                            <a class="password_reminder_signin" href="#signin-form_radio2">
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:otherwise>Ik weet mijn login of wachtwoord niet meer</iaixsl:otherwise>
                                </iaixsl:choose>
                            </a>
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie'">
                                <a class="cookie_login_social_new_account" href="/client-new.php?register">Dit is niet mijn account en ik wil een nieuwe aanmaken</a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie' and not(/shop/client_data/@last_login_option = 'shop') and count(login_options/service[not(@name = $social_media_name)]) &gt; 0">
                                <a class="cookie_login_social_more_social" href="#more_social">Inloggen met een account van een andere dienst</a>
                            </iaixsl:if>
                        </div>
                    </form>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_2">
                    <p class="reminder_desc">Er wordt een e-mail naar uw adres gestuurd waarmee u automatisch kunt inloggen. U kunt uw wachtwoord wijzigen nadat u bent ingelogd op de pagina Uw gegevens bewerken.</p>

                    <div class="signin-form_select">
                        <h3>Log me in via</h3>
                        <input id="signin-form_radio3" type="radio" value="signin-form_box_sub_1" name="login_form2" data-target="login_form1"/><label for="signin-form_radio3">login en wachtwoord</label>
                        <input id="signin-form_radio4" type="radio" value="signin-form_box_sub_2" name="email_form2" data-target="email_form1" checked="checked"/><label for="signin-form_radio4">wachtwoord herinneren</label>
                    </div>
                        ...
                        <div class="signin_inputs col-md-10 col-12">
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="user_mail_recover" class="control-label">E-mailadres</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                <div class="form-desc">Voer het e-mailadres in dat u tijdens de registratie hebt opgegeven of het nummer van uw klantenkaart.</div>
                            </div>

                            <div class="signin_buttons col-md-10 col-12">
                                <button class="btn --solid --medium signin_password-recover" type="submit">Wachtwoord herinnering</button>

                                <a class="password_back_signin" href="#signin-form_radio1">Terug naar standaard login</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="signin-form_box_sub">
                        <iaixsl:choose>
                            <iaixsl:when test="page/actions/client_once">
                                <h2 class="big_label">Nieuwe klant</h2>
                                <p class="registration_desc">Als u nog niet eerder een account bij ons hebt aangemaakt, wordt u gevraagd uw gegevens en leveringsadres in te voeren.</p>
                                <iaixsl:if test="page/actions/client_register">
                                    <a class="btn --solid --medium signin-form_register">
                                        ...
                                        </iaixsl:choose>Registreren en bestellen</a>
                                ...
                                <iaixsl:if test="page/actions/client_once">
                                    <a class="btn --solid --medium --secondary signin-form_once">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/actions/client_once/@url"/></iaixsl:attribute>Bestellen zonder registratie</a>
                                </iaixsl:if>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <h2 class="big_label">Registratie</h2>
                                <p class="registration_desc">Als u nog niet eerder een account bij ons hebt aangemaakt, wordt u gevraagd uw gegevens en leveringsadres in te voeren.</p>
                                <a class="btn --solid --medium signin-form_register2">
                                        ...
                                        </iaixsl:choose>Een nieuw account aanmaken</a>
                                    <iaixsl:if test="$register_number &gt; 1">
                                        <div class="register_wholesaler">
                                            <i class="icon-wholesaler-register"></i>Bent u een groothandelaar? Profiteer van<a>
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/registration_options/wholesale/@registration_url"/></iaixsl:attribute>
