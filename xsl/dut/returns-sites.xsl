                                ...
                                <div class="pickupl_return">
                                    ...
                                    <div class="pickupl_return_sub">
                                        ...
                                        <div class="pickupl_return_link">
                                            <a target="_blank">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
                                                <iaixsl:attribute name="title">meer informatie over het punt</iaixsl:attribute>meer informatie</a>
                                        </div>
                                        <iaixsl:if test="info">
                                 ...
                                 <div class="pickupl_return_one">
                                    ...
                                    <div class="pickupl_return_one_sub">
                                        <div class="pickupl_return_one_link">
                                            <a target="_blank">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
                                                <iaixsl:attribute name="title">meer informatie over het punt</iaixsl:attribute>Zie details</a>
                                        </div>
