    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
        ...
        <iaixsl:if test="(page/@type = 'login') and (page/login/@type='ok') and not(page/login/response)">
            <div id="login_welcome" class="l_welcome">
                ...
                <span class="l_welcome__element --text">We kijken ernaar uit u weer te zien</span>

                <a href="/login.php?operation=logout" class="l_welcome__element --logout btn --outline --icon-left icon-power-off">Uitloggen</a>
            </div>
        </iaixsl:if>
                                    ...
                                    <div class="login_menu_sub col-12">
                                        ...
                                        <div class="balance_section">
                                            ...
                                            <iaixsl:if test="page/login/client_balance/balance/@value &gt; 0">
                                                ...
                                                <span>Uw saldo (te veel betaald):</span>
                                            ...
                                            <iaixsl:if test="page/login/client_balance/limit/@value &gt; 0">
                                                <div class="login_point_count">
                                                <span>Resterende kredietlimiet:</span>
                                            ...
                                            <iaixsl:if test="page/login/client/invoice_data/@account_number">
                                                <div class="login_point_count">
                                                <span>Een individuele rekening voor uw bijdragen:<span class="btn_note"><i class="icon-question"></i></span><div class="tooltipContent">Dit rekeningnummer is uw unieke rekeningnummer. U kunt dit nummer gebruiken om uw bestellingen te betalen. Deze rekening is van u alleen, dus zelfs als u een fout maakt en te veel geld overmaakt, wordt dit bij uw saldo opgeteld.</div></span>
                    ...
                    <div class="login_menu_wrapper col-12 row mx-0 flex-wrap align-items-stretch">
                        ...
                        <iaixsl:if test="/shop/page/actions/products_wishes/@url or /shop/page/actions/products_requests/@url">
                            <div class="login_menu col-md-6 col-12" id="products_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsproducts"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsproducts"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="products" src="/gfx/pol/products.png?r=1612518076"/></iaixsl:otherwise></iaixsl:choose>Producten</h3>
                                    ...
                                    <a class="btn --outline">
                                        ...
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/products_wishes/@url"/></iaixsl:attribute>Boodschappenlijst</a>
                                    <a class="btn --outline">
                                    ...
                                    <a class="btn --outline">
                                        ...
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/products_requests/@url"/></iaixsl:attribute>Gezocht</a>
                                </div>
                            </div>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="/shop/page/actions/orders_opened/@url or /shop/page/actions/orders_closed/@url">
                            <div class="login_menu col-md-6 col-12" id="orders_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsorders"><i><iaixsl:attribute name="class"><iaixsl:value-of select="$iconsorders"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="orders" src="/gfx/pol/orders.png?r=1612518076"/></iaixsl:otherwise></iaixsl:choose>AANSCHAF EN BESCHIKBARE MIDDELEN</h3>
                                    <div><span>Een sectie waar u op de hoogte kunt blijven van de voortgang van uw lopende bestellingen, uw betalingen kunt beheren en de bestellingen kunt bekijken die wij al hebben afgerond.</span></div>
                                        <a class="btn --outline">
                                            ...
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/orders_opened/@url"/></iaixsl:attribute>Huidige</a>
                                        ...
                                        <a class="btn --outline">
                                            ...
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/orders_closed/@url"/></iaixsl:attribute>Gerealiseerd</a>
                                </div>
                            </div>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="/shop/page/actions/client_edit/@url">
                            <div class="login_menu col-md-6 col-12" id="dane_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconseditdata"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconseditdata"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="editdata" src="/gfx/pol/editdata.png?r=1612518076"/></iaixsl:otherwise></iaixsl:choose>
                                    ...
                                    <iaixsl:if test="/shop/client_files/@to_download = 'true'">
                                        <a class="btn --outline">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/client_files/@link_to_download"/></iaixsl:attribute>Downloads</a>
                                    </iaixsl:if>
                                    <a class="btn --outline">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/client_edit/@url"/></iaixsl:attribute>Bewerken van gegevens</a>
                                </div>
                            </div>
                        </iaixsl:if>
                        ...
                        <div class="login_menu col-md-6 col-12" id="returns_login">
                            <div class="login_menu_sub">
                                <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsreturns"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsreturns"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="returns" src="/gfx/pol/returns.png?r=1612518076"/></iaixsl:otherwise></iaixsl:choose>PRODUCT RETOUREN</h3>
                                ...
                                <a class="btn --outline">
                                    ...
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="page/actions/orders_returns/@url"/></iaixsl:attribute>Retour toevoegen</a>
                                <a class="btn --outline">
                                    ...
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="page/actions/return_list/@url"/></iaixsl:attribute>Alle toegevoegde opbrengsten</a>
                            </div>
                        </div>
                        ...
                        <iaixsl:if test="/shop/rma/@active = 'y' and /shop/rma/@link">
                            <div class="login_menu col-md-6 col-12" id="rma_login">
                                <div class="login_menu_sub">
                                    <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsrma"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsrma"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="rma" src="/gfx/pol/rma.png?r=1612518076"/></iaixsl:otherwise></iaixsl:choose>PRODUCTKLACHTEN</h3>
                                    ...
                                    <a class="btn --outline">
                                        ...
                                        </iaixsl:if>Een klacht toevoegen</a>
                                    <a class="btn --outline">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/rma/@link"/></iaixsl:attribute>Uw klachten</a>
                                </div>
                            </div>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="(/shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')) or /shop/page/actions/products_points/@available='true' or (/shop/page/actions/points_cms/@url and not(/shop/page/actions/points_cms/@url=''))">
                            <div class="login_menu col-md-6 col-12" id="points_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconspoints"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconspoints"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="points" src="/gfx/pol/points.png?r=1612518076"/></iaixsl:otherwise></iaixsl:choose>GETROUWHEIDSPROGRAMMA<iaixsl:if test="/shop/basket/@client_points">
                                            <span>Je hebt momenteel:<strong><iaixsl:value-of select="/shop/basket/@client_points"/>punt</strong></span>
                                        </iaixsl:if>
                                    </h3>
                                    <div><span>Hier leest u hoe u het loyaliteitsprogramma van de winkel kunt gebruiken en, als u punten op uw rekening heeft, hoe u die kunt gebruiken.</span></div>

                                    <iaixsl:if test="/shop/page/actions/points_cms/@url and not(/shop/page/actions/points_cms/@url='')">
                                        <a class="btn --outline">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/points_cms/@url"/></iaixsl:attribute>Hoe punten verzamelen</a>
                                    </iaixsl:if>
                                    <iaixsl:if test="/shop/page/actions/client_rebate_points and /shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')">
                                        <a class="btn --outline">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/client_rebate_points/@url"/></iaixsl:attribute>Punten inwisselen voor korting</a>
                                    </iaixsl:if>
                                    <iaixsl:if test="/shop/page/actions/products_points/@available='true'">
                                        ...
                                        </iaixsl:if>Producten voor punten</a>
                                </iaixsl:if>
                                </div>
                            </div>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="/shop/page/affiliate and /shop/page/affiliate/@link">
                            <div class="login_menu col-md-6 col-12" id="affiliate_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsaffiliate"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsaffiliate"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="affiliate" src="/gfx/pol/affiliate.png?r=1612518076"/></iaixsl:otherwise></iaixsl:choose>AFFILIATIEPROGRAMMA</h3>
