            ...
            <div class="step6">
                ...
                <div class="progress_bar_wrapper pb_step6">
                    ...
                    <div class="_step _step1">
                        ...
                        <p>
                            <i/>
                            <b>Selecteer</b>Bestel</p>
                    </div>
                    <div class="_step _step2">
                        <span>2</span>
                        <p>
                            <i/>
                            <b>Selecteer producten</b>terug te sturen</p>
                    </div>
                    <div class="_step _step3">
                        <span>3</span>
                        <p>
                            <i/>
                            <b>Kies uw methode</b>product retouren</p>
                    </div>
                    <div class="_step _step4">
                        <span>4</span>
                        <p>
                            <i/>
                            <b>Selecteer een punt</b>productlevering</p>
                    </div>
                    <div class="_step _step5">
                        <span>5</span>
                        <p>
                            <i/>
                            <b>Selecteer vorm</b>terugbetalingen</p>
                    </div>
                    <div class="_step _step6">
                        <span>6</span>
                        <p>
                            <i/>
                            <b>Goedkeuren</b>Uw terugkeer</p>
                    </div>
                </div>
                ...
                <div class="n57856_order_overtaker">
                    <form class="returns_form" method="post">
                        ...
                        <div class="big_label order2_info_label">Gegevens en opmerkingen</div>

                        <div class="order2_info">
                            <div class="order2_info_sub" id="order2_info_sub1">
                                <h3 class="order2_info1" id="order2_nagl_1">Factuurgegevens</h3>
                                <div class="order2_info1" id="order2_box_1">
                                    <div class="order2_info1_sub">
                                        ...
                                        </iaixsl:if>e-mail<iaixsl:value-of select="page/orderclient/@email"/><br/>
                                    </div>

                                    <a class="order2_button_change_address btn --solid mt-2 mt-sm-0">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/orderclient/@changelink"/></iaixsl:attribute>factuurgegevens wijzigen</a>
                            ...
                            <div class="order2_info_sub" id="order2_info_sub2">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/pickup">
                                        <h3 class="order2_info1" id="order2_nagl_2a">Retouradres</h3>
                                        <div class="order2_info1" id="order2_box_2b">
                                            <div class="order2_info1_sub">
                                                ...
                                                <div class="order2_moreinfo">
                                                    <a class="order2_button_change_address btn --solid mt-2 mt-sm-0">
                                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/pickup/link"/></iaixsl:attribute>meer informatie</a>
                                                </div>
                                            </div>

                                            <a class="order2_button_change_address btn --solid mt-2 mt-sm-0" target="_blank">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/pickupchangelink/@url"/></iaixsl:attribute>het adres van het terugkeerpunt wijzigen</a>

                                        </div>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <h3 class="order2_info1" id="order2_nagl_2b">Plaats van terugkeer</h3>
                                        <div class="order2_info1" id="order2_box_2b">
                                            <div class="order2_info1_sub">
                                            ...
                                            <a class="order2_button_change_address btn --solid mt-2 mt-sm-0">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/deliveryaddress/@changelink"/></iaixsl:attribute>het retourleverpunt wijzigen</a>
                                        </div>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                            </div>
                        ...
                        <div id="return_products_list" class="order2_products">
                            ...
                            <iaixsl:variable name="required_from_special_offer"><span>Dit product werd beïnvloed door zijn prijs</span> na ceny innych produktów w koszyku.</iaixsl:variable>
                            ...
                            <table class="order2_table">
                                <tr>
                                    <th class="order2_name">Terug te sturen producten</th>
                                    ...
                                    <th class="order2_price">Prijs per eenheid</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="order2_name">
                                            ...
                                            <iaixsl:if test="not(size/@type='uniw')">
                                                <div class="order2_size_desc">Maat:<iaixsl:value-of select="size/@description"/>
                                                </div>
                                            </iaixsl:if>
                                            ...
                                            <iaixsl:if test="@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                                ...
                                                <iaixsl:if test="@required_from_special_offer = 'true'">
                                                    <div class="productslist_product_special_offer">
                                                        ...
                                                        <span>Dit product werd beïnvloed door zijn prijs</span>op de prijzen van andere producten in het winkelmandje.</div>
                                                </iaixsl:if>
                                            </iaixsl:if>
                        ...
                        <div id="return_products_delivery" class="order2_products">
                            ...
                            <table class="order2_table">
                                <tr>
                                    <th class="order2_name">Wijze en vorm van terugzending van het product</th>
                                        ...
                                        <td class="order2_name">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="/shop/page/return_method/@description">
                                                    <span class="order2_name">Wijze van retourneren van producten:<iaixsl:value-of select="/shop/page/return_method/@name"/>
                                                    </span>
                                                ...
                                                <iaixsl:when test="/shop/page/return_method/@id = 2 and /shop/page/return_method/@shipping_cost = 'shop'">
                                                    <span class="order2_name">Sposób zwrotu produktów: 
                                                        Skorzystam z przesyłek sklepu</span>
                                                    <div class="return_description">De verzendkosten zijn voor rekening van de winkel</div>
                                                </iaixsl:when>
                                    ...
                                    <td class="order2_name">
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 't'">
                                                <span class="order2_name">Vorm van vergoeding: Saldo klant</span>
                                            ...
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
                                                <span class="order2_name">Vorm van vergoeding: Transfer</span>
                                            ...
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
                                                <span class="order2_name">Vorm van terugbetaling: Handelskrediet herstellen</span>
                                ...
                                <div class="basketedit_summary_buttons table_display">
                                    ...
                                    <div class="btn_wrapper backlink">
                                        <iaixsl:if test="page/backlink/@url">
                                            <a class="btn --medium pl-sm-0">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/backlink/@url"/></iaixsl:attribute>Terug naar de vorige stap</a>
                                        </iaixsl:if>
                                    </div>
                                    ...
                                    <div class="btn_wrapper">
                                        ...
                                        <input class="btn --solid --large" type="submit">
                                            ...
                                            <iaixsl:attribute name="value">Terugkeerverklaring toevoegen</iaixsl:attribute>

                                            <iaixsl:if test="/shop/return_edit/@return_id">
                                                <iaixsl:attribute name="value">Wijzigingen opslaan</iaixsl:attribute>
                                            </iaixsl:if>
