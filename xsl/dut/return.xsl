...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
        ...
        <!--Komunikaty (return, 119566.1)-->
        <iaixsl:variable name="error_undefined_ret">Er is een onbekende fout opgetreden.</iaixsl:variable>

        <iaixsl:variable name="file_upload_invalid_type">Bestand kan niet worden geüpload</iaixsl:variable>

        <iaixsl:variable name="file_upload_invalid_extension">Bestand kan niet worden geüpload</iaixsl:variable>

        <iaixsl:variable name="file_upload_size_exceeded">Bestand kan niet worden geüpload</iaixsl:variable>

        <iaixsl:variable name="file_uploaded_remove_fail">Er is een fout opgetreden tijdens het uploaden van het bestand.</iaixsl:variable>

        <iaixsl:variable name="auction_shop_bundle_not_exist">De set met de geselecteerde productcombinatie bevindt zich niet in actieve veilingen. Kies indien mogelijk een andere productcombinatie, of neem contact met ons op.</iaixsl:variable>

        <iaixsl:variable name="token_expired">De link om toegang te krijgen tot uw gegevens is nu verlopen. Om toegang te krijgen tot de gegevens in uw account, gebruikt u de optie<a title="Zaloguj się" href="/signin.php">login pagina's</a>.</iaixsl:variable>

        <iaixsl:variable name="too_much_product">Het maximum dat u kunt bestellen is</iaixsl:variable>

        <iaixsl:variable name="not_enough_product">U moet minimaal bestellen</iaixsl:variable>

        <iaixsl:variable name="too_much_product_size">Het maximum dat u kunt bestellen is</iaixsl:variable>

        <iaixsl:variable name="not_enough_product_size">U moet minimaal bestellen</iaixsl:variable>

        <iaixsl:variable name="return_rebates_code_used">De verstrekte kortingscode is al gebruikt.</iaixsl:variable>

        <iaixsl:variable name="rebates_code_notbegun">De opgegeven kortingscode is nog niet actief. Deze promotie is nog niet begonnen.</iaixsl:variable>

        <iaixsl:variable name="rebates_code_expired">De geldigheid van de door u ingevoerde kortingscode is verlopen en niet meer actief.</iaixsl:variable>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="page/return/@type='file_upload_invalid_type' and $file_upload_invalid_type">
                        <h3 class="return_label"><iaixsl:value-of select="$file_upload_invalid_type"/>
                            <span class="invalidFileName"><iaixsl:value-of select="@value"/></span>aangezien het opnemen van bestanden van dit type niet is toegestaan.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='file_upload_size_exceeded' and $file_upload_size_exceeded">
                        <h3 class="return_label"><iaixsl:value-of select="$file_upload_size_exceeded"/>
                            <span class="invalidFileName"><iaixsl:value-of select="@value"/></span>omdat het de maximaal toegestane grootte overschrijdt.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'opinion_addphotoerror'">
                        <h3 class="return_label">De foto die u toevoegde is onjuist.<iaixsl:if test="page/return/param[@name = 'max_height'] and page/return/param[@name = 'max_width']">
                                <br/>Max. fotogrootte is:<iaixsl:value-of disable-output-escaping="yes" select="page/return/param[@name='max_width']/@value"/>x<iaixsl:value-of disable-output-escaping="yes" select="page/return/param[@name='max_height']/@value"/>px.</iaixsl:if>
                            <iaixsl:if test="page/return/param[@name = 'photo_format']">
                                <br/>Aanvaardbare fotoformaten:<iaixsl:value-of disable-output-escaping="yes" select="page/return/param[@name='photo_format']/@value"/>.
                            </iaixsl:if>
                        </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='token_expired' and $token_expired">
                        <h3 class="return_label">De link om toegang te krijgen tot uw gegevens is nu verlopen. Om toegang te krijgen tot de gegevens in uw account, gebruikt u de optie<a title="Zaloguj się" href="/signin.php">login pagina's</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='too_much_product' and $too_much_product">
                        <h3 class="return_label"><iaixsl:value-of select="$too_much_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/>stuks</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='not_enough_product' and $not_enough_product">
                        <h3 class="return_label"><iaixsl:value-of select="$not_enough_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/>stuks</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='too_much_product_size' and $too_much_product_size">
                        <h3 class="return_label"><iaixsl:value-of select="$too_much_product_size"/><iaixsl:value-of select="/shop/page/return/param/@value"/>stukken van de geselecteerde grootte.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='not_enough_product_size' and $not_enough_product_size">
                        <h3 class="return_label"><iaixsl:value-of select="$not_enough_product_size"/><iaixsl:value-of select="/shop/page/return/param/@value"/>stukken van de geselecteerde grootte.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'rma_require_one_order'">
                        <h3 class="return_label">Er is geen bestelling verwerkt op uw klantenrekening. Je moet iets gekocht hebben om een claim te kunnen toevoegen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderedit_dataerror'">
                        <h3 class="return_label">Gegevensfout bij het bewerken van een bestelling.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_product_worth'">
                        <h3 class="return_label">Het is niet mogelijk een bestelling te plaatsen omdat er producten in de winkelwagen zitten met een prijs van 0<iaixsl:value-of select="currency/@name"/>. Gelieve de inhoud van uw mandje te corrigeren.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='order_invalidpoints'">
                        <h3 class="return_label">Er is een fout opgetreden bij een product dat met punten is gekocht.<a href="/contact.php">Neem contact op met het winkelpersoneel</a>.</h3>
                    </iaixsl:when>

                    
                    <iaixsl:when test="page/return/@type='openid_login_canceled'">
                        <h3 class="return_label">Inloggen geannuleerd.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='openid_invalid_authorization'">
                        <h3 class="return_label">Autorisatie fout.</h3>
                    </iaixsl:when>
                    

                    <iaixsl:when test="page/return/@type = 'suggestbody_illegal_urls'">
                        <h3 class="return_label">We hebben de e-mail niet verstuurd omdat er adressen van andere sites in staan. Gebruik dergelijke adressen niet of laat de standaardsjabloon staan.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_login_disabled'">
                        <h3 class="return_label">Deze account geeft u niet het recht om in te loggen op deze website. Gebruik een andere rekening of<a href="/client-new.php?register">een nieuwe opzetten</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_notenoughpoints'">
                        <h3 class="return_label">U heeft te weinig loyaliteitspunten op uw rekening.</h3>
                    </iaixsl:when>


                    <iaixsl:when test="page/return/@type = 'compare_error_minimum'">
                        <h3 class="return_label">Voeg ten minste twee producten toe aan de vergelijking</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'questionnaire_error'">
                        <h3 class="return_label">Er is een fout opgetreden, de enquête is niet verzonden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'questionnaire_sent'">
                        <h3 class="return_label">Bedankt. De enquête is verstuurd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_authorized'">
                        <h3 class="return_label">Autorisatie verhuld.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_unauthorized'">
                        <h3 class="return_label">Autorisatie mislukt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_zagiel_error'">
                        <h3 class="return_label">U heeft ervoor gekozen geen afbetaling te ontvangen. Ga naar uw bestelgegevens en probeer opnieuw te betalen in termijnen of kies een andere vorm van betaling.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_zagiel_success'">
                        <h3 class="return_label">Verwacht dat een vertegenwoordiger van de Bank telefonisch contact met u opneemt. Tijdens het telefoongesprek stelt hij of zij een afbetalingscontract met u op. Voorbereiden: een identiteitskaart en een tweede identiteitsdocument.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_error'">
                        <h3 class="return_label">PolCard-autorisatiefout opgetreden</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'contactus_sent'">
                        <h3 class="return_label">Het bericht is verstuurd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'contactus_error'">
                        <h3 class="return_label">Er is een fout opgetreden. Bericht niet verzonden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_ok'">
                        <h3 class="return_label">Bestel<iaixsl:if test="page/return/@extra"><iaixsl:value-of select="page/return/@extra"/></iaixsl:if>werd geannuleerd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'returncancel_ok'">
                        <h3 class="return_label">De restitutie werd geannuleerd.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'returncancel_error'">
                        <h3 class="return_label">"Zwrot nie może zostać anulowany. Skontaktuj się z<a href="contact.php">service</a>voor meer informatie.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_dberror'">
                        <h3 class="return_label">Databank fout.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_dataerror'">
                        <h3 class="return_label">Deze bestelling kan niet worden geannuleerd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_ok'">
                        <h3 class="return_label">Bedankt. Bestel<iaixsl:if test="page/return/@extra"><iaixsl:value-of select="page/return/@extra"/></iaixsl:if>werd gemarkeerd als bevestigd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_noneed'">
                        <h3 class="return_label">De bestelling hoeft niet meer per e-mail te worden bevestigd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_confirmed'">
                        <h3 class="return_label">Het bevel was al bevestigd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_dataerror'">
                        <h3 class="return_label">Het ingevoerde adres is onjuist of verkeerd ingevoerd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'prepaid_error'">
                        <h3 class="return_label">U kunt deze volgorde niet wijzigen. Neem contact op met<a href="/contact.php">winkelpersoneel</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'prepaid_payback'">
                        <h3 class="return_label">Je hebt de vooruitbetaling verwijderd. Het geld wordt terugbetaald zodra het op onze rekening staat.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_badlogin'">
                        <h3 class="return_label">Het door u ingevoerde login of wachtwoord is niet correct.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_nouser'">
                        <h3 class="return_label">We konden geen account vinden met dit e-mailadres of klantenkaartnummer.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_disabled'">
                        <h3 class="return_label">De opgegeven rekening is geblokkeerd.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_wholesale_disabled'">
                        <h3 class="return_label">De winkel is alleen beschikbaar voor groothandelsklanten. Als u groothandelaar wilt worden, neem dan contact op met het winkelpersoneel.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_passremind'">
                        <h3 class="return_label">Er is een e-mail naar uw adres gestuurd waarmee u automatisch kunt inloggen. U kunt uw wachtwoord wijzigen nadat u bent ingelogd op de pagina Uw gegevens bewerken.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'basket_empty'">
                        <div class="basket_icon_wrapper"><i class="icon-empty_basket"></i></div>
                        <h3 class="return_label">Je mandje is leeg.</h3>
                        <p>Voeg producten toe om uw bestelling te plaatsen.</p>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'basket_size'">
                        <h3 class="return_label">Uw mandje heeft het maximaal beschikbare aantal producten bereikt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'wisheslist_empty'">
                        <div class="whish_icon_wrapper"><i class="icon-star-empty"></i></div>
                        <h3 class="return_label">Het boodschappenlijstje is leeg.</h3>
                        <p>Voeg er de producten aan toe die u leuk vindt en die u later wilt kopen.</p>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordered_empty'">
                        <div class="ordered_icon_wrapper"><i class="icon-empty_basket"></i></div>
                        <h3 class="return_label">De lijst van gekochte producten is leeg.</h3>
                        <p>Wanneer u een product koopt, verschijnt het op deze lijst.</p>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_minimum'">
                        <h3 class="return_label">Te kleine bestelwaarde.<iaixsl:if test="page/return/@extra">
                                <br/>De minimale bestelwaarde is<iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>
                            </iaixsl:if>
                        </h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'order_minimal_wholesale'">
                        <h3 class="return_label">Te kleine bestelwaarde.<iaixsl:if test="page/return/@extra">
                                <br/>De minimumwaarde van bulkaankopen is<iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>
                            </iaixsl:if>
                        </h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'order_tomuch'">
                        <h3 class="return_label">Uw totale bestelling is te groot<iaixsl:if test="page/return/@extra">(<iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>)</iaixsl:if>
                            <br/>Wacht tot we hebben voldaan aan wat u vooraf heeft besteld, of<a href="/login.php">een eerdere bestelling te annuleren.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'shipping_error'">
                        <h3 class="return_label">Het spijt ons, maar we leveren niet aan het geselecteerde leveringsland. Als u een bestelling wilt plaatsen in onze winkel -<a href="/contact.php">contact met ons opnemen</a>om de mogelijkheid toe te voegen om pakketten in uw land te leveren.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_nosuchemail'">
                        <h3 class="return_label">Het door u opgegeven e-mailadres staat niet op onze mailinglijst.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_removesuccess'">
                        <h3 class="return_label">Het e-mailadres is verwijderd van de mailinglijst.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_addsuccess'">
                        <h3 class="return_label">Het e-mailadres is toegevoegd aan de verzendlijst.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_emailexist'">
                        <h3 class="return_label">Het opgegeven e-mailadres staat al op de verzendlijst.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_maileregerror'">
                        <h3 class="return_label">Verkeerd e-mail adres. Probeer het opnieuw.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_sendingconfirm'">
                        <h3 class="return_label">Er is een e-mail gestuurd naar het door u opgegeven e-mailadres om wijzigingen in onze mailinglijst te bevestigen. Ontvang de mail en volg de aanwijzingen in het bericht.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_success'">
                        <h3 class="return_label">De instructie om een online betaling te doen werd aanvaard.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_error'">
                        <h3 class="return_label">Er is een online betalingsfout opgetreden.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'payment_credit_success'">
                        <h3 class="return_label">De opdracht tot betaling in termijnen werd aanvaard.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_error'">
                        <h3 class="return_label">Er was een fout in de betaling in termijnen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'opinion_addsuccess'">
                        <h3 class="return_label">Het commentaar is toegevoegd en wacht op moderatie.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'opinion_adderror'">
                        <h3 class="return_label">Er is een fout opgetreden - het commentaar is niet toegevoegd aan het product.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '403'">
                        <h3 class="return_label">Toegang tot dit bestand is verboden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '404'">
                        <h3 class="return_label">Het ingevoerde document is niet gevonden. Als u via een onjuiste link naar deze pagina bent verwezen, gelieve dan<a href="/contact.php">dit aan ons melden</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '500'">
                        <h3 class="return_label">Er is een serverfout opgetreden. Wacht even en probeer de pagina opnieuw te verversen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'askforproduct_sent'">
                        <h3 class="return_label">Productgerelateerde vraag<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/return/@extra"/><iaixsl:text> </iaixsl:text>is succesvol verzonden. Wacht alstublieft op een antwoord.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'askforproduct_error'">
                        <h3 class="return_label">Productgerelateerde vraag<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/return/@extra"/><iaixsl:text> </iaixsl:text>is niet verzonden. Probeer het later nog eens.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'incorrect_email'">
                        <h3 class="return_label">Verkeerd e-mail adres. Geef een geldig e-mailadres op.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestreceiver_toolong'">
                        <h3 class="return_label">De lengte van adressen in het e-mailadresveld mag niet langer zijn dan 255 tekens.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestreceiver_bademail'">
                        <h3 class="return_label">De ingevoerde e-mailadressen zijn onjuist. Controleer of ze correct zijn ingevoerd en, als u meer dan één adres invoert, of ze door komma's worden gescheiden.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestsignature_tooshort'">
                        <h3 class="return_label">De getypte handtekening is te kort. Geef uw naam of bijnaam waaraan de ontvanger u zal herkennen.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestbody_tooshort'">
                        <h3 class="return_label">Geef de inhoud van uw bericht aan een vriend.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestproduct_sent'">
                        <h3 class="return_label">Het productaanbevelingsbericht is verzonden.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='rebates_code_begins'">
                        <h3 class="return_label">De promotie voor deze kortingscode is nog niet gestart.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='rebates_code_expires'">
                        <h3 class="return_label">De promotie voor deze kortingscode is nu afgelopen.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='rebates_code_undefined'">
                        <h3 class="return_label">De vermelde kortingscode bestaat niet.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='account_logoff'">
                        <h3 class="return_label">Er is een fout opgetreden tijdens het plaatsen van uw bestelling. Log opnieuw in en voltooi uw aankoop. Indien dit niet mogelijk is, gelieve<a href="/contact.php">contact met winkelpersoneel</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='get_attachment_error'">
                        <h3 class="return_label">De bijlage die u probeert te downloaden is niet beschikbaar.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='stock_not_found'">
                        <h3 class="return_label">Geen verzamelpunt gevonden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='stock_transfer'">
                        <h3 class="return_label">U kunt geen bestelling plaatsen omdat de producten die u bestelt zich in verschillende magazijnen bevinden.<a href="/contact.php">Neem contact op met het winkelpersoneel</a>voor informatie over hoe u uw bestelling kunt afronden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='insurance_error'">
                        <h3 class="return_label">Er is een fout gemaakt bij het verzekeren van uw bestelling en deze is niet geregistreerd.<a href="/contact.php">Neem contact op met het winkelpersoneel om de situatie op te helderen.</a>  </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='products_not_available'">
                        <h3 class="return_label">Het product is niet verkrijgbaar bij een persoonlijk afhaalpunt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='no_partners'">
                        <h3 class="return_label">Sorry. Onze winkel deelt geen informatie over zijn zakenpartners.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='page_only_register'">
                        <h3 class="return_label">Pagina alleen beschikbaar voor ingelogde personen.<a class="loginPopUpShow" href="/signin.php" title="Zaloguj się">Inloggen.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='page_only_unregister'">
                        <h3 class="return_label">Deze pagina is alleen beschikbaar voor wie niet is ingelogd.<a href="/login.php?operation=logout" title="Wyloguj się">Afmelden.</a></h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_confirmed'">
                        <h3 class="return_label">Bedankt dat u contact met ons opneemt. We hebben uw vraag geregistreerd. Wij sturen zo spoedig mogelijk een antwoord op uw e-mail.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_confirm_error'">
                        <h3 class="return_label">Er is een fout opgetreden. De productaanvraag is niet verzonden.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_wrong_email'">
                        <h3 class="return_label">Verkeerd e-mail adres. De vraag is niet verzonden.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_sent'">
                        <h3 class="return_label">Bedankt voor uw vraag. Klik op de link in de e-mail die wij u zojuist hebben gestuurd om de indiening ervan te bevestigen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'to_many_products_compared'">
                        <h3 class="return_label">Ter vergelijking worden maximaal meerdere producten toegevoegd. Verwijder er een om een andere te kunnen toevoegen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'products_not_found'">
                        <h3 class="return_label">Het product dat u zoekt is niet gevonden. Gebruik alsjeblieft<a href="/searching.php" title="Kliknij, aby przejść do wyszukiwarki zaawansowanej">een geavanceerde zoekmachine</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'virtual_products_not_found'">
                        <h3 class="return_label">De lijst met bestanden die u niet meer kunt downloaden is leeg.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'virtual_products_to_download_not_found'">
                        <h3 class="return_label">Je hebt geen downloads. Deze pagina wordt actief zodra ze zijn gekocht.</h3>
                    </iaixsl:when>
        ...
        <div class="n54744_goback">
            <a class="btn --solid --medium n54744">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="(page/return/@type = 'page_only_register') or (page/return/@type = 'page_only_unregister') or (page/return/@type = 'basket_empty')">
                        
                        <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/@currurl"/></iaixsl:attribute>
                        <iaixsl:attribute name="id">retbut_strona_glowna</iaixsl:attribute>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <iaixsl:choose>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="page/return/@type = 'account_badlogin'">Inloggen</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'order_notenoughpoints'">Uw winkelmandje</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'ordercancel_ok'">Stuur  terug.</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'orderconfirm_dataerror'">Homepage</iaixsl:when>
                    <iaixsl:when test="page/return/@type='token_expired' and $token_expired">Inloggen</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'prepaid_error'">Inloggen</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'account_nouser'">Inloggen</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'account_disabled'">Homepage</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'account_passremind'">Inloggen</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'order_minimum'">Stuur  terug.</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'order_notenough'">Stuur  terug.</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'order_tomuch'">Stuur  terug.</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'rebates_code_begins'">Controleer uw code</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'rebates_code_expires'">Controleer uw code</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'rebates_code_undefined'">Controleer uw code</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'account_logoff'">Inloggen</iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'compare_error_minimum'">Homepage</iaixsl:when>
                    <iaixsl:when test="(page/return/@type = 'page_only_register') or (page/return/@type = 'page_only_unregister')">Homepage</iaixsl:when>
                    <iaixsl:when test="(page/return/@type = 'page_only_register') or (page/return/@type = 'page_only_unregister')">Homepage</iaixsl:when>
                    <iaixsl:when test="(page/return/@type = 'basket_empty') or (page/return/@type = 'page_only_unregister') or (page/return/@type = 'wisheslist_empty') or (page/return/@type = 'ordered_empty')">Begin met winkelen</iaixsl:when>
                    <iaixsl:otherwise>Stuur  terug.</iaixsl:otherwise>
                </iaixsl:choose>
            </a>
        </div>
