    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
        ...
        <!--Banery na stronie głównej (main_banner1, 106482.1)-->
            <iaixsl:if test="count(commercial_banner/link) &gt; 0">
                <iaixsl:variable name="txt_69867_01"/>

                <div id="main_banner1" class="mb-2 mb-sm-5">
                    <iaixsl:variable name="banner_class">skeleton mb-2 mb-sm-5</iaixsl:variable>
                    <iaixsl:if test="commercial_banner/link[1]/image or commercial_banner/link[1]/image_desktop or commercial_banner/link[1]/image_tablet or commercial_banner/link[1]/image_mobile">
                        <iaixsl:attribute name="class">
                            <iaixsl:choose>
                                ...
                                <iaixsl:otherwise>skeleton mb-4</iaixsl:otherwise>
                            </iaixsl:choose>
                        </iaixsl:attribute>
                    </iaixsl:if>
        ...
        <!--Buttony strefa 2 na stronie głównej (main_buttons2, 106484.1)-->
            <iaixsl:if test="count(commercial_button2/link)"> 
                <div id="menu_buttons2" class="row mb-5">
        ...
        <!--Hotspot na stronie głównej - strefa 2 (main_hotspot_zone2, 117909.1)-->
                        ...
                        <iaixsl:choose>
                                        ...
                                        <a class="headline">
                                            ...
                                            <span class="headline__name">
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:otherwise>Nieuws</iaixsl:otherwise>
                                                </iaixsl:choose>
                                            </span>
                            ...
                            <div class="products d-flex flex-wrap">
                                <iaixsl:for-each select="page/hotspot/products_zone2/*">
                                    ...
                                    <div class="product col-12 col-sm-6 col-md-2 py-3">
        ...
        <!--Hotspot na stronie głównej - strefa 3 (main_hotspot_zone3, 117910.1)-->
            
                <iaixsl:if test="page/hotspot/products_zone3">

                    <section id="main_hotspot_zone3" class="hotspot mb-5">
                        
                        <iaixsl:variable name="headline_after_products_zone3">Bekijk alle</iaixsl:variable>
        ...
        <!--Banery 3 na stronie głównej (main_banner3, 115705.1)-->
            <iaixsl:if test="count(commercial_banner3/link)"> 
                <div id="menu_banners3" class="row mb-5 mx-0">
                    <iaixsl:for-each select="commercial_banner3/link">
                        <iaixsl:if test="position() = 1">
                            <div class="menu_button_wrapper --hash">
                                <iaixsl:choose>
                                    <iaixsl:when test="not(html)">
                                        <iaixsl:choose>
                                            <iaixsl:when test="@href">
                    ...
                    <iaixsl:if test="count(/shop/commercial_banner3/link) &gt; 2">
                        <div class="row posts_list">
                            <iaixsl:for-each select="commercial_banner3/link">
                                <iaixsl:if test="position() &gt; 2">
                                    <div class="menu_button_wrapper --post">
                                        <iaixsl:choose>
                                            <iaixsl:when test="not(html)">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@href">
