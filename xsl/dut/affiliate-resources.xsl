...
<iaixsl:attribute name="class">big_label affiliate_resources_label</iaixsl:attribute>
    <span class="affiliate_resources_label">Uw fondsen te gebruiken</span>
</div>
<input type="hidden" id="payment_min"/>
<iaixsl:choose>
    <iaixsl:when test="(0 &gt; page/payments/@total) or (page/payments/@total = '0.00')">
        <span class="affiliate_noresources">Momenteel heb je de middelen niet om te gebruiken.</span>
    </iaixsl:when>
    <iaixsl:otherwise>
         <div class="affiliate_resources_wyplata">Uw affiliate account saldo is:<ol>
            ...
            </iaixsl:if>Als u het verzamelde geld wilt omzetten in een productbon, vult u in de onderstaande velden een bedrag in dat niet lager is dan<span class="resources_minpayment">
                ...
                <form method="POST">
                    ...
                    <div class="affiliate_resources_payment">
                        <div class="affiliate_resources_payment_sub">
                            <span class="affiliate_resources_kwota_label">Te betalen bedrag</span>
                            ...
                            <div id="affiliate_warning1" style="display:none;">
                                <div id="affiliate_warning1_sub">Het bedrag dat u noemde is te veel</div>
                            </div>
                            <div id="affiliate_warning2" style="display:none;">
                                <div id="affiliate_warning2_sub">Het bedrag dat u noemde is te klein.</div>
                            </div>
                            <div class="clear"/>
                        </div>
                    </div>
                    <div class="affiliate_resources_payment_type">
                        <iaixsl:choose>
                            ...
                            <iaixsl:otherwise>De bovenstaande waarde wordt uitbetaald in productvouchers.</iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    <input type="submit" class="btn --solid --medium affiliate_resources_submit" id="affiliate_resources_submit">
                                <iaixsl:attribute name="value">Betaling aanvragen</iaixsl:attribute>
                    </input>
                </form>
        </div>
    </iaixsl:otherwise>
...
<iaixsl:if test="page/resources/resource">
        <table class="affiliate_resources">
          <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_resources</iaixsl:attribute>
            <thead>
                <tr>
                    <th>datum van uitbetaling</th>
                    <th>soort betaling</th>
                    <th>tegoedbonnummer</th>
                    <th>stroom naar</th>
                    <th>bedrag</th>
                    <th>gebruikte</th>
                    <th>status</th>
            ...
            <iaixsl:for-each select="page/resources/resource">
                <tr>
                    ...
                    <iaixsl:choose>
                      ...
                      <iaixsl:otherwise>Bon</iaixsl:otherwise>
                    </iaixsl:choose>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <iaixsl:choose>
                      ...
                      <iaixsl:when test="@status = '0000-00-00'">
                         ...
                         <span>In afwachting van goedkeuring</span>
                      </iaixsl:when>
                      ...
                      <iaixsl:otherwise>                       
                        <div class="affiliate-icon-status badge-success">
                         ...
                         <span>Bevestigd<small>(<iaixsl:value-of select="@status"/>)</small>
                         </span> 
                      </iaixsl:otherwise>
                    </iaixsl:choose>
                  </div>
