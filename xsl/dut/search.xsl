...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
        ...
        <iaixsl:if test="/shop/page/products/navigation/filtering/filter/group/item"> </iaixsl:if>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="navigation/descendant::item[@ni=/shop/navigation/current/@ni] and not(navigation/descendant::item[@ni=/shop/navigation/current/@ni]/item) and page/@type='search'">
                        <iaixsl:choose>
                            ...
                            <iaixsl:otherwise>
                                <a class="menu_categories_label" href="/categories.php">Categorieën</a>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                        <ul>
							<iaixsl:if test="not(navigation/descendant::item[@ni=/shop/navigation/current/@ni]/../item[@ni = /shop/navigation/current/@ni])">
    ...
    <!--Opis kategorii w wyszukiwaniu (search_categoriesdescription, 116503.1)-->
        ...
        <div class="search_categoriesdescription">
            <h1>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:otherwise>Zoekresultaten</iaixsl:otherwise>
                </iaixsl:choose>
            </h1>
            <iaixsl:if test="not(page/products/@hideproducts = 'true')">
            <span class="navigation_total">( aantal producten:<b><iaixsl:value-of select="page/products/navigation/@total"/></b> )
            </span>
            </iaixsl:if>
    ...
    <!--Filtrowanie wyników wyszukiwania (search_filters, 110880.1)-->
          ...
          <iaixsl:variable name="showAll">10</iaixsl:variable>
              ...
              <section id="Filters" class="filters mb-4">
                  <form class="filters__form d-md-flex flex-wrap justify-content-start" method="get">
                      ...
                      <iaixsl:for-each select="/shop/page/products/navigation/filtering/filter[(@type = 'list') or (@type = 'text')]">
                          ...
                          <div class="filters__block my-md-1 mb-2">
                              ...
                              <a class="filters__toggler">
                                  ...
                                  <div class="btn --icon-right d-block pr-5">
                                      <span><iaixsl:value-of select="@name"/></span>
                                  </div>
                              </a>
                                  ...
                                  <iaixsl:choose>
                                          ...
                                          <div class="filters__content --search">
                                              <div class="f-group mb-0">
                                                  <input type="text" class="f-control --search_by_text __serialize">
                                                      ...
                                                      <iaixsl:attribute name="placeholder">Typ in wat u zoekt</iaixsl:attribute>
                                                  </input>
                                      ...
                                      <iaixsl:when test="@display = 'gfx' or @display = 'name_gfx'">
                                          ...
                                          <div class="filters__options">
                                              ...
                                              <button type="submit" class="d-none btn py-0 pl-0 pr-3 --outline --medium --submit">Gebruik</button>

                                              
                                              <iaixsl:if test="count(item) &gt; $showAll and @display = 'name_gfx'">
                                                  <a class="--show-hidden btn py-0 pl-1 pr-0">
                                                      <iaixsl:attribute name="data-id"><iaixsl:value-of select="$id"/></iaixsl:attribute>

                                                      <span class="--show">Uitbreiden</span>
                                          ...
                                          <div class="filters__content --range">
                                              ...
                                              <div class="filters__price">
                                                  ...
                                                  <div class="filters_options">
                                                      <button type="submit" class="btn p-md-0 mt-md-4 d-none d-inline-block --outline --medium">Gebruik</button>
                                                  </div>
                                              </div>
                                          </div>
                                      </iaixsl:when>
                                                  ...
                                                  <li class="filters__item mb-2">
                                                      <div class="f-group --small --checkbox mb-0">
                                                          ...
                                                          <label class="f-label">
                                                              ...
                                                              <span class="--name">
                                                                  <iaixsl:choose>
                                                                      <iaixsl:when test="@desc = '1week'">Vorige week</iaixsl:when>
                                                                      <iaixsl:when test="@desc = '1month'">Vorige maand</iaixsl:when>
                                                                      <iaixsl:when test="@desc = '3months'">Laatste 3 maanden</iaixsl:when>
                                                                      <iaixsl:when test="@desc = '6months'">Laatste zes maanden</iaixsl:when>
                                                                      <iaixsl:when test="@desc = '1year'">Vorig jaar</iaixsl:when>
                                                                  </iaixsl:choose>
                                                              </span>
                                                                        ...
                                                                        <div class="btn --icon-right d-block pr-5">
                                                                            <span>
                                                                                <iaixsl:choose>
                                                                                    ...
                                                                                    <iaixsl:otherwise>Andere</iaixsl:otherwise>
                                                                                </iaixsl:choose>
                                                                            </span>
                                                                        </div>
                                                                    </a>
                                          ...
                                          <li class="filters__item mb-2">
                                              <div class="f-group --small --checkbox mb-0">
                                                  ...
                                                  <label for="filter_nextday_form" class="f-label">
                                                      ...
                                                      <span class="--name">De volgende dag<strong>24h</strong>
                                                      </span>
                                                  </label>
                                              </div>
                                          </li>
                                          ...
                                          <li class="filters__item mb-2">
                                              <div class="f-group --small --checkbox mb-0">
                                                  ...
                                                  <label for="filter_sameday_form" class="f-label">
                                                      ...
                                                      <span class="--name">Op dezelfde dag<i class="icon-clock"></i>
                                                      </span>
                                                  </label>
                                              </div>
                                          </li>
                      ...
                      <div class="f-group filters__buttons d-md-none">
                          ...
                          <button type="submit" class="btn --large --solid d-block">
                              <iaixsl:attribute name="title">Klik om de filters van uw keuze toe te passen</iaixsl:attribute>Geselecteerde filters toepassen</button>
                          ...
                          <iaixsl:if test="(/shop/page/products/navigation/filtering/filter/item/@selected='selected') or count(/shop/page/products/navigation/filtering/filter/@selected)">
                              <a class="d-block" href="/settings.php?filter_remove=all">
                                  ...
                                  <iaixsl:attribute name="title">Klik om de lijst met actieve filters te wissen</iaixsl:attribute>Alle filters verwijderen</a>
                          </iaixsl:if>
                      </div>
                  </form>
              </section>
          ...
          <iaixsl:if test="(count(/shop/page/products/navigation/filtering/filter/@selected) &gt; 0) or count(/shop/page/products/navigation/filtering/filter/item/@selected) &gt; 0">
            <div id="filter_list">
              <div class="filter_list_content">
                <a class="remove_all_list_filters btn --outline --secondary mr-2 mr-sm-3" href="/settings.php?filter_remove=all">
                  <iaixsl:if test="/shop/page/products/navigation/search_link/@value">
                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/products/navigation/search_link/@value "/></iaixsl:attribute>
                  </iaixsl:if>
                  <iaixsl:attribute name="title">Alle filters verwijderen</iaixsl:attribute>Filters verwijderen</a>
                <iaixsl:for-each select="/shop/page/products/navigation/filtering/filter[(@type='list') or (@type='text')]">
        ...
        <iaixsl:variable name="next_page">Volgende pagina</iaixsl:variable>
            ...
            <div id="paging_setting_top" class="s_paging">
                <iaixsl:if test="not(/shop/page/products/navigation/@disable_sort_change = 'y')">
                    <form class="s_paging__item --sort" action="/settings.php">
                        ...
                        <select class="s_paging__select --order --small-md" id="select_top_sort" name="sort_order">
                            <option value="name-a" class="option_name-a"><iaixsl:if test="page/products/navigation/@sort = 'name' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op naam in oplopende volgorde</option>
                            <option value="name-d" class="option_name-d"><iaixsl:if test="page/products/navigation/@sort = 'name' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op naam in aflopende volgorde</option>
                            <option value="price-a" class="option_price-a"><iaixsl:if test="page/products/navigation/@sort = 'price' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteer op prijs in oplopende volgorde</option>
                            <option value="price-d" class="option_price-d"><iaixsl:if test="page/products/navigation/@sort = 'price' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op prijs in aflopende volgorde</option>
                            <option value="date-a" class="option_date-a"><iaixsl:if test="page/products/navigation/@sort = 'date' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op datum in oplopende volgorde</option>
                            <option value="date-d" class="option_date-d"><iaixsl:if test="page/products/navigation/@sort = 'date' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sorteren op datum in aflopende volgorde</option>
                        </select>
                    </form>
                </iaixsl:if>
                    ...
                    <form class="s_paging__item --portions d-none d-md-block" action="/settings.php">
                        ...
                        <select class="s_paging__select --portions --small-md" id="select_top_portions" name="portions">
                            <iaixsl:for-each select="page/products/navigation/portions">
                                <option><iaixsl:attribute name="value"><iaixsl:value-of select="@counter"/></iaixsl:attribute><iaixsl:if test="@selected = 'true'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Toon<iaixsl:value-of select="@counter"/>
                                </option>
                            </iaixsl:for-each>
                        </select>
                    </form>
                ...
                <iaixsl:if test="count(/shop/page/products/navigation/filtering/filter)">
                    <div class="s_paging__item --filters d-md-none mb-2 mb-sm-3">
                        <a class="btn --solid --large" href="#menu_filter">Filteren</a>
                    </div>
                </iaixsl:if>
        ...
        <!--Lista produktów (search, 119360.1)-->
			...
			<iaixsl:variable name="var_net_prices_search"/>
			<iaixsl:variable name="var_b2b_search"/>
			
			<iaixsl:variable name="addcompare_txt">+ Toevoegen om te vergelijken</iaixsl:variable>
				...
				<section id="search" class="search products d-flex flex-wrap mb-2 mb-sm-3">
					<iaixsl:for-each select="/shop/page/products/product">
						<div class="product col-6 col-sm-4 col-md-3">
                            ...
                            <iaixsl:if test="sizes/availability/@status = 'disable'"><iaixsl:attribute name="data-status">disable</iaixsl:attribute></iaixsl:if>
                            <iaixsl:attribute name="class">product col-6 col-sm-4 col-md-3<iaixsl:if test="count(versions/version/enclosures/images/enclosure/@icon) &gt; 1"> --versions</iaixsl:if><iaixsl:if test="not(sizes/size/@type='uniw')"> --sizes</iaixsl:if><iaixsl:if test="@distinguished or @bestseller or @new"> --recommended</iaixsl:if></iaixsl:attribute>
                                ...
                                <div class="product__sub__sub">
                                    ...
                                    <div class="product__icon__wrapper">
                                        <a class="product__icon d-flex justify-content-center align-items-center">
                                            ...
                                            <iaixsl:if test="enclosures/images/enclosure/@position=2">
                                                <iaixsl:attribute name="data-enclosure"><iaixsl:value-of select="enclosures/images/enclosure[@position=2]/@medium"/></iaixsl:attribute>
                                            </iaixsl:if>
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                            <iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="name"/></iaixsl:attribute>
                                            ...
                                            <iaixsl:if test="@new or @bestseller or @discount or (@distinguished and not(@bestseller and @discount)) or (sizes/delivery/@shipping = 0.00) or (sizes/delivery/@shipping = 0) or (sizes/delivery/@shipping = '0.00') or (sizes/delivery/@shipping = '0')">
                                                <strong class="label_icons">
                                                    <iaixsl:if test="(sizes/delivery/@shipping = 0.00) or (sizes/delivery/@shipping = 0) or (sizes/delivery/@shipping = '0.00') or (sizes/delivery/@shipping = '0')">
                                                        <span class="label --shipping_free"/>
                                                    </iaixsl:if>
                                                    <iaixsl:if test="@discount">
                                                        <span class="label --discount">Overpriced</span>
                                                    </iaixsl:if>
                                                    
                                                    
                                                </strong>
                                            </iaixsl:if>
                                            <iaixsl:if test="@distinguished or @bestseller or @new">
                                                <div class="label --recommended">
                                                    <iaixsl:if test="@distinguished">
                                    ...
                                    <div class="product__name__wrapper">
                                        ...
                                        <iaixsl:if test="comments/@count &gt; 0">
                                            <div class="product__comments">
                                                <div class="note">
                                                    <span>
                                                        <i class="icon-star">
                                                            <iaixsl:if test="comments/@avg &gt; 0.5"><iaixsl:attribute name="class">icon-star active</iaixsl:attribute></iaixsl:if>
                                                        </i>
                                                        <i class="icon-star">
                                                            <iaixsl:if test="comments/@avg &gt; 1.5"><iaixsl:attribute name="class">icon-star active</iaixsl:attribute></iaixsl:if>
                                                        </i>
                                                        <i class="icon-star">
                                                            <iaixsl:if test="comments/@avg &gt; 2.5"><iaixsl:attribute name="class">icon-star active</iaixsl:attribute></iaixsl:if>
                                                        </i>
                                                        <i class="icon-star">
                                                            <iaixsl:if test="comments/@avg &gt; 3.5"><iaixsl:attribute name="class">icon-star active</iaixsl:attribute></iaixsl:if>
                                                        </i>
                                                        <i class="icon-star">
                                                            <iaixsl:if test="comments/@avg &gt; 4.5"><iaixsl:attribute name="class">icon-star active</iaixsl:attribute></iaixsl:if>
                                                        </i>
                                                    </span>
                                                    <strong><iaixsl:value-of select="comments/@count"/></strong>
                                                </div>
                                            </div>
                                        </iaixsl:if>
                                    ...
                                    <div class="product__prices__wrapper">
                                                    ...
                                                    <iaixsl:choose>
                                                        ...
                                                        <iaixsl:when test="(sizes/prices/@minprice_net = 0) and not(price/@points)">
                                                            <a class="price --phone">
                                                                ...
                                                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/signin/@url"/></iaixsl:attribute>Prijs op de telefoon</a>
                                                        </iaixsl:when>
                                                        <iaixsl:otherwise>
                                                            ...
                                                            <iaixsl:if test="price/@points">
                                                                <span class="price --points"><iaixsl:value-of select="price/@points"/><span class="currency">punt</span></span>
                                                            </iaixsl:if>
                                                        </iaixsl:otherwise>
                                                    </iaixsl:choose>
                                        ...
                                        <div class="product__availability">
                                            <iaixsl:if test="sizes/availability/@status_gfx">
                                                <div class="product__availability__status">
                                                    <img class="product__availability__status__gfx">
                                                        <iaixsl:attribute name="src"><iaixsl:value-of disable-output-escaping="yes" select="sizes/availability/@status_gfx"/></iaixsl:attribute>
                                                    </img>
                                                </div>
                                            </iaixsl:if>
                                            <iaixsl:choose>
                                                <iaixsl:when test="sizes/availability/@status_description and not(sizes/availability/@status_description = '')">
                                                    <div class="tooltip_wrapper">
                                                        <span class="tooltip_icon"><i class="icon-question-1"></i></span>
                                                        <div class="product__availability__status__description tooltipContent"><iaixsl:value-of disable-output-escaping="yes" select="sizes/availability/@status_description"/></div>
                                                    </div>
                                                </iaixsl:when>
                                                <iaixsl:when test="sizes/availability/@status_description_tel and not(sizes/availability/@status_description_tel = '')">
                                                    <div class="tooltip_wrapper">
                                                        <span class="tooltip_icon"><i class="icon-question-1"></i></span>
                                                        <div class="product__availability__status__description tooltipContent"><iaixsl:value-of disable-output-escaping="yes" select="sizes/availability/@status_description_tel"/></div>
                                                    </div>
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="@id = /shop/compare/product/@id">
                                                    <a class="product__compare_item --remove btn" rel="nofollow">
                                                        ...
                                                        <iaixsl:attribute name="title">Klik om een product uit de vergelijkingsmotor te verwijderen</iaixsl:attribute>- Verwijderen uit vergelijking</a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="product__compare_item --add btn" rel="nofollow">
                                                        ...
                                                        <iaixsl:attribute name="title">Klik om het product aan de vergelijking toe te voegen</iaixsl:attribute>
                                    ...
                                    <iaixsl:if test="count(versions/version/enclosures/images/enclosure/@icon) &gt; 1">
                                        <div class="product__versions">
                                            <iaixsl:for-each select="versions/version">
                                                <a class="product__version">
                                                    <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>                                                
                                                    <iaixsl:if test="enclosures/images/enclosure[@position='1']/@medium">
                                                        <iaixsl:attribute name="data-hover"><iaixsl:value-of select="enclosures/images/enclosure[@position='1']/@medium"/></iaixsl:attribute>
                                                    </iaixsl:if>
                                                    <img>
                                                        <iaixsl:attribute name="src"><iaixsl:value-of select="enclosures/images/enclosure/@icon"/></iaixsl:attribute>
                                                        <iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                                                    </img>
                                                </a>
                                            </iaixsl:for-each>
			...
			<iaixsl:if test="/shop/comments"> </iaixsl:if>
			<iaixsl:if test="/shop/page/products/product/comments"> </iaixsl:if>
        ...
        <iaixsl:variable name="next_page_bottom">Volgende pagina</iaixsl:variable>
        ...
        <iaixsl:if test="not(page/products/@hideproducts = 'true')">
            <div id="paging_setting_bottom" class="s_paging">
                ...
                <iaixsl:if test="count(page/products/navigation/item) &gt; 1">
                    <ul class="s_paging__item pagination mb-2 mb-sm-5">
        ...
        <iaixsl:if test="/shop/page/products/additional/hotspot/products_zone1/@name"> </iaixsl:if>
            ...
            <iaixsl:if test="not(action/set_render/item) or (action/set_render/item/@name = 'footer')">
                <footer>
                    <iaixsl:attribute name="class"/>
                    <!--Menu hotspot w search strefa 1 (menu_search_hotspot1_bis, 116502.1)-->
                ...
                <iaixsl:if test="page/products/additional/hotspot/products_zone1">
                    ...
                    <section id="search_hotspot_zone1" class="hotspot mb-5 container">
                        ...
                        <iaixsl:variable name="headline_after_search_hotspot_zone1">Bekijk alle</iaixsl:variable>
                        ...
                        <iaixsl:choose>
                            ...
                            <div class="products d-flex flex-wrap">
                                <iaixsl:for-each select="page/products/additional/hotspot/products_zone1/*">
                                    ...
                                    <div class="product col-6 col-sm-2 py-3">
            ...
            <iaixsl:if test="not(page/products/additional/category_list/description = '') and (page/products/additional/category_list/description) and count(/shop/page/products/navigation/filtering/filter[@selected]) = 0">
                <iaixsl:if test="(/shop/page/products/@hideproducts = 'true' ) or ((/shop/page/products/navigation/item[1]/@counter =1) and (/shop/page/products/navigation/item[1]/@type ='current'))">
                     <div class="search_categoriesdescription_sub container">
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/search_filters.js.gzip?r=1685223127</iaixsl:attribute></script>
            <script>
                app_shop.runApp();
            </script>
