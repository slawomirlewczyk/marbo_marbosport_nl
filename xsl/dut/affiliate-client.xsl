...
<iaixsl:attribute name="class">big_label affiliate_client_label</iaixsl:attribute>
    <span class="affiliate_client_label">klantenorders<iaixsl:value-of select="page/client/@id"/>
    </span>
</div>
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_client</iaixsl:attribute>
            <thead>
                <tr>
                    ...
                    <th id="affiliate_client_th2">datum van bestelling</th>
                    <th id="affiliate_client_th3">datum van verzending</th>
                    <th id="affiliate_client_th4">contractwaarde</th>
                    <th id="affiliate_client_th5">aantal producten</th>
                    <th id="affiliate_client_th6">betaling</th>
                    <th id="affiliate_client_th7">status</th>
                    <th id="affiliate_client_th8">partner</th>
                    <th id="affiliate_client_th9">commissie</th>
                </tr>
            </thead>
            <tbody>
