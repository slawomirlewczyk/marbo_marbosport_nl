...
<iaixsl:if test="/shop/client_data/@phone and /shop/client_data/@phone = '' and @id = 4"><iaixsl:attribute name="class">return_type choose_return_type disabled_inpost</iaixsl:attribute></iaixsl:if>
                                        ...
                                        <iaixsl:if test="$n69372_p_txt and  shipping/delivery">
                                            ...
                                            <iaixsl:if test="$n69372_shipping_title and  /shop/page/return_methods/@shipping_balanced_refund = 'true'">
                                                <div class="n69372_shipping_balance">
                                                    <strong>Gratis verzending naar de winkel</strong>
                                                    <div>Bij het kiezen van<b>terugstorting van fondsen op het saldo van de klant.</b><br/>Voor de gekozen vorm van klacht.</div>
                                                </div>
                                            </iaixsl:if>
                                            ...
                                            <div class="return_methods_label">
                                                ...
                                                <span class="return_methods_labe2">Kosten</span>
                                            </div>
                                            ...
                                            <div class="return_methods_info">In de volgende stap selecteert u de vorm van de klacht.</div>
                                        </iaixsl:if>
                                    </div>
                                                ...
                                                <div class="order1_delitem_header">
                                                    ...
                                                    <span class="order1_delitem_name">
                                                        ...
                                                        <div class="order1_delitem_time">
                                                            ...
                                                            <span class="order1_delitem_time">Levertijd:<iaixsl:choose>
                                                            ...
                                                            <iaixsl:otherwise>
                                                                ...
                                                                <span class="order1_delitem_price">
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:otherwise>
                                                                            <iaixsl:attribute name="class">order1_delitem_price order1_delitem_price_free</iaixsl:attribute>Gratis verzending naar de winkel</iaixsl:otherwise>
                                                                    </iaixsl:choose>
                                                                </span>
                                                            </iaixsl:otherwise>
                                                        </iaixsl:choose>
                    ...
                    <div class="returns_summary_buttons table_display">
                        ...
                        <div class="btn_wrapper">
                            ...
                            <button id="return_go_next" type="submit" class="n53706_button1 btn --solid --large --icon-right icon-angle-right">Ga verder.</button>
