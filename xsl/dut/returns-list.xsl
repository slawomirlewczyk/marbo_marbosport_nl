...
<div class="client_order">
    <h1 class="big_label">
        <span>Lijst van uw aangiften</span>
    </h1>
    <iaixsl:choose>
        <iaixsl:when test="/shop/page/returns/item">
            <table class="orders" cellspacing="0" cellpadding="0">
                ...
                <thead>
                    <tr id="orders_header">
                        <td class="ord3" id="orders_head_1">retour id</td>
                        <td class="ord3" id="orders_head_2">datum van terugkeer</td>
                        <td class="ord3" id="orders_head_3">terug te sturen</td>
                    ...
                    <iaixsl:for-each select="/shop/page/returns/item">
                        <tr>
                            ...
                            <td>
                             ...
                             <td class="ord">
                                <a class="orders_more"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>meer...</a>
                            </td>
                        </tr>
                    </iaixsl:for-each>
                </tbody>
        ...
        <iaixsl:otherwise>
            <div class="return_list_noitem menu_messages_message" id="return_list_noitem">Er is nog geen rendement toegevoegd.</div>
        </iaixsl:otherwise>
    </iaixsl:choose>
</div>
