...
<iaixsl:attribute name="class">products_requests_cms_label big_label</iaixsl:attribute>
            <span class="products_requests_cms_label">Hoe werkt productrapportage?</span>
        </div>
...
<iaixsl:attribute name="class">products_requests_cms_label  big_label</iaixsl:attribute>
            ...
            <span class="products_requests_list_label">Lijst van gezochte producten</span>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="products_requests_list_info2">
                            <div class="products_requests_list_date">
                                <span class="products_requests_list_date_title">Datum aanvraag:</span>
                            ...
                            <a class="products_requests_list_remlink">
                                ...
                                <iaixsl:attribute name="title">Klik om de melding voor dit product te verwijderen.</iaixsl:attribute>verwijderen uit de lijst</a>
                        </td>
                    </tr>
                </iaixsl:for-each>
            </table>
            <div class="products_requests_add">Om een nieuw product aan de zoeklijst toe te voegen, gebruikt u de knop<a class="products_requests_add">
                    <iaixsl:attribute name="href"><iaixsl:value-of select="page/action/noproduct/@url"/></iaixsl:attribute>
                    <iaixsl:attribute name="title">Product suggestie formulier</iaixsl:attribute>formulier voor productsuggesties</a>.
            </div>
        </div>    
