    ...
    <!--Rabaty klienta - informacje (client_rebates_info, 107782.1)-->
        ...
        <div id="client_rebates_info" class="n58425">
                ...
                <div class="form-code-card">
                    <iaixsl:if test="not(page/rebates_codes/@active = 'y')">
                        <h2 class="big_label">
                            <iaixsl:choose>
                                ...
                                <iaixsl:otherwise>Voer uw kortingscode of kaartnummer in</iaixsl:otherwise>
                            </iaixsl:choose>
                        </h2>
                    </iaixsl:if>
                    ...
                    <iaixsl:variable name="cardform">
                        <form class="rabat-code form-group" action="settings.php?from=client_rebate" method="post">
                            ...
                            <div class="has-feedback">
                                ...
                                <label class="control-label">Kortingskaartnummer</label>
                            </div>
                            <button class="btn --large --solid" type="submit" value="">Activeren</button>
                        </form>
                    </iaixsl:variable>
                    <iaixsl:variable name="codform">
                        <form class="rabat-card form-group" action="settings.php?from=client_rebate" method="post">
                            ...
                            <div class="has-feedback">
                                ...
                                <label class="control-label">Kortingscode nummer</label>
                            </div>
                            <button class="btn --large --solid" type="submit" value="">Activeren</button>
                        </form>
                    </iaixsl:variable>
                                ...
                                <div class="col-sm-6 col-12">
                                    ...
                                    <iaixsl:if test="/shop/rebate_card_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_card_delete_rebate_for_profit_points/@active = 'y' ">
                                        <div class="form-code-carsub_info">
                                            <span class="icon-stack"><i class="icon-sign-blank"></i><i class="icon-question icon-light"></i></span>Het activeren van de kortingskaart heeft tot gevolg dat de korting die aan uw account is toegewezen, op deze bestelling wordt genegeerd.</div>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:if>
                        </iaixsl:if>
                            ...
                            <iaixsl:if test="not(page/rebate_code/@type='rebate')">
                                <div class="col-sm-6 col-12">
                                    ...
                                    <iaixsl:if test="/shop/rebate_code_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_code_delete_rebate_for_profit_points/@active = 'y' ">
                                        <div class="form-code-carsub_info">
                                            <span class="icon-stack"><i class="icon-sign-blank"></i><i class="icon-question icon-light"></i></span>Als u de kortingscode activeert, wordt de aan uw account toegewezen korting op deze bestelling genegeerd.</div>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:if>
                        </iaixsl:if>
                    ...
                    <iaixsl:if test="page/rebate_code/@type='rebate'">
                        <div class="active-code-wrapper">
                            <h2 class="big_label">Kortingscode ingevoerd voor deze bestelling</h2>
                            <div class="active-code n67313_out">
                                <div class="code-name">
                                    <i class="icon-tags"></i>
                                    <span>Actieve code:<strong><iaixsl:value-of disable-output-escaping="yes" select="page/rebate_code/@number"/></strong>
                                    </span>
                                    ...
                                    <ul class="code-details">
                                        <iaixsl:if test="page/rebate_code/@min_order &gt; 0">
                                            <li>
                                                ...
                                                <iaixsl:variable name="minProdVal"><iaixsl:value-of select="page/rebate_code/@min_order"/></iaixsl:variable>Vereiste waarde van de producten in het mandje:<strong><iaixsl:value-of disable-output-escaping="yes" select="format-number($minProdVal, '#')"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="/shop/currency/@name"/></strong>
                                            </li>
                                        </iaixsl:if>
                                        ...
                                        <iaixsl:if test="page/rebate_code/@expires">
                                            <li>Geldig tot:<strong><iaixsl:value-of disable-output-escaping="yes" select="page/rebate_code/@expires"/></strong>
                                            </li>
                                        </iaixsl:if>
                                        <iaixsl:choose>
                                        ...
                                        <iaixsl:if test="page/rebate_code/inactive_zones/item">
                                            <li>De korting geldt niet voor producten gemarkeerd als:<iaixsl:for-each select="page/rebate_code/inactive_zones/item">
                                ...
                                <div class="rabate-button">
                                    <a class="btn --solid" id="n67313_a_change_code" href="#">Verander de code</a>
                                    <a class="btn --solid --secondary" id="n67313_a_remove_code">
                                        <iaixsl:attribute name="href">/settings.php?from=client_rebate&amp;global_rebates_codes=add&amp;rebates_codes=+"</iaixsl:attribute>Deactiveer</a>
                                </div>
                            </div>
                        </div>
                    </iaixsl:if>
                    ...
                    <iaixsl:if test="page/rebate_code/@type='card_discount'">
                        <div class="active-code-wrapper">
                            <h2 class="big_label">Actieve kortingskaart</h2>
                            <iaixsl:for-each select="/shop/page/discount_cards/item[@number = /shop/page/rebate_code[@type='card_discount']/@number]">
                                <div class="active-code n67313_out">
                                    ...
                                    <div class="code-info">
                                        <ul class="code-details">
                                            <li>Kaart nr:<strong><iaixsl:value-of select="@number"/></strong>
                                            </li>
                                            ...
                                            <iaixsl:if test="page/rebate_code/@min_order &gt; 0">
                                                <li>Vereiste waarde van de producten in het mandje:<strong><iaixsl:value-of disable-output-escaping="yes" select="format-number(page/rebate_code/@min_order, '#')"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="/shop/currency/@name"/></strong>
                                                </li>
                                            </iaixsl:if>
                                    ...
                                    <div class="rabate-button">
                                        <a class="btn --solid" id="n67313_a_change_cart" href="#">Verander de code</a>
                                    </div>
                                </div>
                            </iaixsl:for-each>
                        </div>
                    ...
                    <iaixsl:if test="/shop/page/discount_cards/item[not(@number = /shop/page/rebate_code/@number)]">
                        <div class="active-code-wrapper">
                            <h2 class="big_label">Inactieve kortingskaarten</h2>
                                        ...
                                        <div class="active-code n67313_out">
                                            ...
                                            <div class="code-info">
                                                <ul class="code-details">
                                                    <iaixsl:if test="@number">
                                                        ...
                                                        <li>
                                                            <span>Geldig tot:<iaixsl:value-of select="@expires"/>
                                                            </span>
                                                        </li>
                                                    </iaixsl:if>
                                                </ul>
                                            ...
                                            <div class="rabate-form">
                                                <form class="rabat-code" action="settings.php?from=client_rebate" method="post">
                                                    ...
                                                    <button class="btn --solid" type="submit" value="">Activeren</button>
                                                </form>
                                            </div>
                                        </div>
                                    </iaixsl:if>
                    ...
                    <iaixsl:if test="/shop/page/cards/item">
                        <div class="active-code-wrapper">
                            <h2 class="big_label">Loyaliteitskaarten</h2>
                            <div class="active-code-subwrapper">
                                <iaixsl:for-each select="/shop/page/cards/item">
                                    <div class="active-code n67313_out">
                                        <div class="code-name">
                                            <i class="icon-credit-card"></i>
                                            <span>
                                                <strong><iaixsl:value-of disable-output-escaping="yes" select="@name"/></strong>Geldig tot:<iaixsl:value-of select="@expires"/>
                                            </span>
                                        </div>
                                        <div class="code-info">
                                            <ul class="code-details">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="@active = 'y'">
                                                    <b class="card-status-active">
                                                        <i class="icon-ok-sign"></i>actief</b>
                                                </iaixsl:when>
                                                <iaixsl:when test="@active = 'n'">
                                                    <b class="card-status-inactive">
                                                        <i class="icon-remove-sign"></i>inactief</b>
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                        </div>
                                    </div>
            ...
            <iaixsl:if test="page/rebates/range_rebate/range and not(/shop/page/basket_rebate/range)">
                <div class="n67313_out">
                    <div class="n67313_label_b">
                        <span class="n67313_label_l">Drempelwaarde korting</span>
                        <div class="n67313_label_r">In rekening gebracht op de waarde van de producten in het mandje.<iaixsl:choose>
                                ...
                                <iaixsl:otherwise>De korting telt niet op bij andere kortingen.</iaixsl:otherwise>
                            </iaixsl:choose>
                        </div>
                    </div>
                    <div class="n67313_border">
                        <div class="n67313_rebate_l">Bestelbedrag boven<span class="n67313_label_r">Bedrag van de korting</span>
                            <iaixsl:if test="page/basket_rebate/range/@points != '0.00'">
                                <span class="n67313_label_r">Puntenbonus</span>
                            </iaixsl:if>
                        </div>
            ...
            <iaixsl:if test="page/global_rebate">
                <div class="n67313_out">
                    <div class="n67313_label_b">
                        <span class="n67313_label_l">Cumulatieve korting</span>
                        <div class="n67313_label_r">
                            <iaixsl:choose>
                                ...
                                <iaixsl:otherwise>In rekening gebracht op de waarde van eerder gekochte producten<br/>
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                            <iaixsl:choose>
            ...
            <iaixsl:choose>
                <iaixsl:when test="page/rebates/@type = 'r'">
                    ...
                    <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
                        <div class="n67313_out">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">Algemene korting</span>
                            </div>
                            <div class="n67313_border">
                                <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
                                    <div class="n67313_rebate_l">Voor het hele assortiment</div>
                                    <div class="n67313_rebate_info">
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rebates/other/@combined='y'">
                                                <div class="n67313_other_info">De korting wordt opgeteld bij de andere kortingen.</div>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                <div class="n67313_other_info">De korting telt niet op bij andere kortingen.</div>
                                            </iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </div>
                                </iaixsl:if>
                ...
                <iaixsl:when test="(page/rebates/@type = 'z') and ((page/rebates/category) or (page/rebates/producer) or (page/rebates/series))">
                    <div class="n67313_out">
                        <iaixsl:if test="(page/rebates/category) or (page/rebates/producer) or (page/rebates/series)">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">Groepskorting</span>
                                <div class="n67313_label_r">Groepskortingen tellen niet op. Bij overlappende kortingen wordt de hoogste waarde in aanmerking genomen.</div>
                            </div>
                        </iaixsl:if>
                        <div class="n67313_border">
                    ...
                    <iaixsl:if test="page/rebates/product">
                        <div class="n67313_out">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">Specifieke korting</span>
                                <iaixsl:choose>
                                    <iaixsl:when test="((page/rebates/category) or (page/rebates/producer) or (page/rebates/series)) and ((page/rebates/other) and not(page/rebates/other/@value = '0.00'))">
                                        <div class="n67313_label_r">De specifieke korting heeft voorrang op de algemene korting en de groepskorting.</div>
                                    </iaixsl:when>
                                    <iaixsl:when test="((page/rebates/category) or (page/rebates/producer) or (page/rebates/series)) and not((page/rebates/other) and not(page/rebates/other/@value = '0.00'))">
                                        <div class="n67313_label_r">De specifieke korting heeft voorrang op de groepskorting.</div>
                                    </iaixsl:when>
                                    <iaixsl:when test="((page/rebates/other) and not(page/rebates/other/@value = '0.00')) and not(page/rebates/category) and not(page/rebates/producer) and not(page/rebates/series)">
                                        <div class="n67313_label_r">De specifieke korting heeft voorrang op de algemene korting.</div>
                                    </iaixsl:when>
                                </iaixsl:choose>
                            </div>
                            <div class="n67313_border">
                                <div class="n67313_rebate_l">Voor geselecteerde producten</div>
                                ...
                                <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
                                    <div class="n67313_rebate_l">
                                        <iaixsl:choose>
                                            ...
                                            <iaixsl:otherwise>Voor andere producten</iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </div>
                                    <div class="n67313_rebate_info">
                                        <span class="n67313_other_value">
                ...
                <iaixsl:when test="(page/rebates/@type = 'p' or page/rebates/@type = 'z' or page/rebates/@type = 'b') and (page/rebates/other/@value = '0.00') and (page/rebates/global/@value = '0.00') and (page/rebates_codes/@active = 'n')">
                    <div class="menu_messages_message">Je hebt momenteel geen korting. Wij nodigen u uit een kijkje te nemen bij<a href="/terms.php">voorwaarden en kortingsdrempels</a>in onze winkel.</div>
                </iaixsl:when>
                <iaixsl:otherwise>
                    <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
                        <div class="n67313_out">
                            <div class="n67313_label_b">Algemene korting<div class="n67313_label_r">
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rebates/other/@combined='y'">
                                            Rabat jest sumowany z pozostałymi rabatami.
                                        </iaixsl:when>
            ...
            <iaixsl:if test="page/rebate_code/@active = 'y' or page/rebates_for_points/rebate">
                <div class="n67313_label">
                    ...
                    <span class="n67313_label">Uw individuele kortingen</span>
                </div>
                
                <div class="n67313_out">

                    <iaixsl:if test="page/rebate_code/inactive_zones/item">
                        <div class="n67313_label_b">De korting geldt niet voor producten gemarkeerd als:<iaixsl:for-each select="page/rebate_code/inactive_zones/item">
                                <strong><iaixsl:value-of disable-output-escaping="yes" select="@description"/></strong><iaixsl:if test="position() != last()">, </iaixsl:if>
                            </iaixsl:for-each>
                        </div>
                    </iaixsl:if>
                    <iaixsl:if test="page/rebates_for_points/rebate">
                        ...
                        <div class="n67313_rebate_l">Punten inwisselen voor korting</div>
                    ...
                    <iaixsl:if test="page/rebate_code/@active = 'y'">
                        <div class="n67313_border">
                            ...
                            <iaixsl:if test="page/rebate_code/other_products_rebate/@active = 'y'">
                                <div class="n67313_rebate_l">Korting voor andere producten</div>
                                <div class="n67313_rebate_info">
                                    <span class="n67313_other_value">
                                        <iaixsl:choose>
                            ...
                            <iaixsl:if test="page/rebate_code/shipping_cost_rebate/@active = 'y'">
                                <div class="n67313_rebate_l">Korting voor verzendkosten</div>
                                <div class="n67313_rebate_info">
                                    <span class="n67313_other_value">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rebate_code/shipping_cost_rebate/@price_type='net'">
                                            <div class="n67313_other_info">De korting voor verzendkosten wordt berekend over de nettoprijs.</div>
                                        </iaixsl:when>
                                    </iaixsl:choose>
                                </div>
                            </iaixsl:if>
                            ...
                            <iaixsl:if test="page/rebate_code/gratis/@active = 'y'">
                                <div class="n67313_gratis_out">
                                    <div class="n67313_rebate_l_w">Cadeau op bestelling</div>
                                    <table class="clients_rebates"><iaixsl:for-each select="page/rebate_code/gratis/item"><iaixsl:if test="(position()-1) mod 2 = 0"><iaixsl:text disable-output-escaping="yes">&lt;tr&gt;</iaixsl:text></iaixsl:if><td style="width:50%;" class="clients_rebates">
                                            <div class="clients_rebates_wrapper">
                                                ...
                                                <span class="n67313_other_value">Gratis!</span>
                                            </div>
                                            </td><iaixsl:if test="(position()-1) mod 2 = (2 - 1) or position()=last()"><iaixsl:text disable-output-escaping="yes">&lt;/tr&gt;</iaixsl:text></iaixsl:if></iaixsl:for-each></table>
                                </div>
                            </iaixsl:if>
