...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <iaixsl:variable name="order_edit_button">Wijzigingsopdracht</iaixsl:variable>
        <iaixsl:variable name="hours_68242">uur</iaixsl:variable>
        <iaixsl:variable name="immediately_txt">De bestelling is direct na ontvangst klaar voor afhaling.</iaixsl:variable>
        <iaixsl:variable name="n68313_order2_document_invoice">Account</iaixsl:variable>
        <iaixsl:variable name="n68313_order2_document_e_invoice">Elektronische factuur</iaixsl:variable>
        ...
        <div class="n57856_order_overtaker">
            <form class="order2_form">
                ...
                <div class="big_label order2_info_label">
                    <span class="n57856_label" id="labels">Verificatie van de gegevens:</span>
                </div>

                <div class="order2_info">
                    <div class="order2_info_sub" id="order2_info_sub1">
                        <div class="order2_info_label_sub">
                            <h3 class="order2_info1" id="order2_nagl_1">Gegevens van de besteller:</h3>
                            <a class="order2_button_change_mobile d-sm-none">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/orderclient/@changelink"/></iaixsl:attribute>Bewerk</a>
                        </div>
                        ...
                        <div class="order2_info1" id="order2_box_1">
                            <div class="order2_info1_sub">
                                ...
                                <iaixsl:if test="page/order2/orderclient/@nip">NIP:<iaixsl:value-of select="page/order2/orderclient/@nip"/><br/>
                                </iaixsl:if>
                                <iaixsl:if test="(page/order2/orderclient/@phone1) and not(page/order2/orderclient/@phone1 = '')">Telefoon:<iaixsl:value-of select="page/order2/orderclient/@phone1"/><br/>
                                </iaixsl:if>
                                <iaixsl:if test="(page/order2/orderclient/@email) and not(page/order2/orderclient/@email = '')">e-mail:<iaixsl:value-of select="page/order2/orderclient/@email"/><br/>
                                </iaixsl:if>

                            </div>
                            <a class="order2_button_change d-none d-sm-inline-block btn --solid">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/orderclient/@changelink"/></iaixsl:attribute>Klantgegevens wijzigen</a>
                    ...
                    <div class="order2_info_sub" id="order2_info_sub2">
                        <iaixsl:choose>
                            <iaixsl:when test="page/order2/stock">
                                ...
                                <div class="order2_info_label_sub">
                                    <h3 class="order2_info1" id="order2_nagl_2a">Verzamelpunt voor bestellingen:</h3>
                                    <iaixsl:if test="/shop/page/order2/stock/@other_stocks='true'">
                                        <a class="order2_button_change_stock_mobile d-sm-none">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/stock/@change_link"/></iaixsl:attribute>Bewerk</a>
                                    </iaixsl:if>
                                </div>
                                    ...
                                    <iaixsl:if test="not(/shop/page/order2/stock/@link = '')">
                                        <div class="order2_moreinfo">
                                            <a class="order2_stock_moreinfo btn --solid" target="_blank">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/stock/@link"/></iaixsl:attribute>Meer informatie</a>
                                        </div>
                                    </iaixsl:if>
                                    <iaixsl:if test="/shop/page/order2/stock/@other_stocks='true'">
                                        <a class="order2_button_change_stock d-none d-sm-inline-block btn --solid">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/stock/@change_link"/></iaixsl:attribute>Het verzamelpunt wijzigen</a>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <div class="order2_info_label_sub">
                                    <h3 class="order2_info1" id="order2_nagl_2b">Leveringsadres:</h3>
                                    <a class="order2_button_change_address_mobile d-sm-none">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/deliveryaddress/@changelink"/></iaixsl:attribute>Bewerk</a>
                                </div>
                                <div class="order2_info1" id="order2_box_2b">
                                    <div class="order2_info1_sub">
                                        ...
                                        <iaixsl:if test="page/order2/deliveryaddress/@phone and page/order2/deliveryaddress/@phone != ''">Telefoon:<iaixsl:value-of select="page/order2/deliveryaddress/@phone"/><br/>
                                        </iaixsl:if>

                                    </div>
                                    <a class="order2_button_change_address d-none d-sm-inline-block btn --solid">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/deliveryaddress/@changelink"/></iaixsl:attribute>Het leveringspunt wijzigen</a>
                                </div>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    ...
                    <div class="order2_info_sub" id="order2_info_sub3">
                        <div class="order2_info_label_sub">
                            <h3 class="order2_info1" id="order2_nagl_1">Gegevens van de ontvanger:</h3>
                        ...
                        <div class="order2_info1" id="order2_box_3">
                            ...
                            <a class="order2_button_change2 d-none d-sm-inline-block btn --solid">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/orderclient/@changelink"/></iaixsl:attribute>Gegevens van de ontvanger wijzigen</a>
                ...
                <div class="order2_info">
                    ...
                    <div id="order2_info_sub4">
                        <strong>Ik wil graag ontvangen:</strong>
                        <div class="order2_info1" id="order2_box_4">
                            <div class="order2_info1_sub">
                                ...
                                <label for="order2_document_confirmation">
                                    ...
                                    </input>Bevestiging van aankoop</label>
                                ...
                                <iaixsl:if test="page/order2/orderinvoice/@e_invoice='true' and $n68313_order2_document_e_invoice">
                                    <label for="order2_document_e_invoice">
                                        ...
                                        </input>Elektronische factuur</label>
                                    <div id="e-invoice_dialog">
                                        <span class="big_label">Elektronische levering van facturen</span>
                                        <div>
                                            <span class="e-invoice_dialog"><font>Het milieu beschermen</font>en de ontvangst van de factuur bespoedigen</span>
                                            <p>Met het oog op het milieu en uw gemak bieden wij u de mogelijkheid te kiezen voor elektronische factuurverzending. Nu kunt u uw facturen snel en veilig in uw mailbox ontvangen. Elektronische levering van facturen is het digitale equivalent van een papieren factuur. Het bevat precies dezelfde gegevens en heeft dezelfde juridische waarde als een traditioneel papieren document. Het gebruik van een elektronisch verzonden factuur is gratis.</p>
                                            <button class="btn --solid --medium">Ja, ik wil de factuur elektronisch ontvangen</button>
                                        </div>
                                    </div>
                                </iaixsl:if>
                                ...
                                <label for="order2_document_invoice">
                                    ...
                                    <iaixsl:choose>
                                        ...
                                        <iaixsl:otherwise>Gedrukte factuur</iaixsl:otherwise>
                                    </iaixsl:choose>
                                </label>
                ...
                <div class="order2_info_sub">
                    <h3 class="order2_info1">Aanvullende informatie:</h3>
                    <div class="order2_info1" id="order2_box_7">
                        <div class="order2_info1_sub">
                            ...
                            <div class="basketedit_summary_shipment_time">
                                ...
                                <iaixsl:if test="/shop/basket/delivery_time/@days and not(basket/@shipping_undefined = 'true')">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="(/shop/page/order2/orderdetails/@deliveryid = '0-0') or (/shop/page/order2/orderdetails/@deliveryid = '0-1')">
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:otherwise>Uw bestelling ophalen</iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </iaixsl:when>
                                        <iaixsl:when test="$wys_1_68242  and (/shop/basket/delivery_time/@week_amount)  and  (/shop/basket/delivery_time/@week_amount = 0) and (/shop/basket/delivery_time/@hours = 0) and (/shop/basket/delivery_time/@minutes = 0)">Het pakje moet bij u zijn</iaixsl:when>
                                        <iaixsl:when test="/shop/page/order2/orderremarks/@select_date and (/shop/page/order2/orderremarks/@select_date != '')">De zending wordt geleverd op</iaixsl:when>
                                        <iaixsl:otherwise>De levering zal bij u thuis zijn</iaixsl:otherwise>
                                    </iaixsl:choose>
                                    ...
                                    <iaixsl:choose>
                                        ...
                                        <iaixsl:otherwise>
                                            <iaixsl:if test="/shop/basket/delivery_time/@days &gt; 0">tijdens<iaixsl:value-of select="/shop/basket/delivery_time/@days"/>
                                                <iaixsl:choose>
                                                    <iaixsl:when test="/shop/basket/delivery_time/@days ='1'">
                                                        <iaixsl:choose><iaixsl:when test="(/shop/page/order2/orderdetails/@deliveryid = '0-0') or (/shop/page/order2/orderdetails/@deliveryid = '0-1')"/><iaixsl:otherwise>op</iaixsl:otherwise></iaixsl:choose>
                                                    </iaixsl:when>
                            ...
                            <iaixsl:if test="(page/order2/orderdetails/points/@debit) and (page/order2/orderdetails/points/@debit &gt; 0)">
                                <div class="basketedit_summary_debit">Na betaling van deze bestelling krijgt u<iaixsl:value-of select="page/order2/orderdetails/points/@debit"/><span>punt</span>in het loyaliteitsprogramma.</div>
                            </iaixsl:if>
                            ...
                            <iaixsl:if test="/shop/client_data/client_balance/limit/@value &gt; '0'">
                                <div class="basketedit_limit_section">
                                    <div class="basketedit_product_summary">
                                        <label>Beschikbare schuldlimiet:</label>
                ...
                <div class="order2_info comment_container clearfix">
                    ...
                    <a href="#toggleComments" id="toggle_comments_button" class="d-sm-none">Opmerkingen voor de winkel en de koerier</a>

                    <div class="order2_info_sub order_comments">
                        <h3 class="order2_info1">Opmerkingen voor de winkel:</h3>
                    ...
                    <div class="order2_info_sub">
                        <h3 class="order2_info1">Opmerkingen voor de koerier:</h3>
                        ...
                        <div class="basketedit_summary_sub">
                            ...
                            <iaixsl:if test="not(page/order2/ordersproducts/product/@product_type)">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">Bestelde producten</th>
                                            <th class="order2_price" data-mobile-class="hide">Prijs per eenheid</th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                                            <th class="order2_vat">BTW</th></iaixsl:if>
                                            <th class="order2_quantity">Hoeveelheid</th>
                                            <th class="order2_worth">Waarde</th>
                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="order2_name">
                                                    ...
                                                    <iaixsl:if test="not(@size = '') and (@size != 'uniw')">
                                                        <div class="order2_size_desc">Maat:<iaixsl:value-of select="@size_desc"/>
                                                        </div>
                                                    </iaixsl:if>
                                                    ...
                                                    <iaixsl:if test="@product_type = 'product_bundle'">
                                                        <div class="productslist_product_bundle">Kit onderdelen:<iaixsl:for-each select="bundled/product">
                                                                <span>
                                                                    ...
                                                                    <iaixsl:if test="@product_type = 'product_virtual'">
                                                                        <i class="product_virtual">Virtueel product</i>
                                                                    </iaixsl:if>
                                                    ...
                                                    <iaixsl:if test="order_files/file">
                                                        <div class="order2_productlist_files">
                                                            <span class="n53330_projectorlink">De bestanden die je hebt toegevoegd:</span>
                                                ...
                                                <td class="order2_price" data-mobile-class="hide">
                                                    <iaixsl:if test="@forpoints">
                                                        <iaixsl:value-of select="@points_for_one"/>punt</iaixsl:if>
                                                ...
                                                <td class="order2_bruttoworth">
                                                    ...
                                                    <iaixsl:choose>
                                                        ...
                                                        <iaixsl:when test="@forpoints">
                                                            ...
                                                            <iaixsl:value-of select="@points"/>punt</iaixsl:when>
                                                    </iaixsl:choose>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <div class="order2_comment">
                                                            <span class="comment_label">Uw getypte opmerkingen over dit product:</span>
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product[@product_type = 'product_virtual']">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">Besteld<span class="product_virtual">virtuele producten</span>
                                            </th>
                                            <th class="order2_price" data-mobile-class="hide">Prijs per eenheid</th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                                            <th class="order2_vat">BTW</th></iaixsl:if>
                                            <th class="order2_quantity">Hoeveelheid</th>
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product[@product_type = 'product_service']">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">Besteld<span class="product_virtual">services</span>
                                            </th>
                                            <th class="order2_price" data-mobile-class="hide">Prijs per eenheid</th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                                            <th class="order2_vat">BTW</th></iaixsl:if>
                                            <th class="order2_quantity">Hoeveelheid</th>
                            ...
                            <iaixsl:if test="page/wrappers/wrapper">
                                <div class="order2_products">
                                    ...
                                    <table class="order2_table">
                                        <tr>
                                            <th class="order2_name">Geselecteerde verpakkingen:</th>
                                    ...
                                    <table class="order2_table">
                                        <tr>
                                            <th class="order2_name">
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="/shop/page/order2/insurance_product">Levering, betaling en verzekering</iaixsl:when>
                                                    <iaixsl:otherwise>Levering en betaling:</iaixsl:otherwise>
                                                </iaixsl:choose>
                                        ...
                                        <tr>
                                            <td class="order2_name">
                                                ...
                                                <span class="order2_name">Vorm van levering:<iaixsl:value-of select="page/order2/orderdetails/@deliveryname"/>
                                                    <a class="order2_change_delivery_link" href="order1.php">verandering</a></span>
                                        ...
                                        <iaixsl:if test="not(page/order2/orderdetails/@deliverytype = 'prepaid' and page/order2/orderdetails/@payment_name = '') or (page/order2/orderdetails/@tradeCredit = 'y')">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name"><iaixsl:choose><iaixsl:when test="page/order2/orderdetails/voucher/@value">Vorm van betaling:<iaixsl:value-of select="page/order2/orderdetails/@payment_name"/></iaixsl:when><iaixsl:when test="(page/order2/orderdetails/@deliverytype = 'prepaid') and (page/order2/orderdetails/@tradeCredit = 'y')">Forma płatności: kredyt kupiecki</iaixsl:when><iaixsl:when test="page/order2/orderdetails/@deliverytype = 'prepaid'">Vorm van betaling:<iaixsl:value-of select="page/order2/orderdetails/@payment_name"/></iaixsl:when><iaixsl:when test="page/order2/orderdetails/@deliverytype = 'dvp'">Vorm van betaling:</iaixsl:when></iaixsl:choose>
                                                        ...
                                                        <iaixsl:if test="not(page/order2/orderdetails/@tradeCredit = 'y')">
                                                            <a class="order2_change_delivery_link" href="order1.php">verandering</a>
                                                        </iaixsl:if>
                                                    </span>
                                                    ...
                                                    <div class="order2_delivery_info">
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="page/order2/orderdetails/voucher/@value and (page/order2/orderdetails/@paymentcost &gt; 0)">Extra kosten<iaixsl:value-of select="page/order2/orderdetails/@paymentcost_formatted"/>


                                                            </iaixsl:when>
                                                            <iaixsl:when test="(page/order2/orderdetails/@deliverytype = 'prepaid') and not(page/order2/orderdetails/@tradeCredit = 'y')">Betaling voor verzending</iaixsl:when>
                                                            <iaixsl:when test="page/order2/orderdetails/@deliverytype = 'dvp' and page/order2/stock/@stock_id">U betaalt bij ons verkooppunt wanneer u uw bestelling afhaalt.</iaixsl:when>
                                                            <iaixsl:when test="page/order2/orderdetails/@deliverytype = 'dvp'">U betaalt door het pakket op te halen</iaixsl:when>
                                        ...
                                        <iaixsl:if test="/shop/page/order2/balance/@currency_value and /shop/page/order2/balance/@currency_value &gt; 0">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name">Betaald van het saldo (te veel betaald op klantrekening)</span>
                                        ...
                                        <iaixsl:if test="/shop/page/order2/insurance_product">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name">Kopersbescherming:<iaixsl:value-of select="/shop/page/order2/insurance_product/@service"/></span>
                                                    ...
                                                    <div class="order2_delivery_info">
                                                        ...
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="/shop/page/order2/insurance_product/@status = 'unconfirmed'">Status: onbevestigd</iaixsl:when>
                                                            <iaixsl:when test="/shop/page/order2/insurance_product/@status = 'confirmed'">Status: bevestigd</iaixsl:when>
                                ...
                                <div class="basketedit_total_summary">
                                    ...
                                    <iaixsl:choose>
                                        ...
                                        <iaixsl:otherwise>
                                            <strong>
                                                <iaixsl:value-of select="/shop/basket/summary/total_to_pay/@value_formatted"/>
                                                <iaixsl:if test="not(/shop/client_data/@uses_vat='false') and not(/shop/contact/owner/@vat_registered = 'false')">bruto</iaixsl:if>
                                            </strong>
                                        </iaixsl:otherwise>
                                    </iaixsl:choose>
                                ...
                                <iaixsl:if test="/shop/basket/summary/prepaid_discount/@value_formatted and $txt_68638_rpoz">
                                    ...
                                    <div class="basketedit_product_summary prepaid_discount_wrapper">
                                        <label>
                                            ...
                                            <span id="discount_paiment_name"><iaixsl:value-of select="page/order2/orderdetails/@payment_name"/></span>ontvangt u een extra korting:</label>
                            ...
                            <div class="order2_terms_wrapper">
                                ...
                                <div class="order2_terms_wrapper_sub">
                                    <label class="order2_terms_conditions">
                                        ...
                                        <i class="css-label"></i>
                                        <span><i class="icon-need"></i>Ik accepteer de voorwaarden<a target="_blank">
                                                <iaixsl:attribute name="title">Reglement</iaixsl:attribute>
                                                <iaixsl:attribute name="href">
                                                    <iaixsl:value-of select="/shop/action/terms/@url"/>
                                                </iaixsl:attribute>voorschriften</a>
                                        </span>
                                    </label>
                                </div>
                                ...
                                <iaixsl:if test="not($returns_agree_control)">
                                    <div class="order2_terms_wrapper_sub">
                                        <label class="order2_cancel">
                                            ...
                                            <i class="css-label"></i>
                                            <span><i class="icon-need"></i>Ik heb nota genomen van mijn<a target="_blank">
                                                    <iaixsl:attribute name="title">Terugtrekking uit het contract</iaixsl:attribute>
                                                    <iaixsl:attribute name="href">
                                                        <iaixsl:value-of select="/shop/action/order_cancel/@url"/>
                                                    </iaixsl:attribute>het herroepingsrecht</a>
                                            </span>
                                        </label>
                                    </div>
                                </iaixsl:if>
                                ...
                                <iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_virtual']">
                                    <div class="order2_terms_wrapper_sub virtual">
                                        <label class="order2_virtual">
                                            ...
                                            <i class="css-label"></i>
                                            <span><i class="icon-need"></i>Ik geef toestemming voor en verzoek tegelijkertijd om de uitvoering vóór het verstrijken van de herroepingstermijn. Ik ben mij ervan bewust dat ik door het geven van deze toestemming mijn recht op herroeping verlies bij aanvang van de uitvoering.</span>
                                        </label>
                                    </div>
                                </iaixsl:if>
                                ...
                                <iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_service']">
                                    <div class="order2_terms_wrapper_sub service">
                                        <label class="order2_service">
                                            ...
                                            <i class="css-label"></i>
                                            <span><i class="icon-need"></i>Ik ga akkoord en verzoek tegelijkertijd om de dienst voor het einde van de wachttijd te starten. Ik ben ervan op de hoogte dat ik mijn herroepingsrecht verlies als de dienst volledig wordt uitgevoerd.</span>
                                        </label>
                                    </div>
                                </iaixsl:if>
                            ...
                            <div class="basketedit_summary_buttons table_display">
                                ...
                                <div class="btn_wrapper">
                                    <input class="btn --solid --large order2_button_order terms_required" type="submit">
                                        ...
                                        <iaixsl:attribute name="value">Opdracht met betalingsverplichting</iaixsl:attribute>
                                    ...
                                    <div class="button_legend">
                                        <i class="icon-need"></i>Velden met een sterretje zijn verplicht.</div>
