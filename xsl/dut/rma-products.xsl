...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
    ...
    <!--Rma lista produktów (rma_products_list, 112530.1)-->
            ...
            <div class="step2">
                <div class="progress_bar_wrapper pb_step2 rma_progress_bar">
                    ...
                    <div class="_step _step2">
                        ...
                        <p>
                            <i> </i>
                            <b>Selecteer producten</b>voor klachten</p>
                    </div>
                ...
                <iaixsl:if test="page/products">
                    ...
                    <iaixsl:variable name="wholesalerPrice"/>
                    ...
                    <form class="returns_productslist" action="/rma-method.php?type=multiproduct" method="post">
                            ...
                            <table>
                                ...
                                <tr class="basketedit_productslist_label">
                                    ...
                                    <iaixsl:if test="page/products/product/warranty">
                                        <th class="productslist_product_warranty">Garantie</th>
                                    </iaixsl:if>
                                    ...
                                    <th class="productslist_product_comment">Opmerkingen</th>
                                    <th>Actie</th>
                                    ...
                                    <tr class="productslist_item">
                                                ...
                                                <iaixsl:when test="@allowReturn='0'">
                                                    ...
                                                    <div class="productslist_product_info d-sm-none">
                                                        <div class="btn-icon allowReturn_1">
                                                            ...
                                                            <span>Dit product is waarschijnlijk niet iets waar je reclame voor kunt maken. Indien nodig<a href="/contact.php">Neem contact op met</a>.</span>
                                                        </div>
                                                    </div>
                                                </iaixsl:when>
                                                <iaixsl:when test="@allowReturn='2'">
                                                    ...
                                                    <div class="productslist_product_info d-sm-none">
                                                        <div class="btn-icon allowReturn_2">
                                                            ...
                                                            <span>Zorg ervoor dat u reclame kunt maken voor dit product, met bijzondere aandacht voor de dag waarop u het product hebt ontvangen en de garantieperiode.<a href="/#">Ik wil adverteren</a>.</span>
                                                        </div>
                                                    </div>
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                            ...
                                            <td class="productslist_product_warranty">
                                                ...
                                                <iaixsl:if test="not(warranty/@gfx)">
                                                    <div class="productslist_warranty">
                                                        ...
                                                        <img class="qmark2 showTip" src="/gfx/dut/qmark2.gif?r=1612518076" alt="" title=""/>
                                        ...
                                        <td class="productslist_product_comment">
                                            <iaixsl:if test="not(@allowReturn='0') and not(@allowReturn='2')">
                                                <a href="#addComment">
                                                    <iaixsl:attribute name="title">klik om commentaar toe te voegen</iaixsl:attribute>
                                                    <i class="icon-paper-clip"></i> <span>Beschrijving en foto's<br/>storingen</span>
                                                </a>
                                            </iaixsl:if>
                                        </td>
                                                        ...
                                                        <iaixsl:when test="change_group/@id">
                                                            ...
                                                            <iaixsl:if test="change_group/@changelink">
                                                                ...
                                                                <a>
                                                                    ...
                                                                    <iaixsl:attribute name="href"><iaixsl:value-of select="change_group/@changelink"/></iaixsl:attribute>ruilproduct</a>
                                                            </iaixsl:if>
                                                        </iaixsl:when>
                                                        <iaixsl:otherwise>
                                                            ...
                                                            <iaixsl:if test="not(size/@unit_sellby = '1')">
                                                                ...
                                                                <div class="productslist_product_sellby_info">verkocht bij:<iaixsl:value-of select="size/@unit_sellby"/><iaixsl:text> </iaixsl:text>
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="not(size/@ordered &gt; 1)">
                                                                            <iaixsl:value-of select="size/@unit_singular"/>
                                                                        </iaixsl:when>
                                        ...
                                        <td colspan="8" class="productslist_comment">
                                            ...
                                            <div class="prodl_comment">
                                                ...
                                                <div class="prodl_comment_left">
                                                    ...
                                                    <a href="#clearComment">opruimen</a>
                                                </div>
                                                ...
                                                <div class="prodl_comment_right">
                                                    ...
                                                    <div class="prodl_comment_button">
                                                        <a href="#addMoreFiles" class="btn --solid addMoreFiles">Bestand toevoegen</a>
                                                    </div>
                        ...
                        <div class="returns_summary_buttons table_display">
                            ...
                            <div class="btn_wrapper">
                              <button id="return_go_next" type="submit" class="btn --solid --large --icon-right icon-angle-right">Ga verder.</button>
                            </div>
