        ...
        <!--Otwórz zamówienie (order_open_form, 112607.1)-->
			<section class="order_open mb-4">
				...
				<h1 class="order_open__label headline">
					<span class="order_open__label_txt headline__name">Controleer de bestelstatus</span>
				</h1>

				
				<div class="order_open__description menu_messages_message mb-4">Om de status van uw bestelling te controleren, voert u uw bestelnummer in (dat vindt u in de e-mail die u na het plaatsen van uw bestelling hebt ontvangen) en uw telefoonnummer of e-mailadres.</div>
				...
				<form action="/order-open.php" method="post" class="order_open__form row flex-column align-items-center mb-4" novalidate="novalidate">
					<div class="order_open__inputs col-12 col-sm-7">
						...
						<div class="f-group order_open__number">
							<div class="f-feedback order_open__feedback --number">
								...
								<label for="order_open__number_input" class="f-label">Bestelnummer:</label>
						...
						<div class="f-group order_open__email">
							<div class="f-feedback order_open__feedback --email">
								...
								<label for="order_open__email_input" class="f-label">Uw telefoon of e-mail:</label>
								<span class="f-control-feedback"/>
							</div>
						</div>
					</div>
					...
					<div class="order_open__submit col-12 col-sm-7 d-flex flex-column align-items-center">
						<button class="btn --solid --medium px-5 order_open__button">Controleer de bestelstatus</button>
				...
				<div class="order_open__signin d-flex justify-content-center">
					<a href="/login.php" class="order_open__signin_link">Ik heb een geregistreerde account en wil toegang tot mijn bestellijst</a>
				</div>
			</section>
