    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <!--Zamówienie niestandardowe - złożenie zamówienia (order_nonstandardized_form, 108077.1)-->
            <iaixsl:if test="page/action/order/@link">
                <a class="btn --large --solid --icon-right icon-angle-right n59299_link" href="/order2.php?preview=true">Ga verder.</a>
                <div class="n59299_text">De leveringskosten worden vastgesteld bij de aanvaarding van de bestelling.</div>
            </iaixsl:if>
