                    ...
                    <tbody>
                            ...
                            <th class="cmp_product configure"><div class="item_width">
                                <iaixsl:if test="lastsearch">
                                    <a class="btn --solid --secondary --medium d-block mb-2">
                                        ...
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="lastsearch"/></iaixsl:attribute>Terug naar de lijst met producten</a>
                                </iaixsl:if>
                                <a class="btn --solid --medium d-block mb-2">
                                    <iaixsl:attribute name="href">#differences</iaixsl:attribute>
                                    <iaixsl:attribute name="data-toggleTxt">Ukryj różnice</iaixsl:attribute>Markeer de verschillen</a>
                            </div></th>
                                ...
                                <td class="cmp_product">
                                    ...
                                    <div class="configure_item item_width">
                                        <a>
                                            ...
                                            <i class="icon-minus"></i>Verberg</a>
                                        <a class="hideCol">
                                            ...
                                            <i class="icon-remove"></i>Verwijder</a>
                                    </div>
                                    <div class="product_wrapper item_width">
                                        <a class="product-icon align_row" data-align="img#css">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
                                            <img class="b-lazy" src="/gfx/pol/loader.gif?r=1685223127">
                                            ...
                                            <strong class="label_icons hideCol">
                                                ...
                                                <iaixsl:if test="(additional/promotion)">
                                                    <span class="label promo">In promotie</span>
                                                </iaixsl:if>
                                                <iaixsl:if test="(additional/new)">
                                                    <span class="label newproducts">Nieuw</span>
                                                </iaixsl:if>
                                                <iaixsl:choose>
                        ...
                        <iaixsl:if test="page/products/product/size">
                            <iaixsl:if test="not(page/products/product/size/size/@name = 'uniw')">
                                <tr>
                                    <th><div class="item_width">Maten</div></th>
                                    <iaixsl:for-each select="page/products/product">
                                        <td>
                        ...
                        <iaixsl:if test="page/products/versions">
                            <iaixsl:for-each select="page/products/versions/version">
                                <tr>
                                    <th><div class="item_width">Opties voor<iaixsl:value-of select="@name"/></div></th>
                        ...
                        <iaixsl:if test="page/products/product/description">
                            <tr>
                                <th><div class="item_width">Beschrijving</div></th>
                                <iaixsl:for-each select="page/products/product">
                                    <td>
                                        <div class="hideCol item_width">
                                            <iaixsl:value-of disable-output-escaping="yes" select="description"/>
