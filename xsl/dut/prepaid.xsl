                                                    ...
                                                    <div class="row">
                                                            <div class="credit_card_pci_dss col-12">
                                                                    ...
                                                                    <span class="pci_dss_icon_container">
                                                                            <img src="/gfx/pol/pci_css_logo.png?r=1612518076" alt="PCI DSS Compilant"/>
                                                                    </span>
                                                            </div>
                                                    </div>
                                            </form>
            ...
            <table>
                ...
                <tr>
                    <td class="ordered-icon">
                        <img src="/gfx/pol/shipping_icon.png?r=1612518076">
                    ...
                    <iaixsl:when test="/shop/page/prepaid/prepaid_history/item/@status = 'n'">
                        <iaixsl:for-each select="/shop/page/prepaid/prepaid_history/item[@status = 'n']">
                            <tr class="payment_form_item">
                                <td class="ordered-icon">
                                    <img src="/gfx/pol/prepaid_method_icon.png?r=1612518076">
                                        <iaixsl:if test="@icon">
                                            <iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute>
                                        </iaixsl:if>
                                        <iaixsl:attribute name="alt"><iaixsl:value-of select="@payment_name"/></iaixsl:attribute>
                ...
                <iaixsl:if test="/shop/page/insurance_product">
                    ...
                    <tr>
                        <td class="ordered-icon">
                            <img src="/gfx/pol/insurance_icon.png?r=1612518076" alt="insurance_icon"/>
                        </td>
            ...
            <iaixsl:if test="$prepaidrt_txt and /shop/page/prepaid/actions/return/@url">
                <div class="actions_return col-12 col-sm-6">
                    <div class="actions_return_sub col-12 mb-4">
                        ...
                        <div>
                            <img alt="returns" src="/gfx/pol/returns_action.png?r=1612518076"/><span>Als u gebruik wilt maken van uw recht om uw aankoop zonder opgaaf van reden te retourneren, gebruik dan ons retoursysteem, dat het proces eenvoudig en veilig maakt.</span></div>
                            <a class="btn --solid">
            ...
            <iaixsl:if test="$prepaidzt_txt and /shop/page/prepaid/actions/rma/@url">
                <div class="actions_rma col-12 col-sm-6">
                    <div class="actions_rma_sub col-12">
                        ...
                        <div>
                            <img alt="rma" src="/gfx/pol/rma_action.png?r=1612518076"/><span>Als het product in goede staat was op het moment van levering, maar defect is geraakt en u een garantieclaim wilt indienen via onze winkel, gebruik dan ons claimsysteem, dat het proces gemakkelijker en sneller maakt.</span></div>
                            <a class="btn --solid">
