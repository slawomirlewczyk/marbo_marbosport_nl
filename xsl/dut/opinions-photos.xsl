    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
		...
		<iaixsl:when test="count(page/opinions-photos/opinions/opinion[@image_small or @image_large]) &gt; 0">
			...
			<div id="opinions">
				...
				<p class="opinions-description">Wil je je foto toevoegen? Dat kan door een review te schrijven en je foto toe te voegen over een van de producten. Om dergelijke producten sneller te vinden, gebruikt u de<a href="/products-bought.php">lijsten van gekochte producten</a>.
							...
							<iaixsl:value-of disable-output-escaping="yes" select="content"/>
								...
								<div class="opinion-hover">
									...
									<div class="product-info">
										...
										<a class="see-product">
												<iaixsl:attribute name="href"><iaixsl:value-of select="product/@link"/></iaixsl:attribute>
												<iaixsl:attribute name="title"><iaixsl:value-of select="product/@name"/></iaixsl:attribute>Bekijk product</a>
									</div>
								</div>
						</div>
				</div>
		...
		<iaixsl:otherwise>
			<div id="opinions" class="d-flex flex-column align-items-center --empty">
				...
				<p class="opinions-description">
				    <span class="d-block">Wil jij als eerste de geschiedenis van onze winkel ingaan?</span>Voeg een foto toe aan de beoordeling van een product. Om dergelijke producten sneller te vinden, gebruikt u<a href="/products-bought.php">lijsten van gekochte producten</a>.
					<iaixsl:if test="false">
					
					<br/>Za każdą opinię ze zdjęciem otrzymasz od nas 
						%s
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/opinions_photos_display.js.gzip?r=1612518076</iaixsl:attribute></script>
            <script>
                app_shop.runApp();
            </script>
