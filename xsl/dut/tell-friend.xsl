...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 119565.1)-->
    ...
    <!--Buttony reklamowe (menu_buttons, 116900.1)-->
        ...
        <!--Poinformuj znajomego - cms (tell_friend_cms, 55903.1)-->
    <iaixsl:if test="page/text/body">
    <table class="cms_55903" cellspacing="0" cellpadding="0" align="center">
        <tr><td class="tell_friend_cms"><iaixsl:value-of disable-output-escaping="yes" select="page/text/body"/></td></tr>
    </table>
    </iaixsl:if>
    <!--Poinformuj znajomego - form (tell_friend_form, 55907.1)-->

<div class="suggest_site_55907">

	<form action="contact.php" class="suggest_site_55907" method="post">
			
		<div class="n55907_main">
				
			<div class="left_55907">
			
				
				<div class="n55907_right1">
                                        <span class="mail_55907">E-mail van de ontvanger:</span>
					<input maxlength="255" class="n55907_form" type="text" name="to"/>
				</div>
				
				
				
				<div class="n55907_right2">	
                                        <span class="name_55907">Uw naam:</span>		
					<input id="firstname" class="n55907_form" type="text" name="firstname">
						<iaixsl:attribute name="value">
						
							<iaixsl:choose>
								<iaixsl:when test="client_data/@firstname">
									<iaixsl:value-of select="client_data/@firstname"/>
								</iaixsl:when>
								<iaixsl:otherwise>
									<iaixsl:value-of select="page/suggest_shop/@firstname"/>
								</iaixsl:otherwise>
							</iaixsl:choose>
			...
			<div class="right_55907">
							
				
				<div class="n55907_right3">
                    <span class="tresc_55907">Inhoud van het bericht:</span>
					<textarea class="n55907_body" name="body"><iaixsl:choose><iaixsl:when test="(page/suggest_shop)  != ''"><iaixsl:value-of select="page/suggest_shop/text()"/></iaixsl:when><iaixsl:otherwise>Ik heb een winkel gevonden die het bekijken waard is. Ik denk dat het je wel zal interesseren.</iaixsl:otherwise></iaixsl:choose></textarea>
				</div>
				
				
			</div>

				<div class="n55907_submit">
                                        <input type="hidden" name="suggest_shop" value="submit"/>
					<input class="n55907_submit" type="submit">
						<iaixsl:attribute name="value"/>
					</input>
				</div>
