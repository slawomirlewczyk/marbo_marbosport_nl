    ...
    (e.prototype.checkResponsive = function (e, t) {
      ...
      if (
        ("window" === r.respondTo
          ...
          : "slider" === r.respondTo
          ? (n = d)
          : "minimaal" === r.respondTo && (n = Math.min(a, d)),
  ...
  $.extend(Datepicker.prototype, {
    ...
    _optionDatepicker: function (target, name, value) {
      ...
      if (inst) {
        ...
        var minDate = this._getMinMaxDate(inst, "minimaal");
...
var projectorClass = function () {
  ...
  this.actions = {};
  this.txt = [];
  this.txt["je bespaart"] = "Sla ";
  this.txt["goedkope"] = "%, czyli ";
  this.txt["wzestawie"] = " kopen als set";
  this.txt["niedostepny"] = "Product niet beschikbaar";
  this.txt["tylkotel"] = "Prijs op afroep. Neem contact op met de verkoper";
  this.txt["tylko_punkty"] = "Koopwaar alleen verkrijgbaar via het loyaliteitsprogramma.";
  this.txt["gratis"] = "gratis";
  this.txt["gratis_produkt"] = "Gratis!";
  this.txt["niemastanu"] = "Product niet beschikbaar";
  this.txt["status_24"] = "binnen 24 uur";
  this.txt["status_natychmiast"] = "binnen 24 uur";
  this.txt["day"] = " dag ";
  this.txt["days"] = " dagen ";
  this.txt["hour"] = " uur ";
  this.txt["hours"] = " uur ";
  this.txt["minimaal"] = "minimaal";
  this.txt["mins"] = " minimaal ";
  this.txt["per"] = "per";
  this.txt["proc"] = "%";
  this.txt["wybrany_rozmiar"] = "Maat";
  this.txt["verzending"] = "Verzending ";
  this.txt["wysylka_za"] = "Verzending binnen";
  this.txt["dostepny"] = "Levering ";
  this.txt["dostepny_za"] = "Levering voor";
  this.txt["punt"] = "punt";
  this.txt["status_full"] = "groter aantal";
  this.txt["status_amount_null"] = "niet op voorraad";
  this.txt["forpointsonly"] = "U kunt het product kopen met punten";
  this.txt["disable_desc"] = "Contact met ons opnemen";
  this.txt["choiceSize"] = "Selecteer grootte";
  this.txt["max"] = "Het maximum dat u kunt bestellen is";
  this.txt["minimaal"] = "U kunt minimaal bestellen";
  this.txt["brak_magazyn"] = "Niet op voorraad";
  this.txt["dodano_produkt"] = "Het product is toegevoegd.";
  this.txt["dodano_produkt_blad"] = "Er is een fout opgetreden tijdens het toevoegen van een product.";
  this.txt["ilosc_mm"] = "";
  this.txt["ilosc_mo"] = "";
  this.txt["ilosc_mo_inf"] = "";
  this.txt["infinity"] = "";
  this.txt["koszt_od"] = "Kosten van";
...
app_shop.txt.txt_65642_1 = "Het genereren van banners is mislukt";
...
promoCodes_txt["code_for_shop"] = "Code voor de winkel";
promoCodes_txt["activate_code"] = "Kortingscode activeren";
promoCodes_txt["generated_code"] = "Gegenereerde code";
promoCodes_txt["generated_code_desc"] =
  "U kunt de volgende code kopiëren en in uw website plakken";
...
var productslist_03a_txt = "Opmerkingen mogen maximaal";
var productslist_03b_txt = "borden.";
...
var txt_order_wrappers_1 = "naar uw mandje";
var txt_order_wrappers_2 = "Gratis !";
var txt_order_wrappers_4 = "Selecteer verpakking";
var txt_order_wrappers_8 = "Sluit";
...
var client_new_social_info_js_txt_1 =
  "Log in op een van de bovengenoemde aanmeldingsformulieren om uw registratie te voltooien.";
app_shop.run(
  function () {
...
clientnew_00_txt = "We hebben al een account geregistreerd voor het door u opgegeven e-mailadres:";
clientnew_01_txt = "Ik herinner me mijn gebruikersnaam en wachtwoord en kan ze geven.";
clientnew_02_txt =
  "Chcę stworzyć nowe konto przy użyciu tego adresu (niezalecane).";
clientnew_03_txt = "Stuur e-mail voor automatische aanmelding";
clientnew_06_txt = "Stuur een bericht naar";
clientnew_07_txt = "met uw inloggegevens.";
clientnew_08_txt = "<br/>" + "De eerder aangemaakte rekening is gekoppeld aan de";
clientnew_13_txt =
  "Wij raden u aan deze account te gebruiken, zodat u kunt genieten van de privileges die voorbehouden zijn aan vaste klanten. Om in te loggen op uw eerder aangemaakte account, klikt u gewoon op de link die wij u in de e-mail sturen.";
clientnew_14_txt =
  "De juiste postcodeformaten voor het geselecteerde land zijn X - cijfer, Y - letter:";
clientnew_15c_txt = "borden" + ").";
clientnew_16a_txt = '<i class="icon-visibility"></i>';
clientnew_16b_txt = '<i class="icon-novisibility"></i>';
var clientNewErrorCode = [];
clientNewErrorCode["no_login"] = "Voer in dit veld uw login in.";
clientNewErrorCode["incorect_login"] =
  "Błędnie wpisany login. Login musi mieć minimum 3 znaki (tylko litery lub cyfry).";
clientNewErrorCode["no_password"] = "Voer uw wachtwoord in dit veld in.";
...
clientNewErrorCode["login_equals_password"] =
  "Het wachtwoord is hetzelfde als de login. Voer een ander wachtwoord in.";
clientNewErrorCode["not_equal_passwords"] =
  "De ingevoerde wachtwoorden zijn niet hetzelfde. Voer het wachtwoord nogmaals in en bevestig.";
clientNewErrorCode["no_firstname"] = "Voer uw naam in dit veld in.";
clientNewErrorCode["no_name"] = "Voer in dit veld uw naam in.";
clientNewErrorCode["incorect_email"] =
  "Błędnie wpisany e-mail. Wpisz pełny adres e-mail, np. jan@kowalski.com";
clientNewErrorCode["incorect_shops"] = "Selecteer een winkel uit de lijst.";
clientNewErrorCode["incorect_nip"] =
  "Verkeerd ingevoerd NIP. De juiste NIP heeft 10 cijfers.";
clientNewErrorCode["no_firmname"] = "Verkeerd ingevoerde bedrijfsnaam.";
clientNewErrorCode["incorrect_region"] = "Verkeerd gekozen regio.";
clientNewErrorCode["no_city"] = "Voer in dit veld de naam van de stad in.";
clientNewErrorCode["birth_date"] =
  "Voer de juiste geboortedatum in, in het formaat JJJJ-MM-DD";
clientNewErrorCode["no_street"] =
  "Voer de straat- of plaatsnaam en het huisnummer in.";
clientNewErrorCode["no_street_number"] =
  "Voer de straat- of plaatsnaam en het huisnummer in.";
clientNewErrorCode["incorect_phone"] = "Voer uw telefoon in.";
clientNewErrorCode["incorect_zipcode"] = "Verkeerd ingevoerde postcode.";
clientNewErrorCode["no_delivery_firstname"] = "Voer de naam in van de ontvanger van de overbrenging.";
clientNewErrorCode["no_delivery_lastname"] =
  "Voer de naam in van de ontvanger van de overbrenging.";
clientNewErrorCode["no_delivery_city"] = "Voer de stad in van de ontvanger van de overbrenging.";
clientNewErrorCode["no_delivery_street"] =
  "Vul de straat en het huisnummer in van de geadresseerde van de zending.";
clientNewErrorCode["incorect_delivery_region"] =
  "Selecteer het land van bestemming van de zending.";
clientNewErrorCode["incorect_delivery_zipcode"] =
  "Voer de postcode van de ontvanger van de zending in.";
clientNewErrorCode["login_taken"] = "De door u ingevoerde login is al bezet";
...
clientNewErrorCode["illegal_characters_client_firstname"] =
  "Een van de gebruikte tekens is niet toegestaan.";
...
days_02_txt = "pn";
days_03_txt = "Dinsdag";
days_04_txt = "Woensdag";
days_05_txt = "Donderdag";
days_06_txt = "Vrijdag";
days_07_txt = "Zaterdag";
month_01_txt = "Januari";
month_02_txt = "Februari";
month_03_txt = "Maart";
month_04_txt = "April";
month_05_txt = "Mei";
month_06_txt = "Juni";
month_07_txt = "Juli";
month_08_txt = "Augustus";
month_09_txt = "September";
month_10_txt = "Oktober";
month_11_txt = "November";
month_12_txt = "December";
month_2_01_txt = "Januari";
month_2_02_txt = "Februari";
month_2_03_txt = "Maart";
month_2_04_txt = "April";
month_2_05_txt = "Mei";
month_2_06_txt = "Juni";
month_2_07_txt = "Juli";
month_2_08_txt = "Augustus";
month_2_09_txt = "September";
month_2_10_txt = "Oktober";
month_2_11_txt = "November";
month_2_12_txt = "December";
month_3_01_txt = "Januari";
month_3_02_txt = "Februari";
month_3_03_txt = "Maart";
month_3_04_txt = "April";
month_3_05_txt = "Mei";
month_3_06_txt = "Juni";
month_3_07_txt = "Juli";
month_3_08_txt = "Augustus";
month_3_09_txt = "September";
month_3_10_txt = "Oktober";
month_3_11_txt = "November";
month_3_12_txt = "December";
iaical_monthNext = "Volgende maand";
iaical_monthPrev = "Vorige maand";
...
var menu_instalment_singleproduct = "Bereken de termijnen alleen voor dit product";
var menu_instalment_multiproduct = "Bereken afbetalingstermijnen voor producten in het mandje";
var menu_instalment_basketproduct = "Bereken de termijnen inclusief de waarde van het mandje";
var menu_instalment_notall =
  "Niet bij alle producten in uw winkelmandje kunt u via dit afbetalingsschema kopen. Ga naar de details van elk product om na te gaan welke een dergelijke aankoop mogelijk maken. Als u besluit in termijnen te kopen, moeten deze producten apart worden betaald met andere betalingsmethoden.";
var menu_instalment_toomany =
  "Er zitten te veel producten in de winkelwagen om uw bestelling met dit afbetalingssysteem te betalen. Verminder de hoeveelheid producten tot";
var menu_instalment_toomany2 =
  "om gebruik te maken van het afbetalingssysteem. Het aantal eenheden van één product is niet beperkt.";
var menu_instalment_label_to = " to ";
var menu_instalment_label_minbasket =
  "U kunt de afbetalingssimulatie niet uitvoeren voor het hele winkelmandje, aangezien het minimumbedrag om aankopen per";
var menu_instalment_text_min =
  "Verhoog de hoeveelheid van het product om de afbetalingscalculator te starten";
var menu_instalment_text_minbasket =
  "Verhoog het aantal stuks van dit product, of leg extra producten in uw mandje.";
var menu_instalment_text_minb =
  "Verhoog het aantal producten in uw mandje om de afbetalingscalculator te starten.";
var menu_instalment_label_max = "Het maximumbedrag dat kan worden gekocht via";
var menu_instalment_label_maxbasket =
  "U kunt de afbetalingssimulatie niet uitvoeren voor het hele winkelmandje, omdat het maximumbedrag dat aankopen door";
var menu_instalment_text_max =
  "Verminder het aantal productstukken om de afbetalingscalculator uit te voeren.";
var menu_instalment_text_maxbasket =
  "Verminder het aantal stuks van dit product, of verwijder enkele producten uit uw mandje.";
var menu_instalment_text_maxb =
  "Verminder het aantal producten in uw mandje om de afbetalingscalculator te starten";
var menu_instalment_label_min = "Minimumbedrag om aankopen via";
...
var menu_notice_txt2 = "Venster sluiten";
...
app_shop.txt.txt_validation1 = "Het minimumaantal tekens voor dit veld is";
app_shop.txt.txt_validation2 = "Het maximumaantal tekens voor dit veld is";
app_shop.txt.txt_validation3 =
  "Błędnie wpisany e-mail. Wpisz pełny adres e-mail, np. jan@kowalski.com.";
app_shop.txt.txt_validation4 = "Dit veld is verplicht.";
app_shop.txt.txt_validation5 =
  "Formaat bankrekeningnummer is onjuist";
app_shop.txt.txt_validation6 =
  "Het telefoonnummer moet minimaal 9 tekens bevatten";
app_shop.txt.hotspot_prev = "Vorige van deze categorie";
app_shop.txt.hotspot_next = "Volgende in deze categorie";
...
txt_quick_search["producten"] = "";
txt_quick_search["categorieën"] = "Categorieën ";
txt_quick_search["producenten"] = "";
txt_quick_search["serie"] = "";
txt_quick_search["cms"] = "Informatie";
txt_quick_search["produkty_before"] = "";
txt_quick_search["kategorie_before"] = "";
txt_quick_search["producenci_before"] = "Fabrikant:";
txt_quick_search["serie_before"] = "Serie:";
txt_quick_search["cms_before"] = "";
txt_quick_search["more"] = "";
txt_quick_search["sep"] = " / ";
txt_quick_search["zoek"] = "Wat zoek je?";
          ...
          if (!$.isEmptyObject(result.products)) {
            var products = $.map(result.products, function (item) {
              ...
              return {
                ...
                category: txt_quick_search["producten"],
          ...
          if (!$.isEmptyObject(result.producers)) {
            var producers = $.map(result.producers, function (item) {
              return {
                ...
                link: item.link,
                price: "",
                category: txt_quick_search["categorieën"],
...
var saldo_txt = [];
saldo_txt["prepaid"] = [
  "Gebruik beschikbare fondsen en betaal het saldo vóór verzending",
  "Gebruik de beschikbare middelen en kies de leveringsmethode",
  '<span class="d-block d-sm-inline">Płatność</span> przed wysyłką',
  "Betaling via handelskrediet",
];
saldo_txt["dvp"] = [
  "Gebruik de beschikbare middelen en betaal het saldo bij levering",
  "Gebruik de beschikbare middelen en betaal het saldo bij levering",
  '<span class="d-block d-sm-inline">Płatność</span> przy odbiorze',
  "Gebruik uw beschikbare kredietlimiet en betaal het saldo bij levering",
];
var deliveryComment = "";
var order1_bonalert =
  "Betaling met product voucher geselecteerd maar geen voucher nummer ingevoerd";
var order1_gratis = "Gratis!";
var order1_showFields_day = "dag";
var order1_showFields_days = "dagen";
var order1_pkt = "punt";
var calendar_in_time = "tijdens";
var gross_txt = "bruto";
var txt_order1_shipping_0 = "<b> Vandaag verzonden </b>";
var txt_order1_shipping_1 = "<b>Verzending maandag</b>";
var txt_order1_shipping_2 = "<b>Verzending dinsdag</b>";
var txt_order1_shipping_3 = "<b>Verzending woensdag</b>";
var txt_order1_shipping_4 = "<b>Versturen op donderdag</b>";
var txt_order1_shipping_5 = "<b>Verzenden op vrijdag</b>";
var txt_order1_shipping_6 = "<b>Verzending zaterdag</b>";
var txt_order1_shipping_7 = "<Verzending op zondag</b>.";
...
var txt_order1_shipping_10 = "Het pakje moet bij u zijn";
var txt_order1_shipping_10_de = "";
var txt_order1_shipping_11 = "Ophalen van bestellingen mogelijk";
var txt_order1_giftcard_gc1 = "Cadeaubon";
var txt_order1_giftcard_gc2 = "Betaal uw aankopen met uw Gift Card";
var txt_order1_giftcard_gc3 = "Nummer:";
var txt_order1_giftcard_gc3a = "Voer uw kaartnummer in";
var txt_order1_giftcard_gc4 = "PIN:";
var txt_order1_giftcard_gc4a = "Voer PIN-code in";
var txt_order1_giftcard_gc5 = "";
var txt_order1_giftcard_01 = "Onjuiste kaartgegevens";
var txt_order1_giftcard_02 = "Voer het juiste nummer en de PIN in";
var txt_order1_giftcard_03 = "Het handvest is goedgekeurd. Bedankt.";
var txt_order1_giftcard_04 = "Kaartnummer:";
var txt_order1_giftcard_05 = "verandering";
var txt_order1_giftcard_06 = "Ga verder.";
var txt_order1_giftcard_07 = "Kaart goedkeuren";
var txt_order1_voucher_01 = "Onjuist vouchernummer";
var txt_order1_gift_voucher_verification = "";
var xpress_couriers = [];
xpress_couriers["not_available"] =
  "Helaas is er momenteel geen voorraad beschikbaar";
xpress_couriers["choose_date"] =
  "U moet gegevens verstrekken over de wijze van levering";
xpress_couriers["errno_2"] = "Express koerier bedient uw gebied niet";
xpress_couriers["errno_3"] =
  "Er is een fout opgetreden bij de externe koeriersdienst. Neem contact op met het winkelpersoneel of verander uw leveringsmethode.";
Order1 = {};
...
var confirmmessage =
  "Uw bestelling is nog niet geplaatst. Als u deze pagina verlaat, verlaat u uw bestelling. Houd er rekening mee dat wanneer u over enige tijd terugkeert naar uw bestelling, sommige producten of prijzen mogelijk niet meer geldig zijn.";
var confirmmessage2 =
  "Uw bestelling is nog niet geplaatst. Pas als u naar de volgende fase van uw bestelling gaat, wordt deze ter verwerking verzonden. Houd er rekening mee dat wanneer u enige tijd later op uw bestelling terugkomt, sommige producten of prijzen mogelijk niet meer geldig zijn.";
var confirmwarning = "Waarschuwing";
var order_send_preloadertxt = "Bestelling in uitvoering";
var stop_order_button = "Bestelling annuleren";
var continue_order_button = "Ga door met uw bestelling";
...
var pickupl_alert = "Geen ophaalpunt geselecteerd";
var pickupl_alertPoczta = "Postkantoor niet geselecteerd";
var pickupl_linktxt = "meer informatie";
var pickupl_linktitle = "Zie details";
var pickupl_requires_client_number =
  "Het klantnummer is niet ingevoerd in het koerierssysteem.";
var pickupl_select_adress = "Voer het juiste adres in.";
var pickupl_select_route = "Voer de naam van de stad in";
var pickupl_nopoints = "Geef een ander adres op, geen afhaalpunten.";
var pickupl_error =   "Er is een fout opgetreden. Vernieuw de pagina en probeer het opnieuw";
var pickupl_nopoints_in_area =   "Geen verzamelpunten gevonden in het gebied.";
...
var txt_62619_label = "Bijdragen";
var txt_62619_wybrales_curr = "Je hebt gekozen";
var txt_62619_wybrales = "U heeft gekozen maar gekozen voor geen betaling";
var txt_62619_nakwote = "ten bedrage van";
var txt_62619_wybrales2_curr = "";
var txt_62619_wybrales2 = "Geselecteerde";
var txt_62619_jako = "als een vorm van betaling.";
var txt_62619_jako_zwrot = "als een vorm van terugkeer.";
var txt_62619_kwota = "Het te storten bedrag is";
var txt_62619_kwota_zwrot = "Het terug te betalen bedrag is";
var txt_62619_auto = "<br/>Wpłata zostanie zaksięgowana <b>automatycznie</b>.";
var txt_62619_dokoncz = "";
var txt_62619_title =
  "Als het betalingsproces is onderbroken, vernieuwt u deze betaling.";
var txt_62619_ponow = "Terugbetaling";
var txt_62619_bedz = "";
...
var txt_62619_w_inny2 = "De betalingsvorm wijzigen";
var txt_62619_rezygnacja = "U heeft gekozen voor deze vorm van betaling.";
var txt_62619_przyj_wplata = "Uw betaling is geaccepteerd.";
var txt_62619_przyj_zwrot = "De terugkeer is gemaakt.";
...
var txt_62619_od_nazwa = "Naam van de ontvanger:";
var txt_62619_konto = "Rekeningnummer:";
var txt_62619_swit = "SWIFT: ";
var txt_62619_bank = "Bank:";
var txt_62619_tytulem = "Transfer titel:";
var txt_62619_do_zaplaty = "Overschrijvingsbedrag:";
var txt_62619_wplata_dane = "<br/>Dokonaj wpłaty na poniższe dane.";
var txt_62619_close_window = "Venster sluiten";
var txt_62619_https_error =
  "Kredietkaartbetalingen kunnen alleen via een gecodeerde verbinding worden verricht. Controleer of het adres van de winkel wordt voorafgegaan door HTTPS of neem contact op met de winkelondersteuning.";
var txt_62619_voucher_error = "Er zijn fouten bij de betaling van de bonnen opgetreden.";
var txt_62619_voucher_error_v1 = "In deze winkel is deze bon niet geldig.";
var txt_62619_voucher_error_v2 =
  "Het bonnummer is onjuist. Een voucher met deze identificatiecode bestaat niet. Probeer de ID opnieuw in te voeren en controleer of deze correct is.";
var txt_62619_giftcard_error_v2 = "De cadeaubon gegevens zijn onjuist.";
var txt_62619_voucher_error_v3 = "Deze bon is geblokkeerd.";
var txt_62619_voucher_error_v4 = "Deze bon is al gebruikt.";
var txt_62619_voucher_error_v5 =
  "Deze bon is niet langer geldig - de vervaldatum is verstreken.";
var txt_62619_voucher_error_v6 = "";
var txt_62619_voucher_error_v7 =
  "De bon met het opgegeven ID bestaat niet. Probeer de identificatie opnieuw in te voeren.";
var txt_62619_voucher_error_v8 = "Er werd geen identificatiecode verstrekt.";
var txt_62619_payment_title = "Doe een betaling";
var txt_62619_loader_message = "Betalingsgegevens downloaden";
var txt_62619_loader_message2 = "Ik voeg betaling toe";
var txt_62619_loader_message3 = "Betalingsgeschiedenis downloaden";
var txt_62619_hhtransfer_error = "Er waren fouten in de betaling van punten.";
var txt_62619_incorrect_paymentid =
  "Er zijn fouten opgetreden - kies een andere vorm van betaling.";
var txt_62619_newpayment_error =
  "Er zijn betalingsfouten opgetreden. Probeer zo meteen opnieuw te betalen.";
var txt_62619_newpayment_points_error =
  "U heeft niet genoeg spaarpunten om deze bestelling te betalen - kies een andere betaalmethode.";
var txt_62619_mozesz_row = "U kunt ook";
var txt_62619_anuluj_wplate = "deze betaling annuleren";
...
var txt_62619_loader_message_4 = "Aan de gang zijnde annulering van de betaling";
var txt_62619_wypelnij_wniosek = "Vul het aanvraagformulier in";
var txt_62619_dokonaj_platnosci = "Doe een betaling";
var txt_62619_do_oplacenia = "Je moet nog steeds betalen voor je bestelling";
var txt_62619_dodatkowa_opl = "Extra kosten";
var txt_62619_l_nawias = " (";
var txt_62619_r_nawias = ")";
var txt_62619_payment_success =
  "De instructie om een online betaling te doen werd aanvaard.";
var txt_62619_select_payment_method = "Selecteer de betalingswijze";
var txt_62619_select_firstData =
  "De transactie wordt verwerkt door het betalingssysteem FirstData International.";
var txt_prepaid0011_kredyt = "Handelskrediet";
var txt_prepaid0011_saldo = "Saldo (nadpłata na koncie klienta)";
var txt_prepaid0019_upper = "Kies een andere vorm van betaling";
var txt_blikCode = "Voer de 6-cijferige BLIK-code in:";
var lukasnotconfirmed = "Gelieve het vakje met uw toestemming aan te kruisen.";
var zagielnotconfirmed =
  "Lees de voorwaarden voordat u een eRata-betaling goedkeurt.";
var next_voucher_text = "<span>+</span> Użyj kolejnego bonu";
var blik_js_txt_confirm =
  "Bevestig de transactie via de app op uw mobiele apparaat.";
var blik_code_empty = "";
var txt_terms_title = "Eenmalige betaling IAI Pay";
var txt_terms_link = "Voorwaarden voor IAI Pay";
var txt_terms_checkbox =
  "Oświadczam, że zapoznałam / zapoznałem się i w pełni akceptuję Regulamin.";
var txt_terms_checkbox1 = "Ik heb gelezen en accepteer";
var txt_terms_checkbox2 = "via welke de betaling zal worden verricht.";
var txt_62619_restartPayment = "Terugbetaling";
var txt_62619_card_not_supported =
  "Sorry, maar we ondersteunen dit type kaart niet.";
var txt_62619_blik_length_error = "De BLIK-code moet 6 cijfers bevatten";
...
app_shop.txt.txt_111709_1 = "Delen op Facebook";
app_shop.txt.txt_111709_2 = "Afbeelding downloaden";
...
projectorObj.txt["per"] = "per";
projectorObj.txt["goedkope"] = "<b>%</b> (";
projectorObj.txt["je bespaart"] = "<b>" + "Sla" + " </b> ";
projectorObj.txt["wzestawie"] = ")";
projectorObj.txt["wzestawieoszczedzasz"] =
  "Kopen als een set," + " <b>" + "je bespaart" + "</b> ";
projectorObj.txt["niedostepny"] = "Product niet beschikbaar";
projectorObj.txt["tylkotel"] = "Prijs op afroep. Neem contact op met de verkoper.";
projectorObj.txt["tylko_punkty"] =
  "Product alleen verkrijgbaar via het loyaliteitsprogramma.";
projectorObj.txt["za_malo_punktow"] = "Je hebt niet genoeg punten";
projectorObj.txt["gratis"] = "gratis";
projectorObj.txt["niemastanu"] = "Product niet beschikbaar";
projectorObj.txt["status_24"] = "binnen 24 uur";
projectorObj.txt["status_natychmiast"] = "Onmiddellijk";
projectorObj.txt["day"] = " dag ";
projectorObj.txt["days"] = " dagen ";
projectorObj.txt["hour"] = " uur";
projectorObj.txt["hours"] = " uur ";
projectorObj.txt["minimaal"] = "minimaal";
projectorObj.txt["mins"] = " minimaal ";
projectorObj.txt["proc"] = "%";
projectorObj.txt["wybrany_rozmiar"] = "Maat:";
projectorObj.txt["verzending"] = "";
projectorObj.txt["wysylka_za"] = "tijdens";
projectorObj.txt["dostepny"] = "";
projectorObj.txt["dostepny_za"] = "per";
projectorObj.txt["punt"] = "punt";
projectorObj.txt["status_amount_full"] = "groter aantal";
projectorObj.txt["status_amount_null"] = "niet op voorraad";
projectorObj.txt["forpointsonly"] = "Je kunt het product kopen met punten.";
projectorObj.txt["disable_desc"] = "Contact met ons opnemen.";
projectorObj.txt["choiceSize"] = "Selecteer grootte";
projectorObj.txt["max"] = "Het maximum dat u kunt toevoegen";
projectorObj.txt["minimaal"] = "U moet minimaal bestellen ";
projectorObj.txt["brak_magazyn"] = "Niet op voorraad";
projectorObj.txt["koszt_od"] = "Kosten van";
projectorObj.txt["wysylka_total_begin"] = "<br/>(z tow. z koszyka ";
projectorObj.txt["wysylka_total_end"] = ")";
projectorObj.txt["nawias_end"] = "). ";
projectorObj.txt["gratis_produkt"] = "Gratis!";
projectorObj.txt["virtual_inbasket"] = "Product reeds in het winkelmandje";
projectorObj.txt["infinity"] = "";
projectorObj.txt["ilosc_mm"] = "Aktualnie w naszym magazynie mamy <b>%d</b>.";
projectorObj.txt["ilosc_mo"] =
  "Kolejne <b>%d</b> możemy sprowadzić na zamówienie.";
projectorObj.txt["ilosc_mo_inf"] =
  "Elke hoeveelheid kan op bestelling worden gebracht.";
projectorObj.txt["size_select_functionality"] = "0";
projectorObj.txt["sizes_projector_functionality"] = "1";
projectorObj.txt["size_select_label"] = "Maat:";
projectorObj.txt["size_select_tell_availability"] = "Beschikbaarheid melden";
projectorObj.txt["size_select_last_unit"] = "Laatste stuk!";
projectorObj.txt["size_select_few_last_units"] = "Laatste stukken!";
var Projector_txt_maksymalnie = "Het maximum dat u kunt bestellen is:";
var Projector_txt_minimalnie = projectorObj.txt["minimaal"];
var Projector_txt_brak_magazyn = "Niet op voorraad";
var Projector_txt_produkt_niedostepny = "Product niet beschikbaar";
var Projector_txt_podajilosc = "Voer de hoeveelheid in voor de geselecteerde maat";
var Projector_txt_zalogujsie = "Inloggen";
var Projector_txt_closedialog = "";
var txt_raty_button1 = "Bereken de termijnen voor het product van uw keuze";
var txt_raty_button2 = "Bereken de termijnen met het bedrag in het mandje";
var txt_62619_cms_table = "Maattabel";
var txt_toltip_1 =
  "De prijs van de goedkoopste beschikbare verzendmethode inclusief uw mandje. U ontvangt een volledige lijst met prijzen en koeriers bij het plaatsen van uw bestelling.";
var txt_toltip_2 =
  "Het loyaliteitsprogramma is alleen beschikbaar voor ingelogde klanten.";
var txt_toltip_2a =
  "Możesz zamienić zgromadzone punkty lojalnościowe na ten produkt. Obecnie masz [xxx] punktów.";
var txt_toltip_3 =
  "Zodra uw bestelling is betaald, krijgt u van ons dit aantal loyaliteitspunten. Om punten te verzamelen moet u een geregistreerde klant zijn.";
var txt_toltip_4 = "";
var prepaid = "Betaling voor verzending";
var dvp = "Betaling bij levering";
var day_txt = "dag";
var days_txt = "dagen";
var hour_txt = "uur";
var hours_txt = "uur";
var min_txt = "minimaal";
var txt_24h = "24h";
var txt_do_24h = "tot 24 uur";
var delivery_txt = "Het transport zelf zal";
var delivery_txt2 = "De voorbereiding voor het persoonlijk ophalen zal";
var delivery_txt3 = "Vorm van levering beschikbaar bij";
var gratis_txt = "Gratis!";
app_shop.txt.txt_74629_1 = "Tot het einde van de promotie:";
app_shop.txt.txt_74629_2 = "Selecteer een andere optie.";
app_shop.txt.txt_74629_3 = "dagen";
app_shop.txt.txt_74629_4 = "uren";
app_shop.txt.txt_74629_5 = "minuten";
app_shop.txt.txt_74629_6 = "seconden";
app_shop.txt.txt_74629_7 =
  "Onze excuses, maar wij hebben geen standaard leveringskosten vastgesteld, deze worden individueel door onze medewerkers bepaald zodra de bestelling is geaccepteerd.";
var txt_shipping_8 = "Onmiddellijke verzending";
var txt_shipping_9 = "Verzending op maandag";
var txt_shipping_10 = "Verzending op dinsdag";
var txt_shipping_11 = "Verzending op woensdag";
var txt_shipping_12 = "Verzending op donderdag";
var txt_shipping_13 = "Verzending op vrijdag";
var txt_shipping_14 = "Verzending op zaterdag";
var txt_shipping_15 = "Verzending op zondag";
var txt_shipping_16 = "Verzending morgen!";
app_shop.txt.txt_74629_8 = "Selecteer grootte";
...
app_shop.txt.txt_74629_9 = "Uw product is klaar voor verzending";
app_shop.txt.txt_74629_10 =
  "Uw product is al verpakt en klaar om opgehaald te worden door de koerier.";
app_shop.txt.txt_74629_11 = "Voorbereidingstijd van het product voor verzending";
app_shop.txt.txt_74629_11a = "Klaar voor verzending";
app_shop.txt.txt_74629_11b =
  "Het product is verpakt en beschikbaar voor afhaling door een koerier.";
app_shop.txt.txt_74629_12 =
  "Dit is de tijd waarin het product wordt verpakt en klaargemaakt voor afhaling door de koerier.";
app_shop.txt.txt_74629_13 = "";
app_shop.txt.txt_74629_14 = "Het duurt maximaal 24 uur om klaar te maken voor persoonlijke afhaling.";
app_shop.txt.txt_74629_15 = "Het duurt 24 uur om klaar te maken voor persoonlijke afhaling.";
app_shop.txt.txt_74629_16 = "De voorbereiding voor het persoonlijk ophalen zal";
app_shop.txt.txt_74629_17 = "Het pakket zal vandaag bij u zijn!";
app_shop.txt.txt_74629_18 = "Het pakket zal morgen bij u zijn!";
app_shop.txt.txt_74629_19 = "De levering zal aan u in";
app_shop.txt.txt_74629_16467 = "Venster sluiten";
app_shop.txt.txt_74629_997 = "Meer lezen";
app_shop.txt.txt_74629_998 = "Instorten";
var txt_62619_nieprawidlowy_email = "Onjuist e-mailadres.";
var txt_62619_przekroczono_liczbe =
  "Het aantal toegevoegde meldingen per dag is overschreden.";
var txt_62619_podczas_dodawania =
  "Er is een fout opgetreden tijdens het toevoegen van een product. Controleer de juistheid van de ingevoerde gegevens.";
var txt_62619_produkt_dodany =
  "Het product is correct toegevoegd aan de meldingen.";
var txt_62619_blad_pobrania =
  "Er was een probleem met de verbinding. Voer de actie opnieuw uit.";
var txt_62619_bledny_email =
  "Błędnie wpisany e-mail. Wpisz pełny adres e-mail, np. jan@kowalski.com ";
var txt_62619_wpisz_telefon = "Voer uw telefoon in.";
var fashionGallery_new = "";
var txt_62619_od = "van";
var txt_62619_submitting = "Toevoegen aan winkelmandje";
...
app_shop.txt.txt_collapser_show_more = "Meer lezen";
app_shop.txt.txt_collapser_show_less = "Instorten";
  ...
  () => {
    ...
    if (app_shop.vars.view < 3) {
      dictionaryCollapser.init($("#projector_dictionary"), {
        height: 400,
        txt: {
          showMore: "Bekijk alle parameters",
          showLess: "De lijst met parameters samenvouwen",
        },
      });
    } else {
      dictionaryCollapser.init($("#projector_dictionary"), {
        txt: {
          showMore: "Zie meer parameters",
          showLess: "De lijst met parameters samenvouwen",
        },
      });
    }
...
app_shop.vars.opinions_empty_input = "Gelieve dit veld in te vullen.";
app_shop.vars.opinions_not_email = "Er is een ongeldig e-mailadres ingevoerd.";
...
var txt_1_69363 = "Kies de voor u meest geschikte verzendmethode voor retourzendingen";
...
var txt_1_69372 = "Kies hoe u de producten terugstuurt";
var txt_1_69372_param = "Selecteer de parameter voor het retourneren van producten";
var txt_1_69372_tak = "Ik bevestig";
var txt_1_69372_confirm_header = "Bevestigt u...?";
var txt_1_fill_phone =
  "Om deze retourmethode te selecteren moet u het telefoonnummer invullen in uw accountinstellingen";
...
var txt_1_69260_1 = "Selecteer de terug te sturen producten";
var txt_1_odznacz_w_p = "Alle producten deselecteren";
var txt_1_zaznacz_w_p = "Selecteer alle producten";
var txt_1_max_ret_amount = "Het maximum dat u kunt teruggeven";
...
var txt_1_69378 = "Kies de vorm van terugbetaling";
var validationTextErrors = [];
validationTextErrors["invalid_bank_acccount"] =
  "Het ingevoerde bankrekeningnummer is onjuist.";
app_shop.run(
  function () {
...
var txt_1_69376 = "Kies een retouradres";
...
var rma_add_alert = "Vul alle velden van het formulier in.";
var rma_add_msg1 = "Productnaam invoeren";
var rma_add_msg2 = "Voer het serienummer van het product in";
var rma_add_msg3 = "Datum van aankoop van het product invoeren";
var rma_add_msg4 = "Beschrijf de fout";
var rma_add_msg5 = "Beschrijf waar het product wordt gekocht";
var rma_add_msg6 = "Voer het adres in waarnaar u wilt worden terugbetaald";
var rma_add_msg7 = "Voer bankrekeningnummer in";
var rma_add_msg8 = "Vul gegevens voor cheque in";
...
var txt_1_69260 = "Selecteer de te claimen producten";
productslist_03a_txt = "Opmerkingen mogen maximaal";
productslist_03b_txt = "borden.";
...
app_shop.vars.show_description = "Meer lezen";
...
var stocks_list_more_txt = "meer informatie";
var stocks_list_on_map_txt = "Toon op kaart";
