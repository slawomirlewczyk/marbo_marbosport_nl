...
<template match="Moderacja->Treści dodatkowe na stronach generowanych automatycznie (CMS)->Strona główna - druga strefa">

<div class="main_cms_about_us">
    <div class="row">
        <div class="col-12 col-md-3">
            <img class="b-lazy" src="/gfx/pol/loader.gif?r=1612518076" data-src="/data/include/cms/cms/cms-logo.png" alt="Marbo Sport"/>
        </div>
